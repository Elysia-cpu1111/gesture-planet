...
void main() {
    ...
    `,G.add(_e.points);const we=pp({count:F(1200),radius:Zc,jitterRate:1,jitterAmount:.2,colorFn:()=>[.15+Math.random()*.35,.35+Math.random()*.45,.6+Math.random()*.4,Math.random()*.035+.008],renderOrder:7,uniforms:{uPulse:{value:1}},fragShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:wo,vertexColors:!0}),ft=new gf(ct,mt);ft.renderOrder=9,G.add(ft);const et=[ae.mat,Q.mat,N.mat,Ge.mat,we.mat,_e.mat,mt],wt=[ae.mat,Q.mat,N.mat,Ge.mat,we.mat,_e.mat,mt];wt.forEach(U=>{U.uniforms.uChaos={value:0},U.vertexShader=`uniform float uChaos;
