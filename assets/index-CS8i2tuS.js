 ...
 */var rv;function FS(){if(rv)return St;rv=1;var t=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.iterator;function y(N){return N===null||typeof N!="object"?null:(N=_&&N[_]||N["@@iterator"],typeof N=="function"?N:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,w={};function x(N,q,we){this.props=N,this.context=q,this.refs=w,this.updater=we||S}x.prototype.isReactComponent={},x.prototype.setState=function(N,q){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,q,"setState")},x.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function v(){}v.prototype=x.prototype;function D(N,q,we){this.props=N,this.context=q,this.refs=w,this.updater=we||S}var L=D.prototype=new v;L.constructor=D,E(L,x.prototype),L.isPureReactComponent=!0;var R=Array.isArray,j=Object.prototype.hasOwnProperty,U={current:null},F={key:!0,ref:!0,__self:!0,__source:!0};function H(N,q,we){var Z,fe={},Se=null,ve=null;if(q!=null)for(Z in q.ref!==void 0&&(ve=q.ref),q.key!==void 0&&(Se=""+q.key),q)j.call(q,Z)&&!F.hasOwnProperty(Z)&&(fe[Z]=q[Z]);var Re=arguments.length-2;if(Re===1)fe.children=we;else if(1<Re){for(var De=Array(Re),Qe=0;Qe<Re;Qe++)De[Qe]=arguments[Qe+2];fe.children=De}if(N&&N.defaultProps)for(Z in Re=N.defaultProps,Re)fe[Z]===void 0&&(fe[Z]=Re[Z]);return{$$typeof:t,type:N,key:Se,ref:ve,props:fe,_owner:U.current}}function b(N,q){return{$$typeof:t,type:N.type,key:q,ref:N.ref,props:N.props,_owner:N._owner}}function C(N){return typeof N=="object"&&N!==null&&N.$$typeof===t}function B(N){var q={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(we){return q[we]})}var re=/\/+/g;function K(N,q){return typeof N=="object"&&N!==null&&N.key!=null?B(""+N.key):q.toString(36)}function ce(N,q,we,Z,fe){var Se=typeof N;(Se==="undefined"||Se==="boolean")&&(N=null);var ve=!1;if(N===null)ve=!0;else switch(Se){case"string":case"number":ve=!0;break;case"object":switch(N.$$typeof){case t:case e:ve=!0}}if(ve)return ve=N,fe=fe(ve),N=Z===""?"."+K(ve,0):Z,R(fe)?(we="",N!=null&&(we=N.replace(re,"$&/")+"/"),ce(fe,q,we,"",function(Qe){return Qe})):fe!=null&&(C(fe)&&(fe=b(fe,we+(!fe.key||ve&&ve.key===fe.key?"":(""+fe.key).replace(re,"$&/")+"/")+N)),q.push(fe)),1;if(ve=0,Z=Z===""?".":Z+":",R(N))for(var Re=0;Re<N.length;Re++){Se=N[Re];var De=Z+K(Se,Re);ve+=ce(Se,q,we,De,fe)}else if(De=y(N),typeof De=="function")for(N=De.call(N),Re=0;!(Se=N.next()).done;)Se=Se.value,De=Z+K(Se,Re++),ve+=ce(Se,q,we,De,fe);else if(Se==="object")throw q=String(N),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.");return ve}function de(N,q,we){if(N==null)return N;var Z=[],fe=0;return ce(N,Z,"","",function(Se){return q.call(we,Se,fe++)}),Z}function Q(N){if(N._status===-1){var q=N._result;q=q(),q.then(function(we){(N._status===0||N._status===-1)&&(N._status=1,N._result=we)},function(we){(N._status===0||N._status===-1)&&(N._status=2,N._result=we)}),N._status===-1&&(N._status=0,N._result=q)}if(N._status===1)return N._result.default;throw N._result}var se={current:null},k={transition:null},le={ReactCurrentDispatcher:se,ReactCurrentBatchConfig:k,ReactCurrentOwner:U};function oe(){throw Error("act(...) is not supported in production builds of React.")}return St.Children={map:de,forEach:function(N,q,we){de(N,function(){q.apply(this,arguments)},we)},count:function(N){var q=0;return de(N,function(){q++}),q},toArray:function(N){return de(N,function(q){return q})||[]},only:function(N){if(!C(N))throw Error("React.Children.only expected to receive a single React element child.");return N}},St.Component=x,St.Fragment=n,St.Profiler=o,St.PureComponent=D,St.StrictMode=r,St.Suspense=d,St.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=le,St.act=oe,St.cloneElement=function(N,q,we){if(N==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+N+".");var Z=E({},N.props),fe=N.key,Se=N.ref,ve=N._owner;if(q!=null){if(q.ref!==void 0&&(Se=q.ref,ve=U.current),q.key!==void 0&&(fe=""+q.key),N.type&&N.type.defaultProps)var Re=N.type.defaultProps;for(De in q)j.call(q,De)&&!F.hasOwnProperty(De)&&(Z[De]=q[De]===void 0&&Re!==void 0?Re[De]:q[De])}var De=arguments.length-2;if(De===1)Z.children=we;else if(1<De){Re=Array(De);for(var Qe=0;Qe<De;Qe++)Re[Qe]=arguments[Qe+2];Z.children=Re}return{$$typeof:t,type:N.type,key:fe,ref:Se,props:Z,_owner:ve}},St.createContext=function(N){return N={$$typeof:c,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},N.Provider={$$typeof:l,_context:N},N.Consumer=N},St.createElement=H,St.createFactory=function(N){var q=H.bind(null,N);return q.type=N,q},St.createRef=function(){return{current:null}},St.forwardRef=function(N){return{$$typeof:f,render:N}},St.isValidElement=C,St.lazy=function(N){return{$$typeof:g,_payload:{_status:-1,_result:N},_init:Q}},St.memo=function(N,q){return{$$typeof:p,type:N,compare:q===void 0?null:q}},St.startTransition=function(N){var q=k.transition;k.transition={};try{N()}finally{k.transition=q}},St.unstable_act=oe,St.useCallback=function(N,q){return se.current.useCallback(N,q)},St.useContext=function(N){return se.current.useContext(N)},St.useDebugValue=function(){},St.useDeferredValue=function(N){return se.current.useDeferredValue(N)},St.useEffect=function(N,q){return se.current.useEffect(N,q)},St.useId=function(){return se.current.useId()},St.useImperativeHandle=function(N,q,we){return se.current.useImperativeHandle(N,q,we)},St.useInsertionEffect=function(N,q){return se.current.useInsertionEffect(N,q)},St.useLayoutEffect=function(N,q){return se.current.useLayoutEffect(N,q)},St.useMemo=function(N,q){return se.current.useMemo(N,q)},St.useReducer=function(N,q,we){return se.current.useReducer(N,q,we)},St.useRef=function(N){return se.current.useRef(N)},St.useState=function(N){return se.current.useState(N)},St.useSyncExternalStore=function(N,q,we){return se.current.useSyncExternalStore(N,q,we)},St.useTransition=function(){return se.current.useTransition()},St.version="18.3.1",St}var sv;function Pm(){return sv||(sv=1,Dh.exports=FS()),Dh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lv;function zS(){return lv||(lv=1,(function(t){function e(k,le){var oe=k.length;k.push(le);e:for(;0<oe;){var N=oe-1>>>1,q=k[N];if(0<o(q,le))k[N]=le,k[oe]=q,oe=N;else break e}}function n(k){return k.length===0?null:k[0]}function r(k){if(k.length===0)return null;var le=k[0],oe=k.pop();if(oe!==le){k[0]=oe;e:for(var N=0,q=k.length,we=q>>>1;N<we;){var Z=2*(N+1)-1,fe=k[Z],Se=Z+1,ve=k[Se];if(0>o(fe,oe))Se<q&&0>o(ve,fe)?(k[N]=ve,k[Se]=oe,N=Se):(k[N]=fe,k[Z]=oe,N=Z);else if(Se<q&&0>o(ve,oe))k[N]=ve,k[Se]=oe,N=Se;else break e}}return le}function o(k,le){var oe=k.sortIndex-le.sortIndex;return oe!==0?oe:k.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;t.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();t.unstable_now=function(){return c.now()-f}}var d=[],p=[],g=1,_=null,y=3,S=!1,E=!1,w=!1,x=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(k){for(var le=n(p);le!==null;){if(le.callback===null)r(p);else if(le.startTime<=k)r(p),le.sortIndex=le.expirationTime,e(d,le);else break;le=n(p)}}function R(k){if(w=!1,L(k),!E)if(n(d)!==null)E=!0,Q(j);else{var le=n(p);le!==null&&se(R,le.startTime-k)}}function j(k,le){E=!1,w&&(w=!1,v(H),H=-1),S=!0;var oe=y;try{for(L(le),_=n(d);_!==null&&(!(_.expirationTime>le)||k&&!B());){var N=_.callback;if(typeof N=="function"){_.callback=null,y=_.priorityLevel;var q=N(_.expirationTime<=le);le=t.unstable_now(),typeof q=="function"?_.callback=q:_===n(d)&&r(d),L(le)}else r(d);_=n(d)}if(_!==null)var we=!0;else{var Z=n(p);Z!==null&&se(R,Z.startTime-le),we=!1}return we}finally{_=null,y=oe,S=!1}}var U=!1,F=null,H=-1,b=5,C=-1;function B(){return!(t.unstable_now()-C<b)}function re(){if(F!==null){var k=t.unstable_now();C=k;var le=!0;try{le=F(!0,k)}finally{le?K():(U=!1,F=null)}}else U=!1}var K;if(typeof D=="function")K=function(){D(re)};else if(typeof MessageChannel<"u"){var ce=new MessageChannel,de=ce.port2;ce.port1.onmessage=re,K=function(){de.postMessage(null)}}else K=function(){x(re,0)};function Q(k){F=k,U||(U=!0,K())}function se(k,le){H=x(function(){k(t.unstable_now())},le)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(k){k.callback=null},t.unstable_continueExecution=function(){E||S||(E=!0,Q(j))},t.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<k?Math.floor(1e3/k):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(d)},t.unstable_next=function(k){switch(y){case 1:case 2:case 3:var le=3;break;default:le=y}var oe=y;y=le;try{return k()}finally{y=oe}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(k,le){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var oe=y;y=k;try{return le()}finally{y=oe}},t.unstable_scheduleCallback=function(k,le,oe){var N=t.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?N+oe:N):oe=N,k){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=oe+q,k={id:g++,callback:le,priorityLevel:k,startTime:oe,expirationTime:q,sortIndex:-1},oe>N?(k.sortIndex=oe,e(p,k),n(d)===null&&k===n(p)&&(w?(v(H),H=-1):w=!0,se(R,oe-N))):(k.sortIndex=q,e(d,k),E||S||(E=!0,Q(j))),k},t.unstable_shouldYield=B,t.unstable_wrapCallback=function(k){var le=y;return function(){var oe=y;y=le;try{return k.apply(this,arguments)}finally{y=oe}}}})(Uh)),Uh}var uv;function VS(){return uv||(uv=1,Nh.exports=zS()),Nh.exports}/**
 * @license React
...
`)+`
`+v);const L=D+x+c,R=D+v+f,j=Jv(o,o.VERTEX_SHADER,L),U=Jv(o,o.FRAGMENT_SHADER,R);o.attachShader(w,j),o.attachShader(w,U),n.index0AttributeName!==void 0?o.bindAttribLocation(w,0,n.index0AttributeName):n.morphTargets===!0&&o.bindAttribLocation(w,0,"position"),o.linkProgram(w);function F(B){if(t.debug.checkShaderErrors){const re=o.getProgramInfoLog(w).trim(),K=o.getShaderInfoLog(j).trim(),ce=o.getShaderInfoLog(U).trim();let de=!0,Q=!0;if(o.getProgramParameter(w,o.LINK_STATUS)===!1)if(de=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(o,w,j,U);else{const se=t1(o,j,"vertex"),k=t1(o,U,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(w,o.VALIDATE_STATUS)+`
...
}`;function DA(t,e,n){let r=new Bm;const o=new Bt,l=new Bt,c=new ln,f=new RA({depthPacking:TM}),d=new bA,p={},g=n.maxTextureSize,_={[Xs]:pi,[pi]:Xs,[Jr]:Jr},y=new $i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Bt},radius:{value:4}},vertexShader:PA,fragmentShader:LA}),S=y.clone();S.defines.HORIZONTAL_PASS=1;const E=new Ri;E.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new fr(E,y),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=S2;let v=this.type;this.render=function(U,F,H){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||U.length===0)return;const b=t.getRenderTarget(),C=t.getActiveCubeFace(),B=t.getActiveMipmapLevel(),re=t.state;re.setBlending(Hs),re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const K=v!==Qr&&this.type===Qr,ce=v===Qr&&this.type!==Qr;for(let de=0,Q=U.length;de<Q;de++){const se=U[de],k=se.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",se,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;o.copy(k.mapSize);const le=k.getFrameExtents();if(o.multiply(le),l.copy(k.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(l.x=Math.floor(g/le.x),o.x=l.x*le.x,k.mapSize.x=l.x),o.y>g&&(l.y=Math.floor(g/le.y),o.y=l.y*le.y,k.mapSize.y=l.y)),k.map===null||K===!0||ce===!0){const N=this.type!==Qr?{minFilter:dr,magFilter:dr}:{};k.map!==null&&k.map.dispose(),k.map=new Do(o.x,o.y,N),k.map.texture.name=se.name+".shadowMap",k.camera.updateProjectionMatrix()}t.setRenderTarget(k.map),t.clear();const oe=k.getViewportCount();for(let N=0;N<oe;N++){const q=k.getViewport(N);c.set(l.x*q.x,l.y*q.y,l.x*q.z,l.y*q.w),re.viewport(c),k.updateMatrices(se,N),r=k.getFrustum(),R(F,H,k.camera,se,this.type)}k.isPointLightShadow!==!0&&this.type===Qr&&D(k,H),k.needsUpdate=!1}v=this.type,x.needsUpdate=!1,t.setRenderTarget(b,C,B)};function D(U,F){const H=e.update(w);y.defines.VSM_SAMPLES!==U.blurSamples&&(y.defines.VSM_SAMPLES=U.blurSamples,S.defines.VSM_SAMPLES=U.blurSamples,y.needsUpdate=!0,S.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new Do(o.x,o.y)),y.uniforms.shadow_pass.value=U.map.texture,y.uniforms.resolution.value=U.mapSize,y.uniforms.radius.value=U.radius,t.setRenderTarget(U.mapPass),t.clear(),t.renderBufferDirect(F,null,H,y,w,null),S.uniforms.shadow_pass.value=U.mapPass.texture,S.uniforms.resolution.value=U.mapSize,S.uniforms.radius.value=U.radius,t.setRenderTarget(U.map),t.clear(),t.renderBufferDirect(F,null,H,S,w,null)}function L(U,F,H,b){let C=null;const B=H.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(B!==void 0)C=B;else if(C=H.isPointLight===!0?d:f,t.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0){const re=C.uuid,K=F.uuid;let ce=p[re];ce===void 0&&(ce={},p[re]=ce);let de=ce[K];de===void 0&&(de=C.clone(),ce[K]=de,F.addEventListener("dispose",j)),C=de}if(C.visible=F.visible,C.wireframe=F.wireframe,b===Qr?C.side=F.shadowSide!==null?F.shadowSide:F.side:C.side=F.shadowSide!==null?F.shadowSide:_[F.side],C.alphaMap=F.alphaMap,C.alphaTest=F.alphaTest,C.map=F.map,C.clipShadows=F.clipShadows,C.clippingPlanes=F.clippingPlanes,C.clipIntersection=F.clipIntersection,C.displacementMap=F.displacementMap,C.displacementScale=F.displacementScale,C.displacementBias=F.displacementBias,C.wireframeLinewidth=F.wireframeLinewidth,C.linewidth=F.linewidth,H.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const re=t.properties.get(C);re.light=H}return C}function R(U,F,H,b,C){if(U.visible===!1)return;if(U.layers.test(F.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&C===Qr)&&(!U.frustumCulled||r.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,U.matrixWorld);const K=e.update(U),ce=U.material;if(Array.isArray(ce)){const de=K.groups;for(let Q=0,se=de.length;Q<se;Q++){const k=de[Q],le=ce[k.materialIndex];if(le&&le.visible){const oe=L(U,le,b,C);U.onBeforeShadow(t,U,F,H,K,oe,k),t.renderBufferDirect(H,null,K,oe,U,k),U.onAfterShadow(t,U,F,H,K,oe,k)}}}else if(ce.visible){const de=L(U,ce,b,C);U.onBeforeShadow(t,U,F,H,K,de,null),t.renderBufferDirect(H,null,K,de,U,null),U.onAfterShadow(t,U,F,H,K,de,null)}}const re=U.children;for(let K=0,ce=re.length;K<ce;K++)R(re[K],F,H,b,C)}function j(U){U.target.removeEventListener("dispose",j);for(const H in p){const b=p[H],C=U.target.uuid;C in b&&(b[C].dispose(),delete b[C])}}}const IA={[Ap]:Cp,[Rp]:Lp,[bp]:Dp,[Ia]:Pp,[Cp]:Ap,[Lp]:Rp,[Dp]:bp,[Pp]:Ia};function NA(t,e){function n(){let V=!1;const be=new ln;let ae=null;const ge=new ln(0,0,0,0);return{setMask:function(Ie){ae!==Ie&&!V&&(t.colorMask(Ie,Ie,Ie,Ie),ae=Ie)},setLocked:function(Ie){V=Ie},setClear:function(Ie,Le,ft,Xt,yn){yn===!0&&(Ie*=Xt,Le*=Xt,ft*=Xt),be.set(Ie,Le,ft,Xt),ge.equals(be)===!1&&(t.clearColor(Ie,Le,ft,Xt),ge.copy(be))},reset:function(){V=!1,ae=null,ge.set(-1,0,0,0)}}}function r(){let V=!1,be=!1,ae=null,ge=null,Ie=null;return{setReversed:function(Le){if(be!==Le){const ft=e.get("EXT_clip_control");be?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT);const Xt=Ie;Ie=null,this.setClear(Xt)}be=Le},getReversed:function(){return be},setTest:function(Le){Le?ve(t.DEPTH_TEST):Re(t.DEPTH_TEST)},setMask:function(Le){ae!==Le&&!V&&(t.depthMask(Le),ae=Le)},setFunc:function(Le){if(be&&(Le=IA[Le]),ge!==Le){switch(Le){case Ap:t.depthFunc(t.NEVER);break;case Cp:t.depthFunc(t.ALWAYS);break;case Rp:t.depthFunc(t.LESS);break;case Ia:t.depthFunc(t.LEQUAL);break;case bp:t.depthFunc(t.EQUAL);break;case Pp:t.depthFunc(t.GEQUAL);break;case Lp:t.depthFunc(t.GREATER);break;case Dp:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ge=Le}},setLocked:function(Le){V=Le},setClear:function(Le){Ie!==Le&&(be&&(Le=1-Le),t.clearDepth(Le),Ie=Le)},reset:function(){V=!1,ae=null,ge=null,Ie=null,be=!1}}}function o(){let V=!1,be=null,ae=null,ge=null,Ie=null,Le=null,ft=null,Xt=null,yn=null;return{setTest:function(At){V||(At?ve(t.STENCIL_TEST):Re(t.STENCIL_TEST))},setMask:function(At){be!==At&&!V&&(t.stencilMask(At),be=At)},setFunc:function(At,ni,Zn){(ae!==At||ge!==ni||Ie!==Zn)&&(t.stencilFunc(At,ni,Zn),ae=At,ge=ni,Ie=Zn)},setOp:function(At,ni,Zn){(Le!==At||ft!==ni||Xt!==Zn)&&(t.stencilOp(At,ni,Zn),Le=At,ft=ni,Xt=Zn)},setLocked:function(At){V=At},setClear:function(At){yn!==At&&(t.clearStencil(At),yn=At)},reset:function(){V=!1,be=null,ae=null,ge=null,Ie=null,Le=null,ft=null,Xt=null,yn=null}}}const l=new n,c=new r,f=new o,d=new WeakMap,p=new WeakMap;let g={},_={},y=new WeakMap,S=[],E=null,w=!1,x=null,v=null,D=null,L=null,R=null,j=null,U=null,F=new vt(0,0,0),H=0,b=!1,C=null,B=null,re=null,K=null,ce=null;const de=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Q=!1,se=0;const k=t.getParameter(t.VERSION);k.indexOf("WebGL")!==-1?(se=parseFloat(/^WebGL (\d)/.exec(k)[1]),Q=se>=1):k.indexOf("OpenGL ES")!==-1&&(se=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),Q=se>=2);let le=null,oe={};const N=t.getParameter(t.SCISSOR_BOX),q=t.getParameter(t.VIEWPORT),we=new ln().fromArray(N),Z=new ln().fromArray(q);function fe(V,be,ae,ge){const Ie=new Uint8Array(4),Le=t.createTexture();t.bindTexture(V,Le),t.texParameteri(V,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(V,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let ft=0;ft<ae;ft++)V===t.TEXTURE_3D||V===t.TEXTURE_2D_ARRAY?t.texImage3D(be,0,t.RGBA,1,1,ge,0,t.RGBA,t.UNSIGNED_BYTE,Ie):t.texImage2D(be+ft,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Ie);return Le}const Se={};Se[t.TEXTURE_2D]=fe(t.TEXTURE_2D,t.TEXTURE_2D,1),Se[t.TEXTURE_CUBE_MAP]=fe(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),Se[t.TEXTURE_2D_ARRAY]=fe(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),Se[t.TEXTURE_3D]=fe(t.TEXTURE_3D,t.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),ve(t.DEPTH_TEST),c.setFunc(Ia),yt(!1),gt(hv),ve(t.CULL_FACE),G(Hs);function ve(V){g[V]!==!0&&(t.enable(V),g[V]=!0)}function Re(V){g[V]!==!1&&(t.disable(V),g[V]=!1)}function De(V,be){return _[V]!==be?(t.bindFramebuffer(V,be),_[V]=be,V===t.DRAW_FRAMEBUFFER&&(_[t.FRAMEBUFFER]=be),V===t.FRAMEBUFFER&&(_[t.DRAW_FRAMEBUFFER]=be),!0):!1}function Qe(V,be){let ae=S,ge=!1;if(V){ae=y.get(be),ae===void 0&&(ae=[],y.set(be,ae));const Ie=V.textures;if(ae.length!==Ie.length||ae[0]!==t.COLOR_ATTACHMENT0){for(let Le=0,ft=Ie.length;Le<ft;Le++)ae[Le]=t.COLOR_ATTACHMENT0+Le;ae.length=Ie.length,ge=!0}}else ae[0]!==t.BACK&&(ae[0]=t.BACK,ge=!0);ge&&t.drawBuffers(ae)}function wt(V){return E!==V?(t.useProgram(V),E=V,!0):!1}const pt={[yo]:t.FUNC_ADD,[ZS]:t.FUNC_SUBTRACT,[QS]:t.FUNC_REVERSE_SUBTRACT};pt[JS]=t.MIN,pt[eM]=t.MAX;const Ot={[tM]:t.ZERO,[nM]:t.ONE,[iM]:t.SRC_COLOR,[Tp]:t.SRC_ALPHA,[uM]:t.SRC_ALPHA_SATURATE,[aM]:t.DST_COLOR,[sM]:t.DST_ALPHA,[rM]:t.ONE_MINUS_SRC_COLOR,[wp]:t.ONE_MINUS_SRC_ALPHA,[lM]:t.ONE_MINUS_DST_COLOR,[oM]:t.ONE_MINUS_DST_ALPHA,[cM]:t.CONSTANT_COLOR,[fM]:t.ONE_MINUS_CONSTANT_COLOR,[dM]:t.CONSTANT_ALPHA,[hM]:t.ONE_MINUS_CONSTANT_ALPHA};function G(V,be,ae,ge,Ie,Le,ft,Xt,yn,At){if(V===Hs){w===!0&&(Re(t.BLEND),w=!1);return}if(w===!1&&(ve(t.BLEND),w=!0),V!==KS){if(V!==x||At!==b){if((v!==yo||R!==yo)&&(t.blendEquation(t.FUNC_ADD),v=yo,R=yo),At)switch(V){case Ra:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case wo:t.blendFunc(t.ONE,t.ONE);break;case pv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case mv:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}else switch(V){case Ra:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case wo:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case pv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case mv:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}D=null,L=null,j=null,U=null,F.set(0,0,0),H=0,x=V,b=At}return}Ie=Ie||be,Le=Le||ae,ft=ft||ge,(be!==v||Ie!==R)&&(t.blendEquationSeparate(pt[be],pt[Ie]),v=be,R=Ie),(ae!==D||ge!==L||Le!==j||ft!==U)&&(t.blendFuncSeparate(Ot[ae],Ot[ge],Ot[Le],Ot[ft]),D=ae,L=ge,j=Le,U=ft),(Xt.equals(F)===!1||yn!==H)&&(t.blendColor(Xt.r,Xt.g,Xt.b,yn),F.copy(Xt),H=yn),x=V,b=!1}function vn(V,be){V.side===Jr?Re(t.CULL_FACE):ve(t.CULL_FACE);let ae=V.side===pi;be&&(ae=!ae),yt(ae),V.blending===Ra&&V.transparent===!1?G(Hs):G(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),c.setFunc(V.depthFunc),c.setTest(V.depthTest),c.setMask(V.depthWrite),l.setMask(V.colorWrite);const ge=V.stencilWrite;f.setTest(ge),ge&&(f.setMask(V.stencilWriteMask),f.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),f.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),Pt(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?ve(t.SAMPLE_ALPHA_TO_COVERAGE):Re(t.SAMPLE_ALPHA_TO_COVERAGE)}function yt(V){C!==V&&(V?t.frontFace(t.CW):t.frontFace(t.CCW),C=V)}function gt(V){V!==YS?(ve(t.CULL_FACE),V!==B&&(V===hv?t.cullFace(t.BACK):V===qS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Re(t.CULL_FACE),B=V}function Je(V){V!==re&&(Q&&t.lineWidth(V),re=V)}function Pt(V,be,ae){V?(ve(t.POLYGON_OFFSET_FILL),(K!==be||ce!==ae)&&(t.polygonOffset(be,ae),K=be,ce=ae)):Re(t.POLYGON_OFFSET_FILL)}function ue(V){V?ve(t.SCISSOR_TEST):Re(t.SCISSOR_TEST)}function P(V){V===void 0&&(V=t.TEXTURE0+de-1),le!==V&&(t.activeTexture(V),le=V)}function T(V,be,ae){ae===void 0&&(le===null?ae=t.TEXTURE0+de-1:ae=le);let ge=oe[ae];ge===void 0&&(ge={type:void 0,texture:void 0},oe[ae]=ge),(ge.type!==V||ge.texture!==be)&&(le!==ae&&(t.activeTexture(ae),le=ae),t.bindTexture(V,be||Se[V]),ge.type=V,ge.texture=be)}function Y(){const V=oe[le];V!==void 0&&V.type!==void 0&&(t.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function me(){try{t.compressedTexImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function pe(){try{t.compressedTexImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function he(){try{t.texSubImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ve(){try{t.texSubImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ce(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ue(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function dt(){try{t.texStorage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Me(){try{t.texStorage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Fe(){try{t.texImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function rt(){try{t.texImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ot(V){we.equals(V)===!1&&(t.scissor(V.x,V.y,V.z,V.w),we.copy(V))}function ke(V){Z.equals(V)===!1&&(t.viewport(V.x,V.y,V.z,V.w),Z.copy(V))}function xt(V,be){let ae=p.get(be);ae===void 0&&(ae=new WeakMap,p.set(be,ae));let ge=ae.get(V);ge===void 0&&(ge=t.getUniformBlockIndex(be,V.name),ae.set(V,ge))}function ct(V,be){const ge=p.get(be).get(V);d.get(be)!==ge&&(t.uniformBlockBinding(be,ge,V.__bindingPointIndex),d.set(be,ge))}function Ft(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),c.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),g={},le=null,oe={},_={},y=new WeakMap,S=[],E=null,w=!1,x=null,v=null,D=null,L=null,R=null,j=null,U=null,F=new vt(0,0,0),H=0,b=!1,C=null,B=null,re=null,K=null,ce=null,we.set(0,0,t.canvas.width,t.canvas.height),Z.set(0,0,t.canvas.width,t.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:ve,disable:Re,bindFramebuffer:De,drawBuffers:Qe,useProgram:wt,setBlending:G,setMaterial:vn,setFlipSided:yt,setCullFace:gt,setLineWidth:Je,setPolygonOffset:Pt,setScissorTest:ue,activeTexture:P,bindTexture:T,unbindTexture:Y,compressedTexImage2D:me,compressedTexImage3D:pe,texImage2D:Fe,texImage3D:rt,updateUBOMapping:xt,uniformBlockBinding:ct,texStorage2D:dt,texStorage3D:Me,texSubImage2D:he,texSubImage3D:Ve,compressedTexSubImage2D:Ce,compressedTexSubImage3D:Ue,scissor:ot,viewport:ke,reset:Ft}}function u1(t,e,n,r){const o=UA(r);switch(n){case R2:return t*e;case P2:return t*e;case L2:return t*e*2;case D2:return t*e/o.components*o.byteLength;case Um:return t*e/o.components*o.byteLength;case I2:return t*e*2/o.components*o.byteLength;case Fm:return t*e*2/o.components*o.byteLength;case b2:return t*e*3/o.components*o.byteLength;case cr:return t*e*4/o.components*o.byteLength;case Om:return t*e*4/o.components*o.byteLength;case sf:case of:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case af:case lf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case kp:case zp:return Math.max(t,16)*Math.max(e,8)/4;case Op:case Bp:return Math.max(t,8)*Math.max(e,8)/2;case Vp:case Hp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Gp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Wp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Xp:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case jp:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Yp:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case qp:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case $p:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Kp:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case Zp:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Qp:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Jp:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case em:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case tm:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case nm:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case im:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case uf:case rm:case sm:return Math.ceil(t/4)*Math.ceil(e/4)*16;case N2:case om:return Math.ceil(t/4)*Math.ceil(e/4)*8;case am:case lm:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function UA(t){switch(t){case rs:case w2:return{byteLength:1,components:1};case iu:case A2:case lu:return{byteLength:2,components:1};case Im:case Nm:return{byteLength:2,components:4};case Lo:case Dm:case ts:return{byteLength:4,components:1};case C2:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function FA(t,e,n,r,o,l,c){const f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Bt,g=new WeakMap;let _;const y=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(P,T){return S?new OffscreenCanvas(P,T):pf("canvas")}function w(P,T,Y){let me=1;const pe=ue(P);if((pe.width>Y||pe.height>Y)&&(me=Y/Math.max(pe.width,pe.height)),me<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const he=Math.floor(me*pe.width),Ve=Math.floor(me*pe.height);_===void 0&&(_=E(he,Ve));const Ce=T?E(he,Ve):_;return Ce.width=he,Ce.height=Ve,Ce.getContext("2d").drawImage(P,0,0,he,Ve),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+he+"x"+Ve+")."),Ce}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),P;return P}function x(P){return P.generateMipmaps}function v(P){t.generateMipmap(P)}function D(P){return P.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?t.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function L(P,T,Y,me,pe=!1){if(P!==null){if(t[P]!==void 0)return t[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let he=T;if(T===t.RED&&(Y===t.FLOAT&&(he=t.R32F),Y===t.HALF_FLOAT&&(he=t.R16F),Y===t.UNSIGNED_BYTE&&(he=t.R8)),T===t.RED_INTEGER&&(Y===t.UNSIGNED_BYTE&&(he=t.R8UI),Y===t.UNSIGNED_SHORT&&(he=t.R16UI),Y===t.UNSIGNED_INT&&(he=t.R32UI),Y===t.BYTE&&(he=t.R8I),Y===t.SHORT&&(he=t.R16I),Y===t.INT&&(he=t.R32I)),T===t.RG&&(Y===t.FLOAT&&(he=t.RG32F),Y===t.HALF_FLOAT&&(he=t.RG16F),Y===t.UNSIGNED_BYTE&&(he=t.RG8)),T===t.RG_INTEGER&&(Y===t.UNSIGNED_BYTE&&(he=t.RG8UI),Y===t.UNSIGNED_SHORT&&(he=t.RG16UI),Y===t.UNSIGNED_INT&&(he=t.RG32UI),Y===t.BYTE&&(he=t.RG8I),Y===t.SHORT&&(he=t.RG16I),Y===t.INT&&(he=t.RG32I)),T===t.RGB_INTEGER&&(Y===t.UNSIGNED_BYTE&&(he=t.RGB8UI),Y===t.UNSIGNED_SHORT&&(he=t.RGB16UI),Y===t.UNSIGNED_INT&&(he=t.RGB32UI),Y===t.BYTE&&(he=t.RGB8I),Y===t.SHORT&&(he=t.RGB16I),Y===t.INT&&(he=t.RGB32I)),T===t.RGBA_INTEGER&&(Y===t.UNSIGNED_BYTE&&(he=t.RGBA8UI),Y===t.UNSIGNED_SHORT&&(he=t.RGBA16UI),Y===t.UNSIGNED_INT&&(he=t.RGBA32UI),Y===t.BYTE&&(he=t.RGBA8I),Y===t.SHORT&&(he=t.RGBA16I),Y===t.INT&&(he=t.RGBA32I)),T===t.RGB&&Y===t.UNSIGNED_INT_5_9_9_9_REV&&(he=t.RGB9_E5),T===t.RGBA){const Ve=pe?Af:Rt.getTransfer(me);Y===t.FLOAT&&(he=t.RGBA32F),Y===t.HALF_FLOAT&&(he=t.RGBA16F),Y===t.UNSIGNED_BYTE&&(he=Ve===zt?t.SRGB8_ALPHA8:t.RGBA8),Y===t.UNSIGNED_SHORT_4_4_4_4&&(he=t.RGBA4),Y===t.UNSIGNED_SHORT_5_5_5_1&&(he=t.RGB5_A1)}return(he===t.R16F||he===t.R32F||he===t.RG16F||he===t.RG32F||he===t.RGBA16F||he===t.RGBA32F)&&e.get("EXT_color_buffer_float"),he}function R(P,T){let Y;return P?T===null||T===Lo||T===Fa?Y=t.DEPTH24_STENCIL8:T===ts?Y=t.DEPTH32F_STENCIL8:T===iu&&(Y=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Lo||T===Fa?Y=t.DEPTH_COMPONENT24:T===ts?Y=t.DEPTH_COMPONENT32F:T===iu&&(Y=t.DEPTH_COMPONENT16),Y}function j(P,T){return x(P)===!0||P.isFramebufferTexture&&P.minFilter!==dr&&P.minFilter!==Ar?Math.log2(Math.max(T.width,T.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?T.mipmaps.length:1}function U(P){const T=P.target;T.removeEventListener("dispose",U),H(T),T.isVideoTexture&&g.delete(T)}function F(P){const T=P.target;T.removeEventListener("dispose",F),C(T)}function H(P){const T=r.get(P);if(T.__webglInit===void 0)return;const Y=P.source,me=y.get(Y);if(me){const pe=me[T.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&b(P),Object.keys(me).length===0&&y.delete(Y)}r.remove(P)}function b(P){const T=r.get(P);t.deleteTexture(T.__webglTexture);const Y=P.source,me=y.get(Y);delete me[T.__cacheKey],c.memory.textures--}function C(P){const T=r.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),r.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let me=0;me<6;me++){if(Array.isArray(T.__webglFramebuffer[me]))for(let pe=0;pe<T.__webglFramebuffer[me].length;pe++)t.deleteFramebuffer(T.__webglFramebuffer[me][pe]);else t.deleteFramebuffer(T.__webglFramebuffer[me]);T.__webglDepthbuffer&&t.deleteRenderbuffer(T.__webglDepthbuffer[me])}else{if(Array.isArray(T.__webglFramebuffer))for(let me=0;me<T.__webglFramebuffer.length;me++)t.deleteFramebuffer(T.__webglFramebuffer[me]);else t.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&t.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&t.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let me=0;me<T.__webglColorRenderbuffer.length;me++)T.__webglColorRenderbuffer[me]&&t.deleteRenderbuffer(T.__webglColorRenderbuffer[me]);T.__webglDepthRenderbuffer&&t.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const Y=P.textures;for(let me=0,pe=Y.length;me<pe;me++){const he=r.get(Y[me]);he.__webglTexture&&(t.deleteTexture(he.__webglTexture),c.memory.textures--),r.remove(Y[me])}r.remove(P)}let B=0;function re(){B=0}function K(){const P=B;return P>=o.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+o.maxTextures),B+=1,P}function ce(P){const T=[];return T.push(P.wrapS),T.push(P.wrapT),T.push(P.wrapR||0),T.push(P.magFilter),T.push(P.minFilter),T.push(P.anisotropy),T.push(P.internalFormat),T.push(P.format),T.push(P.type),T.push(P.generateMipmaps),T.push(P.premultiplyAlpha),T.push(P.flipY),T.push(P.unpackAlignment),T.push(P.colorSpace),T.join()}function de(P,T){const Y=r.get(P);if(P.isVideoTexture&&Je(P),P.isRenderTargetTexture===!1&&P.version>0&&Y.__version!==P.version){const me=P.image;if(me===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(me.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(Y,P,T);return}}n.bindTexture(t.TEXTURE_2D,Y.__webglTexture,t.TEXTURE0+T)}function Q(P,T){const Y=r.get(P);if(P.version>0&&Y.__version!==P.version){Z(Y,P,T);return}n.bindTexture(t.TEXTURE_2D_ARRAY,Y.__webglTexture,t.TEXTURE0+T)}function se(P,T){const Y=r.get(P);if(P.version>0&&Y.__version!==P.version){Z(Y,P,T);return}n.bindTexture(t.TEXTURE_3D,Y.__webglTexture,t.TEXTURE0+T)}function k(P,T){const Y=r.get(P);if(P.version>0&&Y.__version!==P.version){fe(Y,P,T);return}n.bindTexture(t.TEXTURE_CUBE_MAP,Y.__webglTexture,t.TEXTURE0+T)}const le={[Up]:t.REPEAT,[So]:t.CLAMP_TO_EDGE,[Fp]:t.MIRRORED_REPEAT},oe={[dr]:t.NEAREST,[MM]:t.NEAREST_MIPMAP_NEAREST,[Rc]:t.NEAREST_MIPMAP_LINEAR,[Ar]:t.LINEAR,[Fh]:t.LINEAR_MIPMAP_NEAREST,[Mo]:t.LINEAR_MIPMAP_LINEAR},N={[CM]:t.NEVER,[IM]:t.ALWAYS,[RM]:t.LESS,[U2]:t.LEQUAL,[bM]:t.EQUAL,[DM]:t.GEQUAL,[PM]:t.GREATER,[LM]:t.NOTEQUAL};function q(P,T){if(T.type===ts&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===Ar||T.magFilter===Fh||T.magFilter===Rc||T.magFilter===Mo||T.minFilter===Ar||T.minFilter===Fh||T.minFilter===Rc||T.minFilter===Mo)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(P,t.TEXTURE_WRAP_S,le[T.wrapS]),t.texParameteri(P,t.TEXTURE_WRAP_T,le[T.wrapT]),(P===t.TEXTURE_3D||P===t.TEXTURE_2D_ARRAY)&&t.texParameteri(P,t.TEXTURE_WRAP_R,le[T.wrapR]),t.texParameteri(P,t.TEXTURE_MAG_FILTER,oe[T.magFilter]),t.texParameteri(P,t.TEXTURE_MIN_FILTER,oe[T.minFilter]),T.compareFunction&&(t.texParameteri(P,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(P,t.TEXTURE_COMPARE_FUNC,N[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===dr||T.minFilter!==Rc&&T.minFilter!==Mo||T.type===ts&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||r.get(T).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");t.texParameterf(P,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,o.getMaxAnisotropy())),r.get(T).__currentAnisotropy=T.anisotropy}}}function we(P,T){let Y=!1;P.__webglInit===void 0&&(P.__webglInit=!0,T.addEventListener("dispose",U));const me=T.source;let pe=y.get(me);pe===void 0&&(pe={},y.set(me,pe));const he=ce(T);if(he!==P.__cacheKey){pe[he]===void 0&&(pe[he]={texture:t.createTexture(),usedTimes:0},c.memory.textures++,Y=!0),pe[he].usedTimes++;const Ve=pe[P.__cacheKey];Ve!==void 0&&(pe[P.__cacheKey].usedTimes--,Ve.usedTimes===0&&b(T)),P.__cacheKey=he,P.__webglTexture=pe[he].texture}return Y}function Z(P,T,Y){let me=t.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(me=t.TEXTURE_2D_ARRAY),T.isData3DTexture&&(me=t.TEXTURE_3D);const pe=we(P,T),he=T.source;n.bindTexture(me,P.__webglTexture,t.TEXTURE0+Y);const Ve=r.get(he);if(he.version!==Ve.__version||pe===!0){n.activeTexture(t.TEXTURE0+Y);const Ce=Rt.getPrimaries(Rt.workingColorSpace),Ue=T.colorSpace===zs?null:Rt.getPrimaries(T.colorSpace),dt=T.colorSpace===zs||Ce===Ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,T.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);let Me=w(T.image,!1,o.maxTextureSize);Me=Pt(T,Me);const Fe=l.convert(T.format,T.colorSpace),rt=l.convert(T.type);let ot=L(T.internalFormat,Fe,rt,T.colorSpace,T.isVideoTexture);q(me,T);let ke;const xt=T.mipmaps,ct=T.isVideoTexture!==!0,Ft=Ve.__version===void 0||pe===!0,V=he.dataReady,be=j(T,Me);if(T.isDepthTexture)ot=R(T.format===Oa,T.type),Ft&&(ct?n.texStorage2D(t.TEXTURE_2D,1,ot,Me.width,Me.height):n.texImage2D(t.TEXTURE_2D,0,ot,Me.width,Me.height,0,Fe,rt,null));else if(T.isDataTexture)if(xt.length>0){ct&&Ft&&n.texStorage2D(t.TEXTURE_2D,be,ot,xt[0].width,xt[0].height);for(let ae=0,ge=xt.length;ae<ge;ae++)ke=xt[ae],ct?V&&n.texSubImage2D(t.TEXTURE_2D,ae,0,0,ke.width,ke.height,Fe,rt,ke.data):n.texImage2D(t.TEXTURE_2D,ae,ot,ke.width,ke.height,0,Fe,rt,ke.data);T.generateMipmaps=!1}else ct?(Ft&&n.texStorage2D(t.TEXTURE_2D,be,ot,Me.width,Me.height),V&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Me.width,Me.height,Fe,rt,Me.data)):n.texImage2D(t.TEXTURE_2D,0,ot,Me.width,Me.height,0,Fe,rt,Me.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){ct&&Ft&&n.texStorage3D(t.TEXTURE_2D_ARRAY,be,ot,xt[0].width,xt[0].height,Me.depth);for(let ae=0,ge=xt.length;ae<ge;ae++)if(ke=xt[ae],T.format!==cr)if(Fe!==null)if(ct){if(V)if(T.layerUpdates.size>0){const Ie=u1(ke.width,ke.height,T.format,T.type);for(const Le of T.layerUpdates){const ft=ke.data.subarray(Le*Ie/ke.data.BYTES_PER_ELEMENT,(Le+1)*Ie/ke.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ae,0,0,Le,ke.width,ke.height,1,Fe,ft)}T.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ae,0,0,0,ke.width,ke.height,Me.depth,Fe,ke.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ae,ot,ke.width,ke.height,Me.depth,0,ke.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ct?V&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ae,0,0,0,ke.width,ke.height,Me.depth,Fe,rt,ke.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ae,ot,ke.width,ke.height,Me.depth,0,Fe,rt,ke.data)}else{ct&&Ft&&n.texStorage2D(t.TEXTURE_2D,be,ot,xt[0].width,xt[0].height);for(let ae=0,ge=xt.length;ae<ge;ae++)ke=xt[ae],T.format!==cr?Fe!==null?ct?V&&n.compressedTexSubImage2D(t.TEXTURE_2D,ae,0,0,ke.width,ke.height,Fe,ke.data):n.compressedTexImage2D(t.TEXTURE_2D,ae,ot,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ct?V&&n.texSubImage2D(t.TEXTURE_2D,ae,0,0,ke.width,ke.height,Fe,rt,ke.data):n.texImage2D(t.TEXTURE_2D,ae,ot,ke.width,ke.height,0,Fe,rt,ke.data)}else if(T.isDataArrayTexture)if(ct){if(Ft&&n.texStorage3D(t.TEXTURE_2D_ARRAY,be,ot,Me.width,Me.height,Me.depth),V)if(T.layerUpdates.size>0){const ae=u1(Me.width,Me.height,T.format,T.type);for(const ge of T.layerUpdates){const Ie=Me.data.subarray(ge*ae/Me.data.BYTES_PER_ELEMENT,(ge+1)*ae/Me.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ge,Me.width,Me.height,1,Fe,rt,Ie)}T.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,Me.width,Me.height,Me.depth,Fe,rt,Me.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ot,Me.width,Me.height,Me.depth,0,Fe,rt,Me.data);else if(T.isData3DTexture)ct?(Ft&&n.texStorage3D(t.TEXTURE_3D,be,ot,Me.width,Me.height,Me.depth),V&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Me.width,Me.height,Me.depth,Fe,rt,Me.data)):n.texImage3D(t.TEXTURE_3D,0,ot,Me.width,Me.height,Me.depth,0,Fe,rt,Me.data);else if(T.isFramebufferTexture){if(Ft)if(ct)n.texStorage2D(t.TEXTURE_2D,be,ot,Me.width,Me.height);else{let ae=Me.width,ge=Me.height;for(let Ie=0;Ie<be;Ie++)n.texImage2D(t.TEXTURE_2D,Ie,ot,ae,ge,0,Fe,rt,null),ae>>=1,ge>>=1}}else if(xt.length>0){if(ct&&Ft){const ae=ue(xt[0]);n.texStorage2D(t.TEXTURE_2D,be,ot,ae.width,ae.height)}for(let ae=0,ge=xt.length;ae<ge;ae++)ke=xt[ae],ct?V&&n.texSubImage2D(t.TEXTURE_2D,ae,0,0,Fe,rt,ke):n.texImage2D(t.TEXTURE_2D,ae,ot,Fe,rt,ke);T.generateMipmaps=!1}else if(ct){if(Ft){const ae=ue(Me);n.texStorage2D(t.TEXTURE_2D,be,ot,ae.width,ae.height)}V&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Fe,rt,Me)}else n.texImage2D(t.TEXTURE_2D,0,ot,Fe,rt,Me);x(T)&&v(me),Ve.__version=he.version,T.onUpdate&&T.onUpdate(T)}P.__version=T.version}function fe(P,T,Y){if(T.image.length!==6)return;const me=we(P,T),pe=T.source;n.bindTexture(t.TEXTURE_CUBE_MAP,P.__webglTexture,t.TEXTURE0+Y);const he=r.get(pe);if(pe.version!==he.__version||me===!0){n.activeTexture(t.TEXTURE0+Y);const Ve=Rt.getPrimaries(Rt.workingColorSpace),Ce=T.colorSpace===zs?null:Rt.getPrimaries(T.colorSpace),Ue=T.colorSpace===zs||Ve===Ce?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,T.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);const dt=T.isCompressedTexture||T.image[0].isCompressedTexture,Me=T.image[0]&&T.image[0].isDataTexture,Fe=[];for(let ge=0;ge<6;ge++)!dt&&!Me?Fe[ge]=w(T.image[ge],!0,o.maxCubemapSize):Fe[ge]=Me?T.image[ge].image:T.image[ge],Fe[ge]=Pt(T,Fe[ge]);const rt=Fe[0],ot=l.convert(T.format,T.colorSpace),ke=l.convert(T.type),xt=L(T.internalFormat,ot,ke,T.colorSpace),ct=T.isVideoTexture!==!0,Ft=he.__version===void 0||me===!0,V=pe.dataReady;let be=j(T,rt);q(t.TEXTURE_CUBE_MAP,T);let ae;if(dt){ct&&Ft&&n.texStorage2D(t.TEXTURE_CUBE_MAP,be,xt,rt.width,rt.height);for(let ge=0;ge<6;ge++){ae=Fe[ge].mipmaps;for(let Ie=0;Ie<ae.length;Ie++){const Le=ae[Ie];T.format!==cr?ot!==null?ct?V&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie,0,0,Le.width,Le.height,ot,Le.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie,xt,Le.width,Le.height,0,Le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ct?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie,0,0,Le.width,Le.height,ot,ke,Le.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie,xt,Le.width,Le.height,0,ot,ke,Le.data)}}}else{if(ae=T.mipmaps,ct&&Ft){ae.length>0&&be++;const ge=ue(Fe[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,be,xt,ge.width,ge.height)}for(let ge=0;ge<6;ge++)if(Me){ct?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,Fe[ge].width,Fe[ge].height,ot,ke,Fe[ge].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,xt,Fe[ge].width,Fe[ge].height,0,ot,ke,Fe[ge].data);for(let Ie=0;Ie<ae.length;Ie++){const ft=ae[Ie].image[ge].image;ct?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie+1,0,0,ft.width,ft.height,ot,ke,ft.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie+1,xt,ft.width,ft.height,0,ot,ke,ft.data)}}else{ct?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,ot,ke,Fe[ge]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,xt,ot,ke,Fe[ge]);for(let Ie=0;Ie<ae.length;Ie++){const Le=ae[Ie];ct?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie+1,0,0,ot,ke,Le.image[ge]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Ie+1,xt,ot,ke,Le.image[ge])}}}x(T)&&v(t.TEXTURE_CUBE_MAP),he.__version=pe.version,T.onUpdate&&T.onUpdate(T)}P.__version=T.version}function Se(P,T,Y,me,pe,he){const Ve=l.convert(Y.format,Y.colorSpace),Ce=l.convert(Y.type),Ue=L(Y.internalFormat,Ve,Ce,Y.colorSpace),dt=r.get(T),Me=r.get(Y);if(Me.__renderTarget=T,!dt.__hasExternalTextures){const Fe=Math.max(1,T.width>>he),rt=Math.max(1,T.height>>he);pe===t.TEXTURE_3D||pe===t.TEXTURE_2D_ARRAY?n.texImage3D(pe,he,Ue,Fe,rt,T.depth,0,Ve,Ce,null):n.texImage2D(pe,he,Ue,Fe,rt,0,Ve,Ce,null)}n.bindFramebuffer(t.FRAMEBUFFER,P),gt(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,me,pe,Me.__webglTexture,0,yt(T)):(pe===t.TEXTURE_2D||pe>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,me,pe,Me.__webglTexture,he),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ve(P,T,Y){if(t.bindRenderbuffer(t.RENDERBUFFER,P),T.depthBuffer){const me=T.depthTexture,pe=me&&me.isDepthTexture?me.type:null,he=R(T.stencilBuffer,pe),Ve=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ce=yt(T);gt(T)?f.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ce,he,T.width,T.height):Y?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ce,he,T.width,T.height):t.renderbufferStorage(t.RENDERBUFFER,he,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ve,t.RENDERBUFFER,P)}else{const me=T.textures;for(let pe=0;pe<me.length;pe++){const he=me[pe],Ve=l.convert(he.format,he.colorSpace),Ce=l.convert(he.type),Ue=L(he.internalFormat,Ve,Ce,he.colorSpace),dt=yt(T);Y&&gt(T)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,dt,Ue,T.width,T.height):gt(T)?f.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,dt,Ue,T.width,T.height):t.renderbufferStorage(t.RENDERBUFFER,Ue,T.width,T.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Re(P,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,P),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const me=r.get(T.depthTexture);me.__renderTarget=T,(!me.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),de(T.depthTexture,0);const pe=me.__webglTexture,he=yt(T);if(T.depthTexture.format===ba)gt(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,pe,0,he):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,pe,0);else if(T.depthTexture.format===Oa)gt(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,pe,0,he):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,pe,0);else throw new Error("Unknown depthTexture format")}function De(P){const T=r.get(P),Y=P.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==P.depthTexture){const me=P.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),me){const pe=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,me.removeEventListener("dispose",pe)};me.addEventListener("dispose",pe),T.__depthDisposeCallback=pe}T.__boundDepthTexture=me}if(P.depthTexture&&!T.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");Re(T.__webglFramebuffer,P)}else if(Y){T.__webglDepthbuffer=[];for(let me=0;me<6;me++)if(n.bindFramebuffer(t.FRAMEBUFFER,T.__webglFramebuffer[me]),T.__webglDepthbuffer[me]===void 0)T.__webglDepthbuffer[me]=t.createRenderbuffer(),ve(T.__webglDepthbuffer[me],P,!1);else{const pe=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,he=T.__webglDepthbuffer[me];t.bindRenderbuffer(t.RENDERBUFFER,he),t.framebufferRenderbuffer(t.FRAMEBUFFER,pe,t.RENDERBUFFER,he)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=t.createRenderbuffer(),ve(T.__webglDepthbuffer,P,!1);else{const me=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,pe=T.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,pe),t.framebufferRenderbuffer(t.FRAMEBUFFER,me,t.RENDERBUFFER,pe)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Qe(P,T,Y){const me=r.get(P);T!==void 0&&Se(me.__webglFramebuffer,P,P.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),Y!==void 0&&De(P)}function wt(P){const T=P.texture,Y=r.get(P),me=r.get(T);P.addEventListener("dispose",F);const pe=P.textures,he=P.isWebGLCubeRenderTarget===!0,Ve=pe.length>1;if(Ve||(me.__webglTexture===void 0&&(me.__webglTexture=t.createTexture()),me.__version=T.version,c.memory.textures++),he){Y.__webglFramebuffer=[];for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0){Y.__webglFramebuffer[Ce]=[];for(let Ue=0;Ue<T.mipmaps.length;Ue++)Y.__webglFramebuffer[Ce][Ue]=t.createFramebuffer()}else Y.__webglFramebuffer[Ce]=t.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){Y.__webglFramebuffer=[];for(let Ce=0;Ce<T.mipmaps.length;Ce++)Y.__webglFramebuffer[Ce]=t.createFramebuffer()}else Y.__webglFramebuffer=t.createFramebuffer();if(Ve)for(let Ce=0,Ue=pe.length;Ce<Ue;Ce++){const dt=r.get(pe[Ce]);dt.__webglTexture===void 0&&(dt.__webglTexture=t.createTexture(),c.memory.textures++)}if(P.samples>0&&gt(P)===!1){Y.__webglMultisampledFramebuffer=t.createFramebuffer(),Y.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let Ce=0;Ce<pe.length;Ce++){const Ue=pe[Ce];Y.__webglColorRenderbuffer[Ce]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,Y.__webglColorRenderbuffer[Ce]);const dt=l.convert(Ue.format,Ue.colorSpace),Me=l.convert(Ue.type),Fe=L(Ue.internalFormat,dt,Me,Ue.colorSpace,P.isXRRenderTarget===!0),rt=yt(P);t.renderbufferStorageMultisample(t.RENDERBUFFER,rt,Fe,P.width,P.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.RENDERBUFFER,Y.__webglColorRenderbuffer[Ce])}t.bindRenderbuffer(t.RENDERBUFFER,null),P.depthBuffer&&(Y.__webglDepthRenderbuffer=t.createRenderbuffer(),ve(Y.__webglDepthRenderbuffer,P,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(he){n.bindTexture(t.TEXTURE_CUBE_MAP,me.__webglTexture),q(t.TEXTURE_CUBE_MAP,T);for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0)for(let Ue=0;Ue<T.mipmaps.length;Ue++)Se(Y.__webglFramebuffer[Ce][Ue],P,T,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,Ue);else Se(Y.__webglFramebuffer[Ce],P,T,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0);x(T)&&v(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ve){for(let Ce=0,Ue=pe.length;Ce<Ue;Ce++){const dt=pe[Ce],Me=r.get(dt);n.bindTexture(t.TEXTURE_2D,Me.__webglTexture),q(t.TEXTURE_2D,dt),Se(Y.__webglFramebuffer,P,dt,t.COLOR_ATTACHMENT0+Ce,t.TEXTURE_2D,0),x(dt)&&v(t.TEXTURE_2D)}n.unbindTexture()}else{let Ce=t.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Ce=P.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Ce,me.__webglTexture),q(Ce,T),T.mipmaps&&T.mipmaps.length>0)for(let Ue=0;Ue<T.mipmaps.length;Ue++)Se(Y.__webglFramebuffer[Ue],P,T,t.COLOR_ATTACHMENT0,Ce,Ue);else Se(Y.__webglFramebuffer,P,T,t.COLOR_ATTACHMENT0,Ce,0);x(T)&&v(Ce),n.unbindTexture()}P.depthBuffer&&De(P)}function pt(P){const T=P.textures;for(let Y=0,me=T.length;Y<me;Y++){const pe=T[Y];if(x(pe)){const he=D(P),Ve=r.get(pe).__webglTexture;n.bindTexture(he,Ve),v(he),n.unbindTexture()}}}const Ot=[],G=[];function vn(P){if(P.samples>0){if(gt(P)===!1){const T=P.textures,Y=P.width,me=P.height;let pe=t.COLOR_BUFFER_BIT;const he=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ve=r.get(P),Ce=T.length>1;if(Ce)for(let Ue=0;Ue<T.length;Ue++)n.bindFramebuffer(t.FRAMEBUFFER,Ve.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ue,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ve.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ue,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ve.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ve.__webglFramebuffer);for(let Ue=0;Ue<T.length;Ue++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(pe|=t.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(pe|=t.STENCIL_BUFFER_BIT)),Ce){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ve.__webglColorRenderbuffer[Ue]);const dt=r.get(T[Ue]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,dt,0)}t.blitFramebuffer(0,0,Y,me,0,0,Y,me,pe,t.NEAREST),d===!0&&(Ot.length=0,G.length=0,Ot.push(t.COLOR_ATTACHMENT0+Ue),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Ot.push(he),G.push(he),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,G)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Ot))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Ce)for(let Ue=0;Ue<T.length;Ue++){n.bindFramebuffer(t.FRAMEBUFFER,Ve.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ue,t.RENDERBUFFER,Ve.__webglColorRenderbuffer[Ue]);const dt=r.get(T[Ue]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ve.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ue,t.TEXTURE_2D,dt,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ve.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&d){const T=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[T])}}}function yt(P){return Math.min(o.maxSamples,P.samples)}function gt(P){const T=r.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Je(P){const T=c.render.frame;g.get(P)!==T&&(g.set(P,T),P.update())}function Pt(P,T){const Y=P.colorSpace,me=P.format,pe=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||Y!==Ka&&Y!==zs&&(Rt.getTransfer(Y)===zt?(me!==cr||pe!==rs)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),T}function ue(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(p.width=P.naturalWidth||P.width,p.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(p.width=P.displayWidth,p.height=P.displayHeight):(p.width=P.width,p.height=P.height),p}this.allocateTextureUnit=K,this.resetTextureUnits=re,this.setTexture2D=de,this.setTexture2DArray=Q,this.setTexture3D=se,this.setTextureCube=k,this.rebindTextures=Qe,this.setupRenderTarget=wt,this.updateRenderTargetMipmap=pt,this.updateMultisampleRenderTarget=vn,this.setupDepthRenderbuffer=De,this.setupFrameBufferTexture=Se,this.useMultisampledRTT=gt}function OA(t,e){function n(r,o=zs){let l;const c=Rt.getTransfer(o);if(r===rs)return t.UNSIGNED_BYTE;if(r===Im)return t.UNSIGNED_SHORT_4_4_4_4;if(r===Nm)return t.UNSIGNED_SHORT_5_5_5_1;if(r===C2)return t.UNSIGNED_INT_5_9_9_9_REV;if(r===w2)return t.BYTE;if(r===A2)return t.SHORT;if(r===iu)return t.UNSIGNED_SHORT;if(r===Dm)return t.INT;if(r===Lo)return t.UNSIGNED_INT;if(r===ts)return t.FLOAT;if(r===lu)return t.HALF_FLOAT;if(r===R2)return t.ALPHA;if(r===b2)return t.RGB;if(r===cr)return t.RGBA;if(r===P2)return t.LUMINANCE;if(r===L2)return t.LUMINANCE_ALPHA;if(r===ba)return t.DEPTH_COMPONENT;if(r===Oa)return t.DEPTH_STENCIL;if(r===D2)return t.RED;if(r===Um)return t.RED_INTEGER;if(r===I2)return t.RG;if(r===Fm)return t.RG_INTEGER;if(r===Om)return t.RGBA_INTEGER;if(r===sf||r===of||r===af||r===lf)if(c===zt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(r===sf)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===of)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===af)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===lf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(r===sf)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===of)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===af)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===lf)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Op||r===kp||r===Bp||r===zp)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(r===Op)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===kp)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Bp)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===zp)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Vp||r===Hp||r===Gp)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(r===Vp||r===Hp)return c===zt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(r===Gp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Wp||r===Xp||r===jp||r===Yp||r===qp||r===$p||r===Kp||r===Zp||r===Qp||r===Jp||r===em||r===tm||r===nm||r===im)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(r===Wp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Xp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===jp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Yp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===qp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===$p)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Kp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Zp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Qp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Jp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===em)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===tm)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===nm)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===im)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===uf||r===rm||r===sm)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(r===uf)return c===zt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===rm)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===sm)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===N2||r===om||r===am||r===lm)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(r===uf)return l.COMPRESSED_RED_RGTC1_EXT;if(r===om)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===am)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===lm)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Fa?t.UNSIGNED_INT_24_8:t[r]!==void 0?t[r]:null}return{convert:n}}class kA extends Yi{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Zl extends On{constructor(){super(),this.isGroup=!0,this.type="Group"}}const BA={type:"move"};class fp{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Zl,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Zl,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new ie,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new ie),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Zl,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new ie,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new ie),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const r of e.hand.values())this._getHandJoint(n,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,r){let o=null,l=null,c=null;const f=this._targetRay,d=this._grip,p=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(p&&e.hand){c=!0;for(const w of e.hand.values()){const x=n.getJointPose(w,r),v=this._getHandJoint(p,w);x!==null&&(v.matrix.fromArray(x.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=x.radius),v.visible=x!==null}const g=p.joints["index-finger-tip"],_=p.joints["thumb-tip"],y=g.position.distanceTo(_.position),S=.02,E=.005;p.inputState.pinching&&y>S+E?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&y<=S-E&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else d!==null&&e.gripSpace&&(l=n.getPose(e.gripSpace,r),l!==null&&(d.matrix.fromArray(l.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,l.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(l.linearVelocity)):d.hasLinearVelocity=!1,l.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(l.angularVelocity)):d.hasAngularVelocity=!1));f!==null&&(o=n.getPose(e.targetRaySpace,r),o===null&&l!==null&&(o=l),o!==null&&(f.matrix.fromArray(o.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,o.linearVelocity?(f.hasLinearVelocity=!0,f.linearVelocity.copy(o.linearVelocity)):f.hasLinearVelocity=!1,o.angularVelocity?(f.hasAngularVelocity=!0,f.angularVelocity.copy(o.angularVelocity)):f.hasAngularVelocity=!1,this.dispatchEvent(BA)))}return f!==null&&(f.visible=o!==null),d!==null&&(d.visible=l!==null),p!==null&&(p.visible=c!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const r=new Zl;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[n.jointName]=r,e.add(r)}return e.joints[n.jointName]}}const zA=`
void main() {
...
void main() {
...
}`;class HA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,r){if(this.texture===null){const o=new mi,l=e.properties.get(o);l.__webglTexture=n.texture,(n.depthNear!=r.depthNear||n.depthFar!=r.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=o}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,r=new $i({vertexShader:zA,fragmentShader:VA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new fr(new Rf(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class GA extends Za{constructor(e,n){super();const r=this;let o=null,l=1,c=null,f="local-floor",d=1,p=null,g=null,_=null,y=null,S=null,E=null;const w=new HA,x=n.getContextAttributes();let v=null,D=null;const L=[],R=[],j=new Bt;let U=null;const F=new Yi;F.viewport=new ln;const H=new Yi;H.viewport=new ln;const b=[F,H],C=new kA;let B=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let fe=L[Z];return fe===void 0&&(fe=new fp,L[Z]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(Z){let fe=L[Z];return fe===void 0&&(fe=new fp,L[Z]=fe),fe.getGripSpace()},this.getHand=function(Z){let fe=L[Z];return fe===void 0&&(fe=new fp,L[Z]=fe),fe.getHandSpace()};function K(Z){const fe=R.indexOf(Z.inputSource);if(fe===-1)return;const Se=L[fe];Se!==void 0&&(Se.update(Z.inputSource,Z.frame,p||c),Se.dispatchEvent({type:Z.type,data:Z.inputSource}))}function ce(){o.removeEventListener("select",K),o.removeEventListener("selectstart",K),o.removeEventListener("selectend",K),o.removeEventListener("squeeze",K),o.removeEventListener("squeezestart",K),o.removeEventListener("squeezeend",K),o.removeEventListener("end",ce),o.removeEventListener("inputsourceschange",de);for(let Z=0;Z<L.length;Z++){const fe=R[Z];fe!==null&&(R[Z]=null,L[Z].disconnect(fe))}B=null,re=null,w.reset(),e.setRenderTarget(v),S=null,y=null,_=null,o=null,D=null,we.stop(),r.isPresenting=!1,e.setPixelRatio(U),e.setSize(j.width,j.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){l=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){f=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||c},this.setReferenceSpace=function(Z){p=Z},this.getBaseLayer=function(){return y!==null?y:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return o},this.setSession=async function(Z){if(o=Z,o!==null){if(v=e.getRenderTarget(),o.addEventListener("select",K),o.addEventListener("selectstart",K),o.addEventListener("selectend",K),o.addEventListener("squeeze",K),o.addEventListener("squeezestart",K),o.addEventListener("squeezeend",K),o.addEventListener("end",ce),o.addEventListener("inputsourceschange",de),x.xrCompatible!==!0&&await n.makeXRCompatible(),U=e.getPixelRatio(),e.getSize(j),o.renderState.layers===void 0){const fe={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:l};S=new XRWebGLLayer(o,n,fe),o.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),D=new Do(S.framebufferWidth,S.framebufferHeight,{format:cr,type:rs,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let fe=null,Se=null,ve=null;x.depth&&(ve=x.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,fe=x.stencil?Oa:ba,Se=x.stencil?Fa:Lo);const Re={colorFormat:n.RGBA8,depthFormat:ve,scaleFactor:l};_=new XRWebGLBinding(o,n),y=_.createProjectionLayer(Re),o.updateRenderState({layers:[y]}),e.setPixelRatio(1),e.setSize(y.textureWidth,y.textureHeight,!1),D=new Do(y.textureWidth,y.textureHeight,{format:cr,type:rs,depthTexture:new $2(y.textureWidth,y.textureHeight,Se,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1})}D.isXRRenderTarget=!0,this.setFoveation(d),p=null,c=await o.requestReferenceSpace(f),we.setContext(o),we.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(o!==null)return o.environmentBlendMode},this.getDepthTexture=function(){return w.getDepthTexture()};function de(Z){for(let fe=0;fe<Z.removed.length;fe++){const Se=Z.removed[fe],ve=R.indexOf(Se);ve>=0&&(R[ve]=null,L[ve].disconnect(Se))}for(let fe=0;fe<Z.added.length;fe++){const Se=Z.added[fe];let ve=R.indexOf(Se);if(ve===-1){for(let De=0;De<L.length;De++)if(De>=R.length){R.push(Se),ve=De;break}else if(R[De]===null){R[De]=Se,ve=De;break}if(ve===-1)break}const Re=L[ve];Re&&Re.connect(Se)}}const Q=new ie,se=new ie;function k(Z,fe,Se){Q.setFromMatrixPosition(fe.matrixWorld),se.setFromMatrixPosition(Se.matrixWorld);const ve=Q.distanceTo(se),Re=fe.projectionMatrix.elements,De=Se.projectionMatrix.elements,Qe=Re[14]/(Re[10]-1),wt=Re[14]/(Re[10]+1),pt=(Re[9]+1)/Re[5],Ot=(Re[9]-1)/Re[5],G=(Re[8]-1)/Re[0],vn=(De[8]+1)/De[0],yt=Qe*G,gt=Qe*vn,Je=ve/(-G+vn),Pt=Je*-G;if(fe.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Pt),Z.translateZ(Je),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Re[10]===-1)Z.projectionMatrix.copy(fe.projectionMatrix),Z.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const ue=Qe+Je,P=wt+Je,T=yt-Pt,Y=gt+(ve-Pt),me=pt*wt/P*ue,pe=Ot*wt/P*ue;Z.projectionMatrix.makePerspective(T,Y,me,pe,ue,P),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function le(Z,fe){fe===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(fe.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(o===null)return;let fe=Z.near,Se=Z.far;w.texture!==null&&(w.depthNear>0&&(fe=w.depthNear),w.depthFar>0&&(Se=w.depthFar)),C.near=H.near=F.near=fe,C.far=H.far=F.far=Se,(B!==C.near||re!==C.far)&&(o.updateRenderState({depthNear:C.near,depthFar:C.far}),B=C.near,re=C.far),F.layers.mask=Z.layers.mask|2,H.layers.mask=Z.layers.mask|4,C.layers.mask=F.layers.mask|H.layers.mask;const ve=Z.parent,Re=C.cameras;le(C,ve);for(let De=0;De<Re.length;De++)le(Re[De],ve);Re.length===2?k(C,F,H):C.projectionMatrix.copy(F.projectionMatrix),oe(Z,C,ve)};function oe(Z,fe,Se){Se===null?Z.matrix.copy(fe.matrixWorld):(Z.matrix.copy(Se.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(fe.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(fe.projectionMatrix),Z.projectionMatrixInverse.copy(fe.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=um*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(y===null&&S===null))return d},this.setFoveation=function(Z){d=Z,y!==null&&(y.fixedFoveation=Z),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=Z)},this.hasDepthSensing=function(){return w.texture!==null},this.getDepthSensingMesh=function(){return w.getMesh(C)};let N=null;function q(Z,fe){if(g=fe.getViewerPose(p||c),E=fe,g!==null){const Se=g.views;S!==null&&(e.setRenderTargetFramebuffer(D,S.framebuffer),e.setRenderTarget(D));let ve=!1;Se.length!==C.cameras.length&&(C.cameras.length=0,ve=!0);for(let De=0;De<Se.length;De++){const Qe=Se[De];let wt=null;if(S!==null)wt=S.getViewport(Qe);else{const Ot=_.getViewSubImage(y,Qe);wt=Ot.viewport,De===0&&(e.setRenderTargetTextures(D,Ot.colorTexture,y.ignoreDepthValues?void 0:Ot.depthStencilTexture),e.setRenderTarget(D))}let pt=b[De];pt===void 0&&(pt=new Yi,pt.layers.enable(De),pt.viewport=new ln,b[De]=pt),pt.matrix.fromArray(Qe.transform.matrix),pt.matrix.decompose(pt.position,pt.quaternion,pt.scale),pt.projectionMatrix.fromArray(Qe.projectionMatrix),pt.projectionMatrixInverse.copy(pt.projectionMatrix).invert(),pt.viewport.set(wt.x,wt.y,wt.width,wt.height),De===0&&(C.matrix.copy(pt.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),ve===!0&&C.cameras.push(pt)}const Re=o.enabledFeatures;if(Re&&Re.includes("depth-sensing")){const De=_.getDepthInformation(Se[0]);De&&De.isValid&&De.texture&&w.init(e,De,o.renderState)}}for(let Se=0;Se<L.length;Se++){const ve=R[Se],Re=L[Se];ve!==null&&Re!==void 0&&Re.update(ve,fe,p||c)}N&&N(Z,fe),fe.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:fe}),E=null}const we=new Y2;we.setAnimationLoop(q),this.setAnimationLoop=function(Z){N=Z},this.dispose=function(){}}}const mo=new ss,WA=new rn;function XA(t,e){function n(x,v){x.matrixAutoUpdate===!0&&x.updateMatrix(),v.value.copy(x.matrix)}function r(x,v){v.color.getRGB(x.fogColor.value,W2(t)),v.isFog?(x.fogNear.value=v.near,x.fogFar.value=v.far):v.isFogExp2&&(x.fogDensity.value=v.density)}function o(x,v,D,L,R){v.isMeshBasicMaterial||v.isMeshLambertMaterial?l(x,v):v.isMeshToonMaterial?(l(x,v),_(x,v)):v.isMeshPhongMaterial?(l(x,v),g(x,v)):v.isMeshStandardMaterial?(l(x,v),y(x,v),v.isMeshPhysicalMaterial&&S(x,v,R)):v.isMeshMatcapMaterial?(l(x,v),E(x,v)):v.isMeshDepthMaterial?l(x,v):v.isMeshDistanceMaterial?(l(x,v),w(x,v)):v.isMeshNormalMaterial?l(x,v):v.isLineBasicMaterial?(c(x,v),v.isLineDashedMaterial&&f(x,v)):v.isPointsMaterial?d(x,v,D,L):v.isSpriteMaterial?p(x,v):v.isShadowMaterial?(x.color.value.copy(v.color),x.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function l(x,v){x.opacity.value=v.opacity,v.color&&x.diffuse.value.copy(v.color),v.emissive&&x.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(x.map.value=v.map,n(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.bumpMap&&(x.bumpMap.value=v.bumpMap,n(v.bumpMap,x.bumpMapTransform),x.bumpScale.value=v.bumpScale,v.side===pi&&(x.bumpScale.value*=-1)),v.normalMap&&(x.normalMap.value=v.normalMap,n(v.normalMap,x.normalMapTransform),x.normalScale.value.copy(v.normalScale),v.side===pi&&x.normalScale.value.negate()),v.displacementMap&&(x.displacementMap.value=v.displacementMap,n(v.displacementMap,x.displacementMapTransform),x.displacementScale.value=v.displacementScale,x.displacementBias.value=v.displacementBias),v.emissiveMap&&(x.emissiveMap.value=v.emissiveMap,n(v.emissiveMap,x.emissiveMapTransform)),v.specularMap&&(x.specularMap.value=v.specularMap,n(v.specularMap,x.specularMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest);const D=e.get(v),L=D.envMap,R=D.envMapRotation;L&&(x.envMap.value=L,mo.copy(R),mo.x*=-1,mo.y*=-1,mo.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(mo.y*=-1,mo.z*=-1),x.envMapRotation.value.setFromMatrix4(WA.makeRotationFromEuler(mo)),x.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=v.reflectivity,x.ior.value=v.ior,x.refractionRatio.value=v.refractionRatio),v.lightMap&&(x.lightMap.value=v.lightMap,x.lightMapIntensity.value=v.lightMapIntensity,n(v.lightMap,x.lightMapTransform)),v.aoMap&&(x.aoMap.value=v.aoMap,x.aoMapIntensity.value=v.aoMapIntensity,n(v.aoMap,x.aoMapTransform))}function c(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,v.map&&(x.map.value=v.map,n(v.map,x.mapTransform))}function f(x,v){x.dashSize.value=v.dashSize,x.totalSize.value=v.dashSize+v.gapSize,x.scale.value=v.scale}function d(x,v,D,L){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.size.value=v.size*D,x.scale.value=L*.5,v.map&&(x.map.value=v.map,n(v.map,x.uvTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function p(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.rotation.value=v.rotation,v.map&&(x.map.value=v.map,n(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function g(x,v){x.specular.value.copy(v.specular),x.shininess.value=Math.max(v.shininess,1e-4)}function _(x,v){v.gradientMap&&(x.gradientMap.value=v.gradientMap)}function y(x,v){x.metalness.value=v.metalness,v.metalnessMap&&(x.metalnessMap.value=v.metalnessMap,n(v.metalnessMap,x.metalnessMapTransform)),x.roughness.value=v.roughness,v.roughnessMap&&(x.roughnessMap.value=v.roughnessMap,n(v.roughnessMap,x.roughnessMapTransform)),v.envMap&&(x.envMapIntensity.value=v.envMapIntensity)}function S(x,v,D){x.ior.value=v.ior,v.sheen>0&&(x.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),x.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(x.sheenColorMap.value=v.sheenColorMap,n(v.sheenColorMap,x.sheenColorMapTransform)),v.sheenRoughnessMap&&(x.sheenRoughnessMap.value=v.sheenRoughnessMap,n(v.sheenRoughnessMap,x.sheenRoughnessMapTransform))),v.clearcoat>0&&(x.clearcoat.value=v.clearcoat,x.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(x.clearcoatMap.value=v.clearcoatMap,n(v.clearcoatMap,x.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,n(v.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(x.clearcoatNormalMap.value=v.clearcoatNormalMap,n(v.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===pi&&x.clearcoatNormalScale.value.negate())),v.dispersion>0&&(x.dispersion.value=v.dispersion),v.iridescence>0&&(x.iridescence.value=v.iridescence,x.iridescenceIOR.value=v.iridescenceIOR,x.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(x.iridescenceMap.value=v.iridescenceMap,n(v.iridescenceMap,x.iridescenceMapTransform)),v.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=v.iridescenceThicknessMap,n(v.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),v.transmission>0&&(x.transmission.value=v.transmission,x.transmissionSamplerMap.value=D.texture,x.transmissionSamplerSize.value.set(D.width,D.height),v.transmissionMap&&(x.transmissionMap.value=v.transmissionMap,n(v.transmissionMap,x.transmissionMapTransform)),x.thickness.value=v.thickness,v.thicknessMap&&(x.thicknessMap.value=v.thicknessMap,n(v.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=v.attenuationDistance,x.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(x.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(x.anisotropyMap.value=v.anisotropyMap,n(v.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=v.specularIntensity,x.specularColor.value.copy(v.specularColor),v.specularColorMap&&(x.specularColorMap.value=v.specularColorMap,n(v.specularColorMap,x.specularColorMapTransform)),v.specularIntensityMap&&(x.specularIntensityMap.value=v.specularIntensityMap,n(v.specularIntensityMap,x.specularIntensityMapTransform))}function E(x,v){v.matcap&&(x.matcap.value=v.matcap)}function w(x,v){const D=e.get(v).light;x.referencePosition.value.setFromMatrixPosition(D.matrixWorld),x.nearDistance.value=D.shadow.camera.near,x.farDistance.value=D.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:o}}function jA(t,e,n,r){let o={},l={},c=[];const f=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function d(D,L){const R=L.program;r.uniformBlockBinding(D,R)}function p(D,L){let R=o[D.id];R===void 0&&(E(D),R=g(D),o[D.id]=R,D.addEventListener("dispose",x));const j=L.program;r.updateUBOMapping(D,j);const U=e.render.frame;l[D.id]!==U&&(y(D),l[D.id]=U)}function g(D){const L=_();D.__bindingPointIndex=L;const R=t.createBuffer(),j=D.__size,U=D.usage;return t.bindBuffer(t.UNIFORM_BUFFER,R),t.bufferData(t.UNIFORM_BUFFER,j,U),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,L,R),R}function _(){for(let D=0;D<f;D++)if(c.indexOf(D)===-1)return c.push(D),D;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(D){const L=o[D.id],R=D.uniforms,j=D.__cache;t.bindBuffer(t.UNIFORM_BUFFER,L);for(let U=0,F=R.length;U<F;U++){const H=Array.isArray(R[U])?R[U]:[R[U]];for(let b=0,C=H.length;b<C;b++){const B=H[b];if(S(B,U,b,j)===!0){const re=B.__offset,K=Array.isArray(B.value)?B.value:[B.value];let ce=0;for(let de=0;de<K.length;de++){const Q=K[de],se=w(Q);typeof Q=="number"||typeof Q=="boolean"?(B.__data[0]=Q,t.bufferSubData(t.UNIFORM_BUFFER,re+ce,B.__data)):Q.isMatrix3?(B.__data[0]=Q.elements[0],B.__data[1]=Q.elements[1],B.__data[2]=Q.elements[2],B.__data[3]=0,B.__data[4]=Q.elements[3],B.__data[5]=Q.elements[4],B.__data[6]=Q.elements[5],B.__data[7]=0,B.__data[8]=Q.elements[6],B.__data[9]=Q.elements[7],B.__data[10]=Q.elements[8],B.__data[11]=0):(Q.toArray(B.__data,ce),ce+=se.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,re,B.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function S(D,L,R,j){const U=D.value,F=L+"_"+R;if(j[F]===void 0)return typeof U=="number"||typeof U=="boolean"?j[F]=U:j[F]=U.clone(),!0;{const H=j[F];if(typeof U=="number"||typeof U=="boolean"){if(H!==U)return j[F]=U,!0}else if(H.equals(U)===!1)return H.copy(U),!0}return!1}function E(D){const L=D.uniforms;let R=0;const j=16;for(let F=0,H=L.length;F<H;F++){const b=Array.isArray(L[F])?L[F]:[L[F]];for(let C=0,B=b.length;C<B;C++){const re=b[C],K=Array.isArray(re.value)?re.value:[re.value];for(let ce=0,de=K.length;ce<de;ce++){const Q=K[ce],se=w(Q),k=R%j,le=k%se.boundary,oe=k+le;R+=le,oe!==0&&j-oe<se.storage&&(R+=j-oe),re.__data=new Float32Array(se.storage/Float32Array.BYTES_PER_ELEMENT),re.__offset=R,R+=se.storage}}}const U=R%j;return U>0&&(R+=j-U),D.__size=R,D.__cache={},this}function w(D){const L={boundary:0,storage:0};return typeof D=="number"||typeof D=="boolean"?(L.boundary=4,L.storage=4):D.isVector2?(L.boundary=8,L.storage=8):D.isVector3||D.isColor?(L.boundary=16,L.storage=12):D.isVector4?(L.boundary=16,L.storage=16):D.isMatrix3?(L.boundary=48,L.storage=48):D.isMatrix4?(L.boundary=64,L.storage=64):D.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",D),L}function x(D){const L=D.target;L.removeEventListener("dispose",x);const R=c.indexOf(L.__bindingPointIndex);c.splice(R,1),t.deleteBuffer(o[L.id]),delete o[L.id],delete l[L.id]}function v(){for(const D in o)t.deleteBuffer(o[D]);c=[],o={},l={}}return{bind:d,update:p,dispose:v}}class YA{constructor(e={}){const{canvas:n=UM(),context:r=null,depth:o=!0,stencil:l=!1,alpha:c=!1,antialias:f=!1,premultipliedAlpha:d=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:y=!1}=e;this.isWebGLRenderer=!0;let S;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=r.getContextAttributes().alpha}else S=c;const E=new Uint32Array(4),w=new Int32Array(4);let x=null,v=null;const D=[],L=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ji,this.toneMapping=Gs,this.toneMappingExposure=1;const R=this;let j=!1,U=0,F=0,H=null,b=-1,C=null;const B=new ln,re=new ln;let K=null;const ce=new vt(0);let de=0,Q=n.width,se=n.height,k=1,le=null,oe=null;const N=new ln(0,0,Q,se),q=new ln(0,0,Q,se);let we=!1;const Z=new Bm;let fe=!1,Se=!1;const ve=new rn,Re=new rn,De=new ie,Qe=new ln,wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let pt=!1;function Ot(){return H===null?k:1}let G=r;function vn(A,W){return n.getContext(A,W)}try{const A={alpha:!0,depth:o,stencil:l,antialias:f,premultipliedAlpha:d,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Lm}`),n.addEventListener("webglcontextlost",ge,!1),n.addEventListener("webglcontextrestored",Ie,!1),n.addEventListener("webglcontextcreationerror",Le,!1),G===null){const W="webgl2";if(G=vn(W,A),G===null)throw vn(W)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let yt,gt,Je,Pt,ue,P,T,Y,me,pe,he,Ve,Ce,Ue,dt,Me,Fe,rt,ot,ke,xt,ct,Ft,V;function be(){yt=new Q4(G),yt.init(),ct=new OA(G,yt),gt=new j4(G,yt,e,ct),Je=new NA(G,yt),gt.reverseDepthBuffer&&y&&Je.buffers.depth.setReversed(!0),Pt=new tw(G),ue=new yA,P=new FA(G,yt,Je,ue,gt,ct,Pt),T=new q4(R),Y=new Z4(R),me=new lE(G),Ft=new W4(G,me),pe=new J4(G,me,Pt,Ft),he=new iw(G,pe,me,Pt),ot=new nw(G,gt,P),Me=new Y4(ue),Ve=new vA(R,T,Y,yt,gt,Ft,Me),Ce=new XA(R,ue),Ue=new SA,dt=new CA(yt),rt=new G4(R,T,Y,Je,he,S,d),Fe=new DA(R,he,gt),V=new jA(G,Pt,gt,Je),ke=new X4(G,yt,Pt),xt=new ew(G,yt,Pt),Pt.programs=Ve.programs,R.capabilities=gt,R.extensions=yt,R.properties=ue,R.renderLists=Ue,R.shadowMap=Fe,R.state=Je,R.info=Pt}be();const ae=new GA(R,G);this.xr=ae,this.getContext=function(){return G},this.getContextAttributes=function(){return G.getContextAttributes()},this.forceContextLoss=function(){const A=yt.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=yt.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return k},this.setPixelRatio=function(A){A!==void 0&&(k=A,this.setSize(Q,se,!1))},this.getSize=function(A){return A.set(Q,se)},this.setSize=function(A,W,te=!0){if(ae.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Q=A,se=W,n.width=Math.floor(A*k),n.height=Math.floor(W*k),te===!0&&(n.style.width=A+"px",n.style.height=W+"px"),this.setViewport(0,0,A,W)},this.getDrawingBufferSize=function(A){return A.set(Q*k,se*k).floor()},this.setDrawingBufferSize=function(A,W,te){Q=A,se=W,k=te,n.width=Math.floor(A*te),n.height=Math.floor(W*te),this.setViewport(0,0,A,W)},this.getCurrentViewport=function(A){return A.copy(B)},this.getViewport=function(A){return A.copy(N)},this.setViewport=function(A,W,te,ne){A.isVector4?N.set(A.x,A.y,A.z,A.w):N.set(A,W,te,ne),Je.viewport(B.copy(N).multiplyScalar(k).round())},this.getScissor=function(A){return A.copy(q)},this.setScissor=function(A,W,te,ne){A.isVector4?q.set(A.x,A.y,A.z,A.w):q.set(A,W,te,ne),Je.scissor(re.copy(q).multiplyScalar(k).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(A){Je.setScissorTest(we=A)},this.setOpaqueSort=function(A){le=A},this.setTransparentSort=function(A){oe=A},this.getClearColor=function(A){return A.copy(rt.getClearColor())},this.setClearColor=function(){rt.setClearColor.apply(rt,arguments)},this.getClearAlpha=function(){return rt.getClearAlpha()},this.setClearAlpha=function(){rt.setClearAlpha.apply(rt,arguments)},this.clear=function(A=!0,W=!0,te=!0){let ne=0;if(A){let X=!1;if(H!==null){const Ae=H.texture.format;X=Ae===Om||Ae===Fm||Ae===Um}if(X){const Ae=H.texture.type,Ee=Ae===rs||Ae===Lo||Ae===iu||Ae===Fa||Ae===Im||Ae===Nm,We=rt.getClearColor(),He=rt.getClearAlpha(),at=We.r,ut=We.g,Xe=We.b;Ee?(E[0]=at,E[1]=ut,E[2]=Xe,E[3]=He,G.clearBufferuiv(G.COLOR,0,E)):(w[0]=at,w[1]=ut,w[2]=Xe,w[3]=He,G.clearBufferiv(G.COLOR,0,w))}else ne|=G.COLOR_BUFFER_BIT}W&&(ne|=G.DEPTH_BUFFER_BIT),te&&(ne|=G.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G.clear(ne)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ge,!1),n.removeEventListener("webglcontextrestored",Ie,!1),n.removeEventListener("webglcontextcreationerror",Le,!1),Ue.dispose(),dt.dispose(),ue.dispose(),T.dispose(),Y.dispose(),he.dispose(),Ft.dispose(),V.dispose(),Ve.dispose(),ae.dispose(),ae.removeEventListener("sessionstart",Bo),ae.removeEventListener("sessionend",cs),Fr.stop()};function ge(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),j=!0}function Ie(){console.log("THREE.WebGLRenderer: Context Restored."),j=!1;const A=Pt.autoReset,W=Fe.enabled,te=Fe.autoUpdate,ne=Fe.needsUpdate,X=Fe.type;be(),Pt.autoReset=A,Fe.enabled=W,Fe.autoUpdate=te,Fe.needsUpdate=ne,Fe.type=X}function Le(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function ft(A){const W=A.target;W.removeEventListener("dispose",ft),Xt(W)}function Xt(A){yn(A),ue.remove(A)}function yn(A){const W=ue.get(A).programs;W!==void 0&&(W.forEach(function(te){Ve.releaseProgram(te)}),A.isShaderMaterial&&Ve.releaseShaderCache(A))}this.renderBufferDirect=function(A,W,te,ne,X,Ae){W===null&&(W=wt);const Ee=X.isMesh&&X.matrixWorld.determinant()<0,We=Tu(A,W,te,ne,X);Je.setMaterial(ne,Ee);let He=te.index,at=1;if(ne.wireframe===!0){if(He=pe.getWireframeAttribute(te),He===void 0)return;at=2}const ut=te.drawRange,Xe=te.attributes.position;let Et=ut.start*at,Nt=(ut.start+ut.count)*at;Ae!==null&&(Et=Math.max(Et,Ae.start*at),Nt=Math.min(Nt,(Ae.start+Ae.count)*at)),He!==null?(Et=Math.max(Et,0),Nt=Math.min(Nt,He.count)):Xe!=null&&(Et=Math.max(Et,0),Nt=Math.min(Nt,Xe.count));const Mt=Nt-Et;if(Mt<0||Mt===1/0)return;Ft.setup(X,ne,We,te,He);let Bn,ht=ke;if(He!==null&&(Bn=me.get(He),ht=xt,ht.setIndex(Bn)),X.isMesh)ne.wireframe===!0?(Je.setLineWidth(ne.wireframeLinewidth*Ot()),ht.setMode(G.LINES)):ht.setMode(G.TRIANGLES);else if(X.isLine){let qe=ne.linewidth;qe===void 0&&(qe=1),Je.setLineWidth(qe*Ot()),X.isLineSegments?ht.setMode(G.LINES):X.isLineLoop?ht.setMode(G.LINE_LOOP):ht.setMode(G.LINE_STRIP)}else X.isPoints?ht.setMode(G.POINTS):X.isSprite&&ht.setMode(G.TRIANGLES);if(X.isBatchedMesh)if(X._multiDrawInstances!==null)ht.renderMultiDrawInstances(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount,X._multiDrawInstances);else if(yt.get("WEBGL_multi_draw"))ht.renderMultiDraw(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount);else{const qe=X._multiDrawStarts,Qi=X._multiDrawCounts,Lt=X._multiDrawCount,zn=He?me.get(He).bytesPerElement:1,Ji=ue.get(ne).currentProgram.getUniforms();for(let xn=0;xn<Lt;xn++)Ji.setValue(G,"_gl_DrawID",xn),ht.render(qe[xn]/zn,Qi[xn])}else if(X.isInstancedMesh)ht.renderInstances(Et,Mt,X.count);else if(te.isInstancedBufferGeometry){const qe=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Qi=Math.min(te.instanceCount,qe);ht.renderInstances(Et,Mt,Qi)}else ht.render(Et,Mt)};function At(A,W,te){A.transparent===!0&&A.side===Jr&&A.forceSinglePass===!1?(A.side=pi,A.needsUpdate=!0,zo(A,W,te),A.side=Xs,A.needsUpdate=!0,zo(A,W,te),A.side=Jr):zo(A,W,te)}this.compile=function(A,W,te=null){te===null&&(te=A),v=dt.get(te),v.init(W),L.push(v),te.traverseVisible(function(X){X.isLight&&X.layers.test(W.layers)&&(v.pushLight(X),X.castShadow&&v.pushShadow(X))}),A!==te&&A.traverseVisible(function(X){X.isLight&&X.layers.test(W.layers)&&(v.pushLight(X),X.castShadow&&v.pushShadow(X))}),v.setupLights();const ne=new Set;return A.traverse(function(X){if(!(X.isMesh||X.isPoints||X.isLine||X.isSprite))return;const Ae=X.material;if(Ae)if(Array.isArray(Ae))for(let Ee=0;Ee<Ae.length;Ee++){const We=Ae[Ee];At(We,te,X),ne.add(We)}else At(Ae,te,X),ne.add(Ae)}),L.pop(),v=null,ne},this.compileAsync=function(A,W,te=null){const ne=this.compile(A,W,te);return new Promise(X=>{function Ae(){if(ne.forEach(function(Ee){ue.get(Ee).currentProgram.isReady()&&ne.delete(Ee)}),ne.size===0){X(A);return}setTimeout(Ae,10)}yt.get("KHR_parallel_shader_compile")!==null?Ae():setTimeout(Ae,10)})};let ni=null;function Zn(A){ni&&ni(A)}function Bo(){Fr.stop()}function cs(){Fr.start()}const Fr=new Y2;Fr.setAnimationLoop(Zn),typeof self<"u"&&Fr.setContext(self),this.setAnimationLoop=function(A){ni=A,ae.setAnimationLoop(A),A===null?Fr.stop():Fr.start()},ae.addEventListener("sessionstart",Bo),ae.addEventListener("sessionend",cs),this.render=function(A,W){if(W!==void 0&&W.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(j===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),W.parent===null&&W.matrixWorldAutoUpdate===!0&&W.updateMatrixWorld(),ae.enabled===!0&&ae.isPresenting===!0&&(ae.cameraAutoUpdate===!0&&ae.updateCamera(W),W=ae.getCamera()),A.isScene===!0&&A.onBeforeRender(R,A,W,H),v=dt.get(A,L.length),v.init(W),L.push(v),Re.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),Z.setFromProjectionMatrix(Re),Se=this.localClippingEnabled,fe=Me.init(this.clippingPlanes,Se),x=Ue.get(A,D.length),x.init(),D.push(x),ae.enabled===!0&&ae.isPresenting===!0){const Ae=R.xr.getDepthSensingMesh();Ae!==null&&Or(Ae,W,-1/0,R.sortObjects)}Or(A,W,0,R.sortObjects),x.finish(),R.sortObjects===!0&&x.sort(le,oe),pt=ae.enabled===!1||ae.isPresenting===!1||ae.hasDepthSensing()===!1,pt&&rt.addToRenderList(x,A),this.info.render.frame++,fe===!0&&Me.beginShadows();const te=v.state.shadowsArray;Fe.render(te,A,W),fe===!0&&Me.endShadows(),this.info.autoReset===!0&&this.info.reset();const ne=x.opaque,X=x.transmissive;if(v.setupLights(),W.isArrayCamera){const Ae=W.cameras;if(X.length>0)for(let Ee=0,We=Ae.length;Ee<We;Ee++){const He=Ae[Ee];Ks(ne,X,A,He)}pt&&rt.render(A);for(let Ee=0,We=Ae.length;Ee<We;Ee++){const He=Ae[Ee];$s(x,A,He,He.viewport)}}else X.length>0&&Ks(ne,X,A,W),pt&&rt.render(A),$s(x,A,W);H!==null&&(P.updateMultisampleRenderTarget(H),P.updateRenderTargetMipmap(H)),A.isScene===!0&&A.onAfterRender(R,A,W),Ft.resetDefaultState(),b=-1,C=null,L.pop(),L.length>0?(v=L[L.length-1],fe===!0&&Me.setGlobalState(R.clippingPlanes,v.state.camera)):v=null,D.pop(),D.length>0?x=D[D.length-1]:x=null};function Or(A,W,te,ne){if(A.visible===!1)return;if(A.layers.test(W.layers)){if(A.isGroup)te=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(W);else if(A.isLight)v.pushLight(A),A.castShadow&&v.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Z.intersectsSprite(A)){ne&&Qe.setFromMatrixPosition(A.matrixWorld).applyMatrix4(Re);const Ee=he.update(A),We=A.material;We.visible&&x.push(A,Ee,We,te,Qe.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Z.intersectsObject(A))){const Ee=he.update(A),We=A.material;if(ne&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Qe.copy(A.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),Qe.copy(Ee.boundingSphere.center)),Qe.applyMatrix4(A.matrixWorld).applyMatrix4(Re)),Array.isArray(We)){const He=Ee.groups;for(let at=0,ut=He.length;at<ut;at++){const Xe=He[at],Et=We[Xe.materialIndex];Et&&Et.visible&&x.push(A,Ee,Et,te,Qe.z,Xe)}}else We.visible&&x.push(A,Ee,We,te,Qe.z,null)}}const Ae=A.children;for(let Ee=0,We=Ae.length;Ee<We;Ee++)Or(Ae[Ee],W,te,ne)}function $s(A,W,te,ne){const X=A.opaque,Ae=A.transmissive,Ee=A.transparent;v.setupLightsView(te),fe===!0&&Me.setGlobalState(R.clippingPlanes,te),ne&&Je.viewport(B.copy(ne)),X.length>0&&fs(X,W,te),Ae.length>0&&fs(Ae,W,te),Ee.length>0&&fs(Ee,W,te),Je.buffers.depth.setTest(!0),Je.buffers.depth.setMask(!0),Je.buffers.color.setMask(!0),Je.setPolygonOffset(!1)}function Ks(A,W,te,ne){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;v.state.transmissionRenderTarget[ne.id]===void 0&&(v.state.transmissionRenderTarget[ne.id]=new Do(1,1,{generateMipmaps:!0,type:yt.has("EXT_color_buffer_half_float")||yt.has("EXT_color_buffer_float")?lu:rs,minFilter:Mo,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Rt.workingColorSpace}));const Ae=v.state.transmissionRenderTarget[ne.id],Ee=ne.viewport||B;Ae.setSize(Ee.z,Ee.w);const We=R.getRenderTarget();R.setRenderTarget(Ae),R.getClearColor(ce),de=R.getClearAlpha(),de<1&&R.setClearColor(16777215,.5),R.clear(),pt&&rt.render(te);const He=R.toneMapping;R.toneMapping=Gs;const at=ne.viewport;if(ne.viewport!==void 0&&(ne.viewport=void 0),v.setupLightsView(ne),fe===!0&&Me.setGlobalState(R.clippingPlanes,ne),fs(A,te,ne),P.updateMultisampleRenderTarget(Ae),P.updateRenderTargetMipmap(Ae),yt.has("WEBGL_multisampled_render_to_texture")===!1){let ut=!1;for(let Xe=0,Et=W.length;Xe<Et;Xe++){const Nt=W[Xe],Mt=Nt.object,Bn=Nt.geometry,ht=Nt.material,qe=Nt.group;if(ht.side===Jr&&Mt.layers.test(ne.layers)){const Qi=ht.side;ht.side=pi,ht.needsUpdate=!0,Mu(Mt,te,ne,Bn,ht,qe),ht.side=Qi,ht.needsUpdate=!0,ut=!0}}ut===!0&&(P.updateMultisampleRenderTarget(Ae),P.updateRenderTargetMipmap(Ae))}R.setRenderTarget(We),R.setClearColor(ce,de),at!==void 0&&(ne.viewport=at),R.toneMapping=He}function fs(A,W,te){const ne=W.isScene===!0?W.overrideMaterial:null;for(let X=0,Ae=A.length;X<Ae;X++){const Ee=A[X],We=Ee.object,He=Ee.geometry,at=ne===null?Ee.material:ne,ut=Ee.group;We.layers.test(te.layers)&&Mu(We,W,te,He,at,ut)}}function Mu(A,W,te,ne,X,Ae){A.onBeforeRender(R,W,te,ne,X,Ae),A.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),X.onBeforeRender(R,W,te,ne,A,Ae),X.transparent===!0&&X.side===Jr&&X.forceSinglePass===!1?(X.side=pi,X.needsUpdate=!0,R.renderBufferDirect(te,W,ne,X,A,Ae),X.side=Xs,X.needsUpdate=!0,R.renderBufferDirect(te,W,ne,X,A,Ae),X.side=Jr):R.renderBufferDirect(te,W,ne,X,A,Ae),A.onAfterRender(R,W,te,ne,X,Ae)}function zo(A,W,te){W.isScene!==!0&&(W=wt);const ne=ue.get(A),X=v.state.lights,Ae=v.state.shadowsArray,Ee=X.state.version,We=Ve.getParameters(A,X.state,Ae,W,te),He=Ve.getProgramCacheKey(We);let at=ne.programs;ne.environment=A.isMeshStandardMaterial?W.environment:null,ne.fog=W.fog,ne.envMap=(A.isMeshStandardMaterial?Y:T).get(A.envMap||ne.environment),ne.envMapRotation=ne.environment!==null&&A.envMap===null?W.environmentRotation:A.envMapRotation,at===void 0&&(A.addEventListener("dispose",ft),at=new Map,ne.programs=at);let ut=at.get(He);if(ut!==void 0){if(ne.currentProgram===ut&&ne.lightsStateVersion===Ee)return _r(A,We),ut}else We.uniforms=Ve.getUniforms(A),A.onBeforeCompile(We,R),ut=Ve.acquireProgram(We,He),at.set(He,ut),ne.uniforms=We.uniforms;const Xe=ne.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Xe.clippingPlanes=Me.uniform),_r(A,We),ne.needsLights=Jf(A),ne.lightsStateVersion=Ee,ne.needsLights&&(Xe.ambientLightColor.value=X.state.ambient,Xe.lightProbe.value=X.state.probe,Xe.directionalLights.value=X.state.directional,Xe.directionalLightShadows.value=X.state.directionalShadow,Xe.spotLights.value=X.state.spot,Xe.spotLightShadows.value=X.state.spotShadow,Xe.rectAreaLights.value=X.state.rectArea,Xe.ltc_1.value=X.state.rectAreaLTC1,Xe.ltc_2.value=X.state.rectAreaLTC2,Xe.pointLights.value=X.state.point,Xe.pointLightShadows.value=X.state.pointShadow,Xe.hemisphereLights.value=X.state.hemi,Xe.directionalShadowMap.value=X.state.directionalShadowMap,Xe.directionalShadowMatrix.value=X.state.directionalShadowMatrix,Xe.spotShadowMap.value=X.state.spotShadowMap,Xe.spotLightMatrix.value=X.state.spotLightMatrix,Xe.spotLightMap.value=X.state.spotLightMap,Xe.pointShadowMap.value=X.state.pointShadowMap,Xe.pointShadowMatrix.value=X.state.pointShadowMatrix),ne.currentProgram=ut,ne.uniformsList=null,ut}function Eu(A){if(A.uniformsList===null){const W=A.currentProgram.getUniforms();A.uniformsList=cf.seqWithValue(W.seq,A.uniforms)}return A.uniformsList}function _r(A,W){const te=ue.get(A);te.outputColorSpace=W.outputColorSpace,te.batching=W.batching,te.batchingColor=W.batchingColor,te.instancing=W.instancing,te.instancingColor=W.instancingColor,te.instancingMorph=W.instancingMorph,te.skinning=W.skinning,te.morphTargets=W.morphTargets,te.morphNormals=W.morphNormals,te.morphColors=W.morphColors,te.morphTargetsCount=W.morphTargetsCount,te.numClippingPlanes=W.numClippingPlanes,te.numIntersection=W.numClipIntersection,te.vertexAlphas=W.vertexAlphas,te.vertexTangents=W.vertexTangents,te.toneMapping=W.toneMapping}function Tu(A,W,te,ne,X){W.isScene!==!0&&(W=wt),P.resetTextureUnits();const Ae=W.fog,Ee=ne.isMeshStandardMaterial?W.environment:null,We=H===null?R.outputColorSpace:H.isXRRenderTarget===!0?H.texture.colorSpace:Ka,He=(ne.isMeshStandardMaterial?Y:T).get(ne.envMap||Ee),at=ne.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,ut=!!te.attributes.tangent&&(!!ne.normalMap||ne.anisotropy>0),Xe=!!te.morphAttributes.position,Et=!!te.morphAttributes.normal,Nt=!!te.morphAttributes.color;let Mt=Gs;ne.toneMapped&&(H===null||H.isXRRenderTarget===!0)&&(Mt=R.toneMapping);const Bn=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,ht=Bn!==void 0?Bn.length:0,qe=ue.get(ne),Qi=v.state.lights;if(fe===!0&&(Se===!0||A!==C)){const Qn=A===C&&ne.id===b;Me.setState(ne,A,Qn)}let Lt=!1;ne.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==Qi.state.version||qe.outputColorSpace!==We||X.isBatchedMesh&&qe.batching===!1||!X.isBatchedMesh&&qe.batching===!0||X.isBatchedMesh&&qe.batchingColor===!0&&X.colorTexture===null||X.isBatchedMesh&&qe.batchingColor===!1&&X.colorTexture!==null||X.isInstancedMesh&&qe.instancing===!1||!X.isInstancedMesh&&qe.instancing===!0||X.isSkinnedMesh&&qe.skinning===!1||!X.isSkinnedMesh&&qe.skinning===!0||X.isInstancedMesh&&qe.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&qe.instancingColor===!1&&X.instanceColor!==null||X.isInstancedMesh&&qe.instancingMorph===!0&&X.morphTexture===null||X.isInstancedMesh&&qe.instancingMorph===!1&&X.morphTexture!==null||qe.envMap!==He||ne.fog===!0&&qe.fog!==Ae||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==Me.numPlanes||qe.numIntersection!==Me.numIntersection)||qe.vertexAlphas!==at||qe.vertexTangents!==ut||qe.morphTargets!==Xe||qe.morphNormals!==Et||qe.morphColors!==Nt||qe.toneMapping!==Mt||qe.morphTargetsCount!==ht)&&(Lt=!0):(Lt=!0,qe.__version=ne.version);let zn=qe.currentProgram;Lt===!0&&(zn=zo(ne,W,X));let Ji=!1,xn=!1,vr=!1;const Ht=zn.getUniforms(),Ni=qe.uniforms;if(Je.useProgram(zn.program)&&(Ji=!0,xn=!0,vr=!0),ne.id!==b&&(b=ne.id,xn=!0),Ji||C!==A){Je.buffers.depth.getReversed()?(ve.copy(A.projectionMatrix),OM(ve),kM(ve),Ht.setValue(G,"projectionMatrix",ve)):Ht.setValue(G,"projectionMatrix",A.projectionMatrix),Ht.setValue(G,"viewMatrix",A.matrixWorldInverse);const Ui=Ht.map.cameraPosition;Ui!==void 0&&Ui.setValue(G,De.setFromMatrixPosition(A.matrixWorld)),gt.logarithmicDepthBuffer&&Ht.setValue(G,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(ne.isMeshPhongMaterial||ne.isMeshToonMaterial||ne.isMeshLambertMaterial||ne.isMeshBasicMaterial||ne.isMeshStandardMaterial||ne.isShaderMaterial)&&Ht.setValue(G,"isOrthographic",A.isOrthographicCamera===!0),C!==A&&(C=A,xn=!0,vr=!0)}if(X.isSkinnedMesh){Ht.setOptional(G,X,"bindMatrix"),Ht.setOptional(G,X,"bindMatrixInverse");const Qn=X.skeleton;Qn&&(Qn.boneTexture===null&&Qn.computeBoneTexture(),Ht.setValue(G,"boneTexture",Qn.boneTexture,P))}X.isBatchedMesh&&(Ht.setOptional(G,X,"batchingTexture"),Ht.setValue(G,"batchingTexture",X._matricesTexture,P),Ht.setOptional(G,X,"batchingIdTexture"),Ht.setValue(G,"batchingIdTexture",X._indirectTexture,P),Ht.setOptional(G,X,"batchingColorTexture"),X._colorsTexture!==null&&Ht.setValue(G,"batchingColorTexture",X._colorsTexture,P));const kr=te.morphAttributes;if((kr.position!==void 0||kr.normal!==void 0||kr.color!==void 0)&&ot.update(X,te,zn),(xn||qe.receiveShadow!==X.receiveShadow)&&(qe.receiveShadow=X.receiveShadow,Ht.setValue(G,"receiveShadow",X.receiveShadow)),ne.isMeshGouraudMaterial&&ne.envMap!==null&&(Ni.envMap.value=He,Ni.flipEnvMap.value=He.isCubeTexture&&He.isRenderTargetTexture===!1?-1:1),ne.isMeshStandardMaterial&&ne.envMap===null&&W.environment!==null&&(Ni.envMapIntensity.value=W.environmentIntensity),xn&&(Ht.setValue(G,"toneMappingExposure",R.toneMappingExposure),qe.needsLights&&wu(Ni,vr),Ae&&ne.fog===!0&&Ce.refreshFogUniforms(Ni,Ae),Ce.refreshMaterialUniforms(Ni,ne,k,se,v.state.transmissionRenderTarget[A.id]),cf.upload(G,Eu(qe),Ni,P)),ne.isShaderMaterial&&ne.uniformsNeedUpdate===!0&&(cf.upload(G,Eu(qe),Ni,P),ne.uniformsNeedUpdate=!1),ne.isSpriteMaterial&&Ht.setValue(G,"center",X.center),Ht.setValue(G,"modelViewMatrix",X.modelViewMatrix),Ht.setValue(G,"normalMatrix",X.normalMatrix),Ht.setValue(G,"modelMatrix",X.matrixWorld),ne.isShaderMaterial||ne.isRawShaderMaterial){const Qn=ne.uniformsGroups;for(let Ui=0,ii=Qn.length;Ui<ii;Ui++){const Au=Qn[Ui];V.update(Au,zn),V.bind(Au,zn)}}return zn}function wu(A,W){A.ambientLightColor.needsUpdate=W,A.lightProbe.needsUpdate=W,A.directionalLights.needsUpdate=W,A.directionalLightShadows.needsUpdate=W,A.pointLights.needsUpdate=W,A.pointLightShadows.needsUpdate=W,A.spotLights.needsUpdate=W,A.spotLightShadows.needsUpdate=W,A.rectAreaLights.needsUpdate=W,A.hemisphereLights.needsUpdate=W}function Jf(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return U},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return H},this.setRenderTargetTextures=function(A,W,te){ue.get(A.texture).__webglTexture=W,ue.get(A.depthTexture).__webglTexture=te;const ne=ue.get(A);ne.__hasExternalTextures=!0,ne.__autoAllocateDepthBuffer=te===void 0,ne.__autoAllocateDepthBuffer||yt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ne.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,W){const te=ue.get(A);te.__webglFramebuffer=W,te.__useDefaultFramebuffer=W===void 0},this.setRenderTarget=function(A,W=0,te=0){H=A,U=W,F=te;let ne=!0,X=null,Ae=!1,Ee=!1;if(A){const He=ue.get(A);if(He.__useDefaultFramebuffer!==void 0)Je.bindFramebuffer(G.FRAMEBUFFER,null),ne=!1;else if(He.__webglFramebuffer===void 0)P.setupRenderTarget(A);else if(He.__hasExternalTextures)P.rebindTextures(A,ue.get(A.texture).__webglTexture,ue.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Xe=A.depthTexture;if(He.__boundDepthTexture!==Xe){if(Xe!==null&&ue.has(Xe)&&(A.width!==Xe.image.width||A.height!==Xe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");P.setupDepthRenderbuffer(A)}}const at=A.texture;(at.isData3DTexture||at.isDataArrayTexture||at.isCompressedArrayTexture)&&(Ee=!0);const ut=ue.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(ut[W])?X=ut[W][te]:X=ut[W],Ae=!0):A.samples>0&&P.useMultisampledRTT(A)===!1?X=ue.get(A).__webglMultisampledFramebuffer:Array.isArray(ut)?X=ut[te]:X=ut,B.copy(A.viewport),re.copy(A.scissor),K=A.scissorTest}else B.copy(N).multiplyScalar(k).floor(),re.copy(q).multiplyScalar(k).floor(),K=we;if(Je.bindFramebuffer(G.FRAMEBUFFER,X)&&ne&&Je.drawBuffers(A,X),Je.viewport(B),Je.scissor(re),Je.setScissorTest(K),Ae){const He=ue.get(A.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_CUBE_MAP_POSITIVE_X+W,He.__webglTexture,te)}else if(Ee){const He=ue.get(A.texture),at=W||0;G.framebufferTextureLayer(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,He.__webglTexture,te||0,at)}b=-1},this.readRenderTargetPixels=function(A,W,te,ne,X,Ae,Ee){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let We=ue.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ee!==void 0&&(We=We[Ee]),We){Je.bindFramebuffer(G.FRAMEBUFFER,We);try{const He=A.texture,at=He.format,ut=He.type;if(!gt.textureFormatReadable(at)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!gt.textureTypeReadable(ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}W>=0&&W<=A.width-ne&&te>=0&&te<=A.height-X&&G.readPixels(W,te,ne,X,ct.convert(at),ct.convert(ut),Ae)}finally{const He=H!==null?ue.get(H).__webglFramebuffer:null;Je.bindFramebuffer(G.FRAMEBUFFER,He)}}},this.readRenderTargetPixelsAsync=async function(A,W,te,ne,X,Ae,Ee){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let We=ue.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ee!==void 0&&(We=We[Ee]),We){const He=A.texture,at=He.format,ut=He.type;if(!gt.textureFormatReadable(at))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!gt.textureTypeReadable(ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(W>=0&&W<=A.width-ne&&te>=0&&te<=A.height-X){Je.bindFramebuffer(G.FRAMEBUFFER,We);const Xe=G.createBuffer();G.bindBuffer(G.PIXEL_PACK_BUFFER,Xe),G.bufferData(G.PIXEL_PACK_BUFFER,Ae.byteLength,G.STREAM_READ),G.readPixels(W,te,ne,X,ct.convert(at),ct.convert(ut),0);const Et=H!==null?ue.get(H).__webglFramebuffer:null;Je.bindFramebuffer(G.FRAMEBUFFER,Et);const Nt=G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE,0);return G.flush(),await FM(G,Nt,4),G.bindBuffer(G.PIXEL_PACK_BUFFER,Xe),G.getBufferSubData(G.PIXEL_PACK_BUFFER,0,Ae),G.deleteBuffer(Xe),G.deleteSync(Nt),Ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,W=null,te=0){A.isTexture!==!0&&($l("WebGLRenderer: copyFramebufferToTexture function signature has changed."),W=arguments[0]||null,A=arguments[1]);const ne=Math.pow(2,-te),X=Math.floor(A.image.width*ne),Ae=Math.floor(A.image.height*ne),Ee=W!==null?W.x:0,We=W!==null?W.y:0;P.setTexture2D(A,0),G.copyTexSubImage2D(G.TEXTURE_2D,te,0,0,Ee,We,X,Ae),Je.unbindTexture()},this.copyTextureToTexture=function(A,W,te=null,ne=null,X=0){A.isTexture!==!0&&($l("WebGLRenderer: copyTextureToTexture function signature has changed."),ne=arguments[0]||null,A=arguments[1],W=arguments[2],X=arguments[3]||0,te=null);let Ae,Ee,We,He,at,ut,Xe,Et,Nt;const Mt=A.isCompressedTexture?A.mipmaps[X]:A.image;te!==null?(Ae=te.max.x-te.min.x,Ee=te.max.y-te.min.y,We=te.isBox3?te.max.z-te.min.z:1,He=te.min.x,at=te.min.y,ut=te.isBox3?te.min.z:0):(Ae=Mt.width,Ee=Mt.height,We=Mt.depth||1,He=0,at=0,ut=0),ne!==null?(Xe=ne.x,Et=ne.y,Nt=ne.z):(Xe=0,Et=0,Nt=0);const Bn=ct.convert(W.format),ht=ct.convert(W.type);let qe;W.isData3DTexture?(P.setTexture3D(W,0),qe=G.TEXTURE_3D):W.isDataArrayTexture||W.isCompressedArrayTexture?(P.setTexture2DArray(W,0),qe=G.TEXTURE_2D_ARRAY):(P.setTexture2D(W,0),qe=G.TEXTURE_2D),G.pixelStorei(G.UNPACK_FLIP_Y_WEBGL,W.flipY),G.pixelStorei(G.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),G.pixelStorei(G.UNPACK_ALIGNMENT,W.unpackAlignment);const Qi=G.getParameter(G.UNPACK_ROW_LENGTH),Lt=G.getParameter(G.UNPACK_IMAGE_HEIGHT),zn=G.getParameter(G.UNPACK_SKIP_PIXELS),Ji=G.getParameter(G.UNPACK_SKIP_ROWS),xn=G.getParameter(G.UNPACK_SKIP_IMAGES);G.pixelStorei(G.UNPACK_ROW_LENGTH,Mt.width),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Mt.height),G.pixelStorei(G.UNPACK_SKIP_PIXELS,He),G.pixelStorei(G.UNPACK_SKIP_ROWS,at),G.pixelStorei(G.UNPACK_SKIP_IMAGES,ut);const vr=A.isDataArrayTexture||A.isData3DTexture,Ht=W.isDataArrayTexture||W.isData3DTexture;if(A.isRenderTargetTexture||A.isDepthTexture){const Ni=ue.get(A),kr=ue.get(W),Qn=ue.get(Ni.__renderTarget),Ui=ue.get(kr.__renderTarget);Je.bindFramebuffer(G.READ_FRAMEBUFFER,Qn.__webglFramebuffer),Je.bindFramebuffer(G.DRAW_FRAMEBUFFER,Ui.__webglFramebuffer);for(let ii=0;ii<We;ii++)vr&&G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,ue.get(A).__webglTexture,X,ut+ii),A.isDepthTexture?(Ht&&G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,ue.get(W).__webglTexture,X,Nt+ii),G.blitFramebuffer(He,at,Ae,Ee,Xe,Et,Ae,Ee,G.DEPTH_BUFFER_BIT,G.NEAREST)):Ht?G.copyTexSubImage3D(qe,X,Xe,Et,Nt+ii,He,at,Ae,Ee):G.copyTexSubImage2D(qe,X,Xe,Et,Nt+ii,He,at,Ae,Ee);Je.bindFramebuffer(G.READ_FRAMEBUFFER,null),Je.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else Ht?A.isDataTexture||A.isData3DTexture?G.texSubImage3D(qe,X,Xe,Et,Nt,Ae,Ee,We,Bn,ht,Mt.data):W.isCompressedArrayTexture?G.compressedTexSubImage3D(qe,X,Xe,Et,Nt,Ae,Ee,We,Bn,Mt.data):G.texSubImage3D(qe,X,Xe,Et,Nt,Ae,Ee,We,Bn,ht,Mt):A.isDataTexture?G.texSubImage2D(G.TEXTURE_2D,X,Xe,Et,Ae,Ee,Bn,ht,Mt.data):A.isCompressedTexture?G.compressedTexSubImage2D(G.TEXTURE_2D,X,Xe,Et,Mt.width,Mt.height,Bn,Mt.data):G.texSubImage2D(G.TEXTURE_2D,X,Xe,Et,Ae,Ee,Bn,ht,Mt);G.pixelStorei(G.UNPACK_ROW_LENGTH,Qi),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Lt),G.pixelStorei(G.UNPACK_SKIP_PIXELS,zn),G.pixelStorei(G.UNPACK_SKIP_ROWS,Ji),G.pixelStorei(G.UNPACK_SKIP_IMAGES,xn),X===0&&W.generateMipmaps&&G.generateMipmap(qe),Je.unbindTexture()},this.copyTextureToTexture3D=function(A,W,te=null,ne=null,X=0){return A.isTexture!==!0&&($l("WebGLRenderer: copyTextureToTexture3D function signature has changed."),te=arguments[0]||null,ne=arguments[1]||null,A=arguments[2],W=arguments[3],X=arguments[4]||0),$l('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(A,W,te,ne,X)},this.initRenderTarget=function(A){ue.get(A).__webglFramebuffer===void 0&&P.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?P.setTextureCube(A,0):A.isData3DTexture?P.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?P.setTexture2DArray(A,0):P.setTexture2D(A,0),Je.unbindTexture()},this.resetState=function(){U=0,F=0,H=null,Je.reset(),Ft.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ns}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorspace=Rt._getDrawingBufferColorSpace(e),n.unpackColorSpace=Rt._getUnpackColorSpace()}}class mf{constructor(e,n=25e-5){this.isFogExp2=!0,this.name="",this.color=new vt(e),this.density=n}clone(){return new mf(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class qA extends On{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ss,this.environmentIntensity=1,this.environmentRotation=new ss,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class ey extends du{static get type(){return"PointsMaterial"}constructor(e){super(),this.isPointsMaterial=!0,this.color=new vt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const c1=new rn,fm=new B2,$c=new Cf,Kc=new ie;class gf extends On{constructor(e=new Ri,n=new ey){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const r=this.geometry,o=this.matrixWorld,l=e.params.Points.threshold,c=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),$c.copy(r.boundingSphere),$c.applyMatrix4(o),$c.radius+=l,e.ray.intersectsSphere($c)===!1)return;c1.copy(o).invert(),fm.copy(e.ray).applyMatrix4(c1);const f=l/((this.scale.x+this.scale.y+this.scale.z)/3),d=f*f,p=r.index,_=r.attributes.position;if(p!==null){const y=Math.max(0,c.start),S=Math.min(p.count,c.start+c.count);for(let E=y,w=S;E<w;E++){const x=p.getX(E);Kc.fromBufferAttribute(_,x),f1(Kc,x,d,o,e,n,this)}}else{const y=Math.max(0,c.start),S=Math.min(_.count,c.start+c.count);for(let E=y,w=S;E<w;E++)Kc.fromBufferAttribute(_,E),f1(Kc,E,d,o,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,r=Object.keys(n);if(r.length>0){const o=n[r[0]];if(o!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let l=0,c=o.length;l<c;l++){const f=o[l].name||String(l);this.morphTargetInfluences.push(0),this.morphTargetDictionary[f]=l}}}}}function f1(t,e,n,r,o,l,c){const f=fm.distanceSqToPoint(t);if(f<n){const d=new ie;fm.closestPointToPoint(t,d),d.applyMatrix4(r);const p=o.ray.origin.distanceTo(d);if(p<o.near||p>o.far)return;l.push({distance:p,distanceToRay:Math.sqrt(f),point:d,index:e,face:null,faceIndex:null,barycoord:null,object:c})}}class _f extends Ri{constructor(e=1,n=32,r=16,o=0,l=Math.PI*2,c=0,f=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:r,phiStart:o,phiLength:l,thetaStart:c,thetaLength:f},n=Math.max(3,Math.floor(n)),r=Math.max(2,Math.floor(r));const d=Math.min(c+f,Math.PI);let p=0;const g=[],_=new ie,y=new ie,S=[],E=[],w=[],x=[];for(let v=0;v<=r;v++){const D=[],L=v/r;let R=0;v===0&&c===0?R=.5/n:v===r&&d===Math.PI&&(R=-.5/n);for(let j=0;j<=n;j++){const U=j/n;_.x=-e*Math.cos(o+U*l)*Math.sin(c+L*f),_.y=e*Math.cos(c+L*f),_.z=e*Math.sin(o+U*l)*Math.sin(c+L*f),E.push(_.x,_.y,_.z),y.copy(_).normalize(),w.push(y.x,y.y,y.z),x.push(U+R,1-L),D.push(p++)}g.push(D)}for(let v=0;v<r;v++)for(let D=0;D<n;D++){const L=g[v][D+1],R=g[v][D],j=g[v+1][D],U=g[v+1][D+1];(v!==0||c>0)&&S.push(L,R,U),(v!==r-1||d<Math.PI)&&S.push(R,j,U)}this.setIndex(S),this.setAttribute("position",new Rr(E,3)),this.setAttribute("normal",new Rr(w,3)),this.setAttribute("uv",new Rr(x,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new _f(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class ty extends On{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new vt(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const dp=new rn,d1=new ie,h1=new ie;class $A{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Bt(512,512),this.map=null,this.mapPass=null,this.matrix=new rn,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Bm,this._frameExtents=new Bt(1,1),this._viewportCount=1,this._viewports=[new ln(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,r=this.matrix;d1.setFromMatrixPosition(e.matrixWorld),n.position.copy(d1),h1.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(h1),n.updateMatrixWorld(),dp.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(dp),r.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),r.multiply(dp)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class KA extends $A{constructor(){super(new q2(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class p1 extends ty{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(On.DEFAULT_UP),this.updateMatrix(),this.target=new On,this.shadow=new KA}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class ZA extends ty{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Lm}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Lm);const Zc=1.5;function hp({count:t,innerR:e,outerR:n,colorInner:r,colorOuter:o,tilt:l,opacity:c,sizeMin:f,sizeMax:d,renderOrder:p}){const g=new Ri,_=new Float32Array(t*3),y=new Float32Array(t*3),S=new Float32Array(t),E=new vt(r),w=new vt(o);for(let L=0;L<t;L++){const R=Math.random()*Math.PI*2,j=Math.random(),U=e+Math.sqrt(j)*(n-e),F=.15+j*.6,H=(Math.random()-.5)*F*2;_[L*3]=Math.cos(R)*U,_[L*3+1]=H,_[L*3+2]=Math.sin(R)*U;const b=E.clone().lerp(w,j);y[L*3]=b.r,y[L*3+1]=b.g,y[L*3+2]=b.b,S[L]=Math.random()*(d-f)+f+(1-j)*f}g.setAttribute("position",new mn(_,3)),g.setAttribute("color",new mn(y,3)),g.setAttribute("size",new mn(S,1));const x=new $i({uniforms:{uScale:{value:1},uTint:{value:new vt("#ffffff")}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,blending:wo,vertexColors:!0}),S=new gf(d,y);return S.renderOrder=l,{points:S,mat:y}}const m1={default:{tint:"#ffffff",bg:"#06060f",fog:"#06060f",glow:"#4488cc",ambient:"#1a2a44"},fire:{tint:"#ffccaa",bg:"#0f0806",fog:"#0f0806",glow:"#ff6644",ambient:"#2a1a0a"},aurora:{tint:"#ccffdd",bg:"#060f0a",fog:"#060f0a",glow:"#44ffcc",ambient:"#0a1a14"},void:{tint:"#bbaadd",bg:"#0a0814",fog:"#0a0814",glow:"#5533aa",ambient:"#0a0a14"}};function QA({ringScale:t,planetScale:e,brightness:n,speed:r,sparkle:o,mode:l,quality:c,focus:f}){const d=tt.useRef(null),p=tt.useRef(null),g=tt.useRef(t),_=tt.useRef(e),y=tt.useRef(n??1),S=tt.useRef(r??1),E=tt.useRef(o??0),w=tt.useRef(l??"default"),x=tt.useRef(c??"high"),v=tt.useRef(f??0);return tt.useEffect(()=>{g.current=t},[t]),tt.useEffect(()=>{_.current=e},[e]),tt.useEffect(()=>{y.current=n??1},[n]),tt.useEffect(()=>{S.current=r??1},[r]),tt.useEffect(()=>{E.current=o??0},[o]),tt.useEffect(()=>{w.current=l??"default"},[l]),tt.useEffect(()=>{x.current=c??"high"},[c]),tt.useEffect(()=>{v.current=f??0},[f]),tt.useEffect(()=>{const D=d.current;let L=!1;const R=c==="eco"?.55:1,j=ue=>Math.round(ue*R),U=new qA;U.background=new vt(394767),U.fog=new mf(394767,15e-5);const F=new Yi(55,D.clientWidth/D.clientHeight,.1,50);F.position.set(0,1,7.5),F.lookAt(0,0,0);const H=new YA({antialias:!0,alpha:!1});H.setPixelRatio(Math.min(window.devicePixelRatio,2)),H.setSize(D.clientWidth,D.clientHeight),H.toneMapping=E2,H.toneMappingExposure=1.2,D.appendChild(H.domElement);const b=new ZA(1714756,1.8);U.add(b);const C=new p1(16772829,3.5);C.position.set(6,4,6),U.add(C);const B=new p1(3364215,1.2);B.position.set(-4,-1,-4),U.add(B);const re=j(1800),K=new Ri,ce=new Float32Array(re*3);for(let ue=0;ue<re;ue++){const P=Math.random()*Math.PI*2,T=Math.acos(2*Math.random()-1),Y=12+Math.random()*8;ce[ue*3]=Math.sin(T)*Math.cos(P)*Y,ce[ue*3+1]=Math.sin(T)*Math.sin(P)*Y,ce[ue*3+2]=Math.cos(T)*Y}K.setAttribute("position",new mn(ce,3));const de=new ey({color:16777215,size:.04,transparent:!0,opacity:.7,depthWrite:!1,blending:wo}),Q=new gf(K,de);Q.renderOrder=0,U.add(Q);const se=hp({count:j(2500),innerR:1.8,outerR:2.8,colorInner:"#ffcc77",colorOuter:"#cc7733",tilt:.25,opacity:.8,sizeMin:.014,sizeMax:.07,renderOrder:3}),k=hp({count:j(2e3),innerR:3.1,outerR:3.7,colorInner:"#66eecc",colorOuter:"#2288bb",tilt:.55,opacity:.65,sizeMin:.012,sizeMax:.055,renderOrder:2}),le=hp({count:j(1800),innerR:3.6,outerR:4.8,colorInner:"#cc99ff",colorOuter:"#5533aa",tilt:.78,opacity:.6,sizeMin:.01,sizeMax:.05,renderOrder:1});U.add(se.group),U.add(k.group),U.add(le.group);const oe=new _f(1.58,64,48),N=new $i({uniforms:{uColor:{value:new vt("#4488cc")}},vertexShader:`
      ...
      `,transparent:!0,blending:wo,depthWrite:!1}),q=new fr(oe,N);q.renderOrder=4,U.add(q);const we=new _f(Zc-.02,64,48),Z=new km({color:394767}),fe=new fr(we,Z);fe.renderOrder=5,U.add(fe);const Se=pp({count:j(1500),radius:Zc,jitterRate:1,jitterAmount:.55,colorFn:()=>{const ue=Math.random();return[.12+ue*.15,.3+ue*.1,.7+ue*.25,Math.random()*.08+.02+ue*.03]},renderOrder:6,uniforms:{uWave:{value:0},uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
    ...
    `,U.add(Se.points);const ve=pp({count:j(1200),radius:Zc,jitterRate:1,jitterAmount:.2,colorFn:()=>[.15+Math.random()*.35,.35+Math.random()*.45,.6+Math.random()*.4,Math.random()*.035+.008],renderOrder:7,uniforms:{uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
      ...
      `});U.add(ve.points);const Re=pp({count:j(2800),radius:Zc,jitterRate:.3,jitterAmount:.15,colorFn:(ue,P,T)=>{const Y=Math.abs(Math.cos(T));return[.2+Y*.4,.4+Y*.35,.55+Y*.4,Math.random()*.04+.01+(Math.random()<.08?.06:0)]},renderOrder:8,uniforms:{uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
      ...
      `});U.add(Re.points);const De=j(500),Qe=new Ri,wt=new Float32Array(De*3),pt=new Float32Array(De*3),Ot=new Float32Array(De);for(let ue=0;ue<De;ue++){const P=Math.random()*Math.PI*2,T=Math.acos(2*Math.random()-1),Y=Math.random(),me=.15+Math.sqrt(Y)*.5;wt[ue*3]=Math.sin(T)*Math.cos(P)*me,wt[ue*3+1]=Math.sin(T)*Math.sin(P)*me,wt[ue*3+2]=Math.cos(T)*me;const pe=1-Y;pt[ue*3]=.8+pe*.2,pt[ue*3+1]=.7+pe*.3,pt[ue*3+2]=.5+pe*.5,Ot[ue]=Math.random()*.06+.02+pe*.08}Qe.setAttribute("position",new mn(wt,3)),Qe.setAttribute("color",new mn(pt,3)),Qe.setAttribute("size",new mn(Ot,1));const G=new $i({uniforms:{uPulse:{value:1},uTint:{value:new vt("#ffffff")}},vertexShader:`
        attribute float size; varying vec3 vColor;
        uniform float uPulse; uniform vec3 uTint;
