 ...
 */var rv;function FS(){if(rv)return St;rv=1;var t=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),d=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.iterator;function y(D){return D===null||typeof D!="object"?null:(D=_&&D[_]||D["@@iterator"],typeof D=="function"?D:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,A={};function x(D,Y,Re){this.props=D,this.context=Y,this.refs=A,this.updater=Re||S}x.prototype.isReactComponent={},x.prototype.setState=function(D,Y){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Y,"setState")},x.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function v(){}v.prototype=x.prototype;function N(D,Y,Re){this.props=D,this.context=Y,this.refs=A,this.updater=Re||S}var L=N.prototype=new v;L.constructor=N,E(L,x.prototype),L.isPureReactComponent=!0;var b=Array.isArray,j=Object.prototype.hasOwnProperty,U={current:null},F={key:!0,ref:!0,__self:!0,__source:!0};function H(D,Y,Re){var Z,ce={},_e=null,fe=null;if(Y!=null)for(Z in Y.ref!==void 0&&(fe=Y.ref),Y.key!==void 0&&(_e=""+Y.key),Y)j.call(Y,Z)&&!F.hasOwnProperty(Z)&&(ce[Z]=Y[Z]);var Se=arguments.length-2;if(Se===1)ce.children=Re;else if(1<Se){for(var Ae=Array(Se),We=0;We<Se;We++)Ae[We]=arguments[We+2];ce.children=Ae}if(D&&D.defaultProps)for(Z in Se=D.defaultProps,Se)ce[Z]===void 0&&(ce[Z]=Se[Z]);return{$$typeof:t,type:D,key:_e,ref:fe,props:ce,_owner:U.current}}function P(D,Y){return{$$typeof:t,type:D.type,key:Y,ref:D.ref,props:D.props,_owner:D._owner}}function R(D){return typeof D=="object"&&D!==null&&D.$$typeof===t}function B(D){var Y={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(Re){return Y[Re]})}var le=/\/+/g;function Q(D,Y){return typeof D=="object"&&D!==null&&D.key!=null?B(""+D.key):Y.toString(36)}function he(D,Y,Re,Z,ce){var _e=typeof D;(_e==="undefined"||_e==="boolean")&&(D=null);var fe=!1;if(D===null)fe=!0;else switch(_e){case"string":case"number":fe=!0;break;case"object":switch(D.$$typeof){case t:case e:fe=!0}}if(fe)return fe=D,ce=ce(fe),D=Z===""?"."+Q(fe,0):Z,b(ce)?(Re="",D!=null&&(Re=D.replace(le,"$&/")+"/"),he(ce,Y,Re,"",function(We){return We})):ce!=null&&(R(ce)&&(ce=P(ce,Re+(!ce.key||fe&&fe.key===ce.key?"":(""+ce.key).replace(le,"$&/")+"/")+D)),Y.push(ce)),1;if(fe=0,Z=Z===""?".":Z+":",b(D))for(var Se=0;Se<D.length;Se++){_e=D[Se];var Ae=Z+Q(_e,Se);fe+=he(_e,Y,Re,Ae,ce)}else if(Ae=y(D),typeof Ae=="function")for(D=Ae.call(D),Se=0;!(_e=D.next()).done;)_e=_e.value,Ae=Z+Q(_e,Se++),fe+=he(_e,Y,Re,Ae,ce);else if(_e==="object")throw Y=String(D),Error("Objects are not valid as a React child (found: "+(Y==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Y)+"). If you meant to render a collection of children, use an array instead.");return fe}function pe(D,Y,Re){if(D==null)return D;var Z=[],ce=0;return he(D,Z,"","",function(_e){return Y.call(Re,_e,ce++)}),Z}function te(D){if(D._status===-1){var Y=D._result;Y=Y(),Y.then(function(Re){(D._status===0||D._status===-1)&&(D._status=1,D._result=Re)},function(Re){(D._status===0||D._status===-1)&&(D._status=2,D._result=Re)}),D._status===-1&&(D._status=0,D._result=Y)}if(D._status===1)return D._result.default;throw D._result}var re={current:null},O={transition:null},ue={ReactCurrentDispatcher:re,ReactCurrentBatchConfig:O,ReactCurrentOwner:U};function se(){throw Error("act(...) is not supported in production builds of React.")}return St.Children={map:pe,forEach:function(D,Y,Re){pe(D,function(){Y.apply(this,arguments)},Re)},count:function(D){var Y=0;return pe(D,function(){Y++}),Y},toArray:function(D){return pe(D,function(Y){return Y})||[]},only:function(D){if(!R(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},St.Component=x,St.Fragment=n,St.Profiler=o,St.PureComponent=N,St.StrictMode=r,St.Suspense=d,St.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ue,St.act=se,St.cloneElement=function(D,Y,Re){if(D==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+D+".");var Z=E({},D.props),ce=D.key,_e=D.ref,fe=D._owner;if(Y!=null){if(Y.ref!==void 0&&(_e=Y.ref,fe=U.current),Y.key!==void 0&&(ce=""+Y.key),D.type&&D.type.defaultProps)var Se=D.type.defaultProps;for(Ae in Y)j.call(Y,Ae)&&!F.hasOwnProperty(Ae)&&(Z[Ae]=Y[Ae]===void 0&&Se!==void 0?Se[Ae]:Y[Ae])}var Ae=arguments.length-2;if(Ae===1)Z.children=Re;else if(1<Ae){Se=Array(Ae);for(var We=0;We<Ae;We++)Se[We]=arguments[We+2];Z.children=Se}return{$$typeof:t,type:D.type,key:ce,ref:_e,props:Z,_owner:fe}},St.createContext=function(D){return D={$$typeof:c,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},D.Provider={$$typeof:l,_context:D},D.Consumer=D},St.createElement=H,St.createFactory=function(D){var Y=H.bind(null,D);return Y.type=D,Y},St.createRef=function(){return{current:null}},St.forwardRef=function(D){return{$$typeof:f,render:D}},St.isValidElement=R,St.lazy=function(D){return{$$typeof:g,_payload:{_status:-1,_result:D},_init:te}},St.memo=function(D,Y){return{$$typeof:p,type:D,compare:Y===void 0?null:Y}},St.startTransition=function(D){var Y=O.transition;O.transition={};try{D()}finally{O.transition=Y}},St.unstable_act=se,St.useCallback=function(D,Y){return re.current.useCallback(D,Y)},St.useContext=function(D){return re.current.useContext(D)},St.useDebugValue=function(){},St.useDeferredValue=function(D){return re.current.useDeferredValue(D)},St.useEffect=function(D,Y){return re.current.useEffect(D,Y)},St.useId=function(){return re.current.useId()},St.useImperativeHandle=function(D,Y,Re){return re.current.useImperativeHandle(D,Y,Re)},St.useInsertionEffect=function(D,Y){return re.current.useInsertionEffect(D,Y)},St.useLayoutEffect=function(D,Y){return re.current.useLayoutEffect(D,Y)},St.useMemo=function(D,Y){return re.current.useMemo(D,Y)},St.useReducer=function(D,Y,Re){return re.current.useReducer(D,Y,Re)},St.useRef=function(D){return re.current.useRef(D)},St.useState=function(D){return re.current.useState(D)},St.useSyncExternalStore=function(D,Y,Re){return re.current.useSyncExternalStore(D,Y,Re)},St.useTransition=function(){return re.current.useTransition()},St.version="18.3.1",St}var sv;function Pm(){return sv||(sv=1,Dh.exports=FS()),Dh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lv;function zS(){return lv||(lv=1,(function(t){function e(O,ue){var se=O.length;O.push(ue);e:for(;0<se;){var D=se-1>>>1,Y=O[D];if(0<o(Y,ue))O[D]=ue,O[se]=Y,se=D;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var ue=O[0],se=O.pop();if(se!==ue){O[0]=se;e:for(var D=0,Y=O.length,Re=Y>>>1;D<Re;){var Z=2*(D+1)-1,ce=O[Z],_e=Z+1,fe=O[_e];if(0>o(ce,se))_e<Y&&0>o(fe,ce)?(O[D]=fe,O[_e]=se,D=_e):(O[D]=ce,O[Z]=se,D=Z);else if(_e<Y&&0>o(fe,se))O[D]=fe,O[_e]=se,D=_e;else break e}}return ue}function o(O,ue){var se=O.sortIndex-ue.sortIndex;return se!==0?se:O.id-ue.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;t.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();t.unstable_now=function(){return c.now()-f}}var d=[],p=[],g=1,_=null,y=3,S=!1,E=!1,A=!1,x=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(O){for(var ue=n(p);ue!==null;){if(ue.callback===null)r(p);else if(ue.startTime<=O)r(p),ue.sortIndex=ue.expirationTime,e(d,ue);else break;ue=n(p)}}function b(O){if(A=!1,L(O),!E)if(n(d)!==null)E=!0,te(j);else{var ue=n(p);ue!==null&&re(b,ue.startTime-O)}}function j(O,ue){E=!1,A&&(A=!1,v(H),H=-1),S=!0;var se=y;try{for(L(ue),_=n(d);_!==null&&(!(_.expirationTime>ue)||O&&!B());){var D=_.callback;if(typeof D=="function"){_.callback=null,y=_.priorityLevel;var Y=D(_.expirationTime<=ue);ue=t.unstable_now(),typeof Y=="function"?_.callback=Y:_===n(d)&&r(d),L(ue)}else r(d);_=n(d)}if(_!==null)var Re=!0;else{var Z=n(p);Z!==null&&re(b,Z.startTime-ue),Re=!1}return Re}finally{_=null,y=se,S=!1}}var U=!1,F=null,H=-1,P=5,R=-1;function B(){return!(t.unstable_now()-R<P)}function le(){if(F!==null){var O=t.unstable_now();R=O;var ue=!0;try{ue=F(!0,O)}finally{ue?Q():(U=!1,F=null)}}else U=!1}var Q;if(typeof N=="function")Q=function(){N(le)};else if(typeof MessageChannel<"u"){var he=new MessageChannel,pe=he.port2;he.port1.onmessage=le,Q=function(){pe.postMessage(null)}}else Q=function(){x(le,0)};function te(O){F=O,U||(U=!0,Q())}function re(O,ue){H=x(function(){O(t.unstable_now())},ue)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){E||S||(E=!0,te(j))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(d)},t.unstable_next=function(O){switch(y){case 1:case 2:case 3:var ue=3;break;default:ue=y}var se=y;y=ue;try{return O()}finally{y=se}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,ue){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var se=y;y=O;try{return ue()}finally{y=se}},t.unstable_scheduleCallback=function(O,ue,se){var D=t.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?D+se:D):se=D,O){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=se+Y,O={id:g++,callback:ue,priorityLevel:O,startTime:se,expirationTime:Y,sortIndex:-1},se>D?(O.sortIndex=se,e(p,O),n(d)===null&&O===n(p)&&(A?(v(H),H=-1):A=!0,re(b,se-D))):(O.sortIndex=Y,e(d,O),E||S||(E=!0,te(j))),O},t.unstable_shouldYield=B,t.unstable_wrapCallback=function(O){var ue=y;return function(){var se=y;y=ue;try{return O.apply(this,arguments)}finally{y=se}}}})(Uh)),Uh}var uv;function VS(){return uv||(uv=1,Ih.exports=zS()),Ih.exports}/**
 * @license React
...
#define LOW_PRECISION`),e}function uA(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===S2?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===$S?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===Qr&&(e="SHADOWMAP_TYPE_VSM"),e}function cA(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case Ia:case Ua:e="ENVMAP_TYPE_CUBE";break;case wf:e="ENVMAP_TYPE_CUBE_UV";break}return e}function fA(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case Ua:e="ENVMAP_MODE_REFRACTION";break}return e}function dA(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case M2:e="ENVMAP_BLENDING_MULTIPLY";break;case pM:e="ENVMAP_BLENDING_MIX";break;case mM:e="ENVMAP_BLENDING_ADD";break}return e}function hA(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:r,maxMip:n}}function pA(t,e,n,r){const o=t.getContext(),l=n.defines;let c=n.vertexShader,f=n.fragmentShader;const d=uA(n),p=cA(n),g=fA(n),_=dA(n),y=hA(n),S=tA(n),E=nA(l),A=o.createProgram();let x,v,N=n.glslVersion?"#version "+n.glslVersion+`
...
`].filter(Kl).join(`
`)),c=cm(c),c=n1(c,n),c=i1(c,n),f=cm(f),f=n1(f,n),f=i1(f,n),c=r1(c),f=r1(f),n.isRawShaderMaterial!==!0&&(N=`#version 300 es
...
`)+`
`+v);const L=N+x+c,b=N+v+f,j=Jv(o,o.VERTEX_SHADER,L),U=Jv(o,o.FRAGMENT_SHADER,b);o.attachShader(A,j),o.attachShader(A,U),n.index0AttributeName!==void 0?o.bindAttribLocation(A,0,n.index0AttributeName):n.morphTargets===!0&&o.bindAttribLocation(A,0,"position"),o.linkProgram(A);function F(B){if(t.debug.checkShaderErrors){const le=o.getProgramInfoLog(A).trim(),Q=o.getShaderInfoLog(j).trim(),he=o.getShaderInfoLog(U).trim();let pe=!0,te=!0;if(o.getProgramParameter(A,o.LINK_STATUS)===!1)if(pe=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(o,A,j,U);else{const re=t1(o,j,"vertex"),O=t1(o,U,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(A,o.VALIDATE_STATUS)+`
...
}`;function DA(t,e,n){let r=new Bm;const o=new Bt,l=new Bt,c=new ln,f=new RA({depthPacking:TM}),d=new bA,p={},g=n.maxTextureSize,_={[Xs]:pi,[pi]:Xs,[Jr]:Jr},y=new $i({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Bt},radius:{value:4}},vertexShader:PA,fragmentShader:LA}),S=y.clone();S.defines.HORIZONTAL_PASS=1;const E=new Ri;E.setAttribute("position",new hn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new fr(E,y),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=S2;let v=this.type;this.render=function(U,F,H){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||U.length===0)return;const P=t.getRenderTarget(),R=t.getActiveCubeFace(),B=t.getActiveMipmapLevel(),le=t.state;le.setBlending(Hs),le.buffers.color.setClear(1,1,1,1),le.buffers.depth.setTest(!0),le.setScissorTest(!1);const Q=v!==Qr&&this.type===Qr,he=v===Qr&&this.type!==Qr;for(let pe=0,te=U.length;pe<te;pe++){const re=U[pe],O=re.shadow;if(O===void 0){console.warn("THREE.WebGLShadowMap:",re,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;o.copy(O.mapSize);const ue=O.getFrameExtents();if(o.multiply(ue),l.copy(O.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(l.x=Math.floor(g/ue.x),o.x=l.x*ue.x,O.mapSize.x=l.x),o.y>g&&(l.y=Math.floor(g/ue.y),o.y=l.y*ue.y,O.mapSize.y=l.y)),O.map===null||Q===!0||he===!0){const D=this.type!==Qr?{minFilter:dr,magFilter:dr}:{};O.map!==null&&O.map.dispose(),O.map=new Do(o.x,o.y,D),O.map.texture.name=re.name+".shadowMap",O.camera.updateProjectionMatrix()}t.setRenderTarget(O.map),t.clear();const se=O.getViewportCount();for(let D=0;D<se;D++){const Y=O.getViewport(D);c.set(l.x*Y.x,l.y*Y.y,l.x*Y.z,l.y*Y.w),le.viewport(c),O.updateMatrices(re,D),r=O.getFrustum(),b(F,H,O.camera,re,this.type)}O.isPointLightShadow!==!0&&this.type===Qr&&N(O,H),O.needsUpdate=!1}v=this.type,x.needsUpdate=!1,t.setRenderTarget(P,R,B)};function N(U,F){const H=e.update(A);y.defines.VSM_SAMPLES!==U.blurSamples&&(y.defines.VSM_SAMPLES=U.blurSamples,S.defines.VSM_SAMPLES=U.blurSamples,y.needsUpdate=!0,S.needsUpdate=!0),U.mapPass===null&&(U.mapPass=new Do(o.x,o.y)),y.uniforms.shadow_pass.value=U.map.texture,y.uniforms.resolution.value=U.mapSize,y.uniforms.radius.value=U.radius,t.setRenderTarget(U.mapPass),t.clear(),t.renderBufferDirect(F,null,H,y,A,null),S.uniforms.shadow_pass.value=U.mapPass.texture,S.uniforms.resolution.value=U.mapSize,S.uniforms.radius.value=U.radius,t.setRenderTarget(U.map),t.clear(),t.renderBufferDirect(F,null,H,S,A,null)}function L(U,F,H,P){let R=null;const B=H.isPointLight===!0?U.customDistanceMaterial:U.customDepthMaterial;if(B!==void 0)R=B;else if(R=H.isPointLight===!0?d:f,t.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0){const le=R.uuid,Q=F.uuid;let he=p[le];he===void 0&&(he={},p[le]=he);let pe=he[Q];pe===void 0&&(pe=R.clone(),he[Q]=pe,F.addEventListener("dispose",j)),R=pe}if(R.visible=F.visible,R.wireframe=F.wireframe,P===Qr?R.side=F.shadowSide!==null?F.shadowSide:F.side:R.side=F.shadowSide!==null?F.shadowSide:_[F.side],R.alphaMap=F.alphaMap,R.alphaTest=F.alphaTest,R.map=F.map,R.clipShadows=F.clipShadows,R.clippingPlanes=F.clippingPlanes,R.clipIntersection=F.clipIntersection,R.displacementMap=F.displacementMap,R.displacementScale=F.displacementScale,R.displacementBias=F.displacementBias,R.wireframeLinewidth=F.wireframeLinewidth,R.linewidth=F.linewidth,H.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const le=t.properties.get(R);le.light=H}return R}function b(U,F,H,P,R){if(U.visible===!1)return;if(U.layers.test(F.layers)&&(U.isMesh||U.isLine||U.isPoints)&&(U.castShadow||U.receiveShadow&&R===Qr)&&(!U.frustumCulled||r.intersectsObject(U))){U.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,U.matrixWorld);const Q=e.update(U),he=U.material;if(Array.isArray(he)){const pe=Q.groups;for(let te=0,re=pe.length;te<re;te++){const O=pe[te],ue=he[O.materialIndex];if(ue&&ue.visible){const se=L(U,ue,P,R);U.onBeforeShadow(t,U,F,H,Q,se,O),t.renderBufferDirect(H,null,Q,se,U,O),U.onAfterShadow(t,U,F,H,Q,se,O)}}}else if(he.visible){const pe=L(U,he,P,R);U.onBeforeShadow(t,U,F,H,Q,pe,null),t.renderBufferDirect(H,null,Q,pe,U,null),U.onAfterShadow(t,U,F,H,Q,pe,null)}}const le=U.children;for(let Q=0,he=le.length;Q<he;Q++)b(le[Q],F,H,P,R)}function j(U){U.target.removeEventListener("dispose",j);for(const H in p){const P=p[H],R=U.target.uuid;R in P&&(P[R].dispose(),delete P[R])}}}const NA={[Ap]:Cp,[Rp]:Lp,[bp]:Dp,[Na]:Pp,[Cp]:Ap,[Lp]:Rp,[Dp]:bp,[Pp]:Na};function IA(t,e){function n(){let V=!1;const be=new ln;let oe=null;const me=new ln(0,0,0,0);return{setMask:function(Ie){oe!==Ie&&!V&&(t.colorMask(Ie,Ie,Ie,Ie),oe=Ie)},setLocked:function(Ie){V=Ie},setClear:function(Ie,Ne,dt,Xt,yn){yn===!0&&(Ie*=Xt,Ne*=Xt,dt*=Xt),be.set(Ie,Ne,dt,Xt),me.equals(be)===!1&&(t.clearColor(Ie,Ne,dt,Xt),me.copy(be))},reset:function(){V=!1,oe=null,me.set(-1,0,0,0)}}}function r(){let V=!1,be=!1,oe=null,me=null,Ie=null;return{setReversed:function(Ne){if(be!==Ne){const dt=e.get("EXT_clip_control");be?dt.clipControlEXT(dt.LOWER_LEFT_EXT,dt.ZERO_TO_ONE_EXT):dt.clipControlEXT(dt.LOWER_LEFT_EXT,dt.NEGATIVE_ONE_TO_ONE_EXT);const Xt=Ie;Ie=null,this.setClear(Xt)}be=Ne},getReversed:function(){return be},setTest:function(Ne){Ne?fe(t.DEPTH_TEST):Se(t.DEPTH_TEST)},setMask:function(Ne){oe!==Ne&&!V&&(t.depthMask(Ne),oe=Ne)},setFunc:function(Ne){if(be&&(Ne=NA[Ne]),me!==Ne){switch(Ne){case Ap:t.depthFunc(t.NEVER);break;case Cp:t.depthFunc(t.ALWAYS);break;case Rp:t.depthFunc(t.LESS);break;case Na:t.depthFunc(t.LEQUAL);break;case bp:t.depthFunc(t.EQUAL);break;case Pp:t.depthFunc(t.GEQUAL);break;case Lp:t.depthFunc(t.GREATER);break;case Dp:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}me=Ne}},setLocked:function(Ne){V=Ne},setClear:function(Ne){Ie!==Ne&&(be&&(Ne=1-Ne),t.clearDepth(Ne),Ie=Ne)},reset:function(){V=!1,oe=null,me=null,Ie=null,be=!1}}}function o(){let V=!1,be=null,oe=null,me=null,Ie=null,Ne=null,dt=null,Xt=null,yn=null;return{setTest:function(Ct){V||(Ct?fe(t.STENCIL_TEST):Se(t.STENCIL_TEST))},setMask:function(Ct){be!==Ct&&!V&&(t.stencilMask(Ct),be=Ct)},setFunc:function(Ct,ni,Zn){(oe!==Ct||me!==ni||Ie!==Zn)&&(t.stencilFunc(Ct,ni,Zn),oe=Ct,me=ni,Ie=Zn)},setOp:function(Ct,ni,Zn){(Ne!==Ct||dt!==ni||Xt!==Zn)&&(t.stencilOp(Ct,ni,Zn),Ne=Ct,dt=ni,Xt=Zn)},setLocked:function(Ct){V=Ct},setClear:function(Ct){yn!==Ct&&(t.clearStencil(Ct),yn=Ct)},reset:function(){V=!1,be=null,oe=null,me=null,Ie=null,Ne=null,dt=null,Xt=null,yn=null}}}const l=new n,c=new r,f=new o,d=new WeakMap,p=new WeakMap;let g={},_={},y=new WeakMap,S=[],E=null,A=!1,x=null,v=null,N=null,L=null,b=null,j=null,U=null,F=new yt(0,0,0),H=0,P=!1,R=null,B=null,le=null,Q=null,he=null;const pe=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,re=0;const O=t.getParameter(t.VERSION);O.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(O)[1]),te=re>=1):O.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),te=re>=2);let ue=null,se={};const D=t.getParameter(t.SCISSOR_BOX),Y=t.getParameter(t.VIEWPORT),Re=new ln().fromArray(D),Z=new ln().fromArray(Y);function ce(V,be,oe,me){const Ie=new Uint8Array(4),Ne=t.createTexture();t.bindTexture(V,Ne),t.texParameteri(V,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(V,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let dt=0;dt<oe;dt++)V===t.TEXTURE_3D||V===t.TEXTURE_2D_ARRAY?t.texImage3D(be,0,t.RGBA,1,1,me,0,t.RGBA,t.UNSIGNED_BYTE,Ie):t.texImage2D(be+dt,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Ie);return Ne}const _e={};_e[t.TEXTURE_2D]=ce(t.TEXTURE_2D,t.TEXTURE_2D,1),_e[t.TEXTURE_CUBE_MAP]=ce(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),_e[t.TEXTURE_2D_ARRAY]=ce(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),_e[t.TEXTURE_3D]=ce(t.TEXTURE_3D,t.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),fe(t.DEPTH_TEST),c.setFunc(Na),mt(!1),_t(hv),fe(t.CULL_FACE),G(Hs);function fe(V){g[V]!==!0&&(t.enable(V),g[V]=!0)}function Se(V){g[V]!==!1&&(t.disable(V),g[V]=!1)}function Ae(V,be){return _[V]!==be?(t.bindFramebuffer(V,be),_[V]=be,V===t.DRAW_FRAMEBUFFER&&(_[t.FRAMEBUFFER]=be),V===t.FRAMEBUFFER&&(_[t.DRAW_FRAMEBUFFER]=be),!0):!1}function We(V,be){let oe=S,me=!1;if(V){oe=y.get(be),oe===void 0&&(oe=[],y.set(be,oe));const Ie=V.textures;if(oe.length!==Ie.length||oe[0]!==t.COLOR_ATTACHMENT0){for(let Ne=0,dt=Ie.length;Ne<dt;Ne++)oe[Ne]=t.COLOR_ATTACHMENT0+Ne;oe.length=Ie.length,me=!0}}else oe[0]!==t.BACK&&(oe[0]=t.BACK,me=!0);me&&t.drawBuffers(oe)}function Tt(V){return E!==V?(t.useProgram(V),E=V,!0):!1}const ht={[yo]:t.FUNC_ADD,[ZS]:t.FUNC_SUBTRACT,[QS]:t.FUNC_REVERSE_SUBTRACT};ht[JS]=t.MIN,ht[eM]=t.MAX;const At={[tM]:t.ZERO,[nM]:t.ONE,[iM]:t.SRC_COLOR,[Tp]:t.SRC_ALPHA,[uM]:t.SRC_ALPHA_SATURATE,[aM]:t.DST_COLOR,[sM]:t.DST_ALPHA,[rM]:t.ONE_MINUS_SRC_COLOR,[wp]:t.ONE_MINUS_SRC_ALPHA,[lM]:t.ONE_MINUS_DST_COLOR,[oM]:t.ONE_MINUS_DST_ALPHA,[cM]:t.CONSTANT_COLOR,[fM]:t.ONE_MINUS_CONSTANT_COLOR,[dM]:t.CONSTANT_ALPHA,[hM]:t.ONE_MINUS_CONSTANT_ALPHA};function G(V,be,oe,me,Ie,Ne,dt,Xt,yn,Ct){if(V===Hs){A===!0&&(Se(t.BLEND),A=!1);return}if(A===!1&&(fe(t.BLEND),A=!0),V!==KS){if(V!==x||Ct!==P){if((v!==yo||b!==yo)&&(t.blendEquation(t.FUNC_ADD),v=yo,b=yo),Ct)switch(V){case Ra:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case wo:t.blendFunc(t.ONE,t.ONE);break;case pv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case mv:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}else switch(V){case Ra:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case wo:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case pv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case mv:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}N=null,L=null,j=null,U=null,F.set(0,0,0),H=0,x=V,P=Ct}return}Ie=Ie||be,Ne=Ne||oe,dt=dt||me,(be!==v||Ie!==b)&&(t.blendEquationSeparate(ht[be],ht[Ie]),v=be,b=Ie),(oe!==N||me!==L||Ne!==j||dt!==U)&&(t.blendFuncSeparate(At[oe],At[me],At[Ne],At[dt]),N=oe,L=me,j=Ne,U=dt),(Xt.equals(F)===!1||yn!==H)&&(t.blendColor(Xt.r,Xt.g,Xt.b,yn),F.copy(Xt),H=yn),x=V,P=!1}function cn(V,be){V.side===Jr?Se(t.CULL_FACE):fe(t.CULL_FACE);let oe=V.side===pi;be&&(oe=!oe),mt(oe),V.blending===Ra&&V.transparent===!1?G(Hs):G(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),c.setFunc(V.depthFunc),c.setTest(V.depthTest),c.setMask(V.depthWrite),l.setMask(V.colorWrite);const me=V.stencilWrite;f.setTest(me),me&&(f.setMask(V.stencilWriteMask),f.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),f.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),Lt(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?fe(t.SAMPLE_ALPHA_TO_COVERAGE):Se(t.SAMPLE_ALPHA_TO_COVERAGE)}function mt(V){R!==V&&(V?t.frontFace(t.CW):t.frontFace(t.CCW),R=V)}function _t(V){V!==YS?(fe(t.CULL_FACE),V!==B&&(V===hv?t.cullFace(t.BACK):V===qS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Se(t.CULL_FACE),B=V}function tt(V){V!==le&&(te&&t.lineWidth(V),le=V)}function Lt(V,be,oe){V?(fe(t.POLYGON_OFFSET_FILL),(Q!==be||he!==oe)&&(t.polygonOffset(be,oe),Q=be,he=oe)):Se(t.POLYGON_OFFSET_FILL)}function qe(V){V?fe(t.SCISSOR_TEST):Se(t.SCISSOR_TEST)}function w(V){V===void 0&&(V=t.TEXTURE0+pe-1),ue!==V&&(t.activeTexture(V),ue=V)}function T(V,be,oe){oe===void 0&&(ue===null?oe=t.TEXTURE0+pe-1:oe=ue);let me=se[oe];me===void 0&&(me={type:void 0,texture:void 0},se[oe]=me),(me.type!==V||me.texture!==be)&&(ue!==oe&&(t.activeTexture(oe),ue=oe),t.bindTexture(V,be||_e[V]),me.type=V,me.texture=be)}function q(){const V=se[ue];V!==void 0&&V.type!==void 0&&(t.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function de(){try{t.compressedTexImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ge(){try{t.compressedTexImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ae(){try{t.texSubImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Be(){try{t.texSubImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ce(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function De(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ct(){try{t.texStorage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ye(){try{t.texStorage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Fe(){try{t.texImage2D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function nt(){try{t.texImage3D.apply(t,arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ot(V){Re.equals(V)===!1&&(t.scissor(V.x,V.y,V.z,V.w),Re.copy(V))}function ke(V){Z.equals(V)===!1&&(t.viewport(V.x,V.y,V.z,V.w),Z.copy(V))}function xt(V,be){let oe=p.get(be);oe===void 0&&(oe=new WeakMap,p.set(be,oe));let me=oe.get(V);me===void 0&&(me=t.getUniformBlockIndex(be,V.name),oe.set(V,me))}function ft(V,be){const me=p.get(be).get(V);d.get(be)!==me&&(t.uniformBlockBinding(be,me,V.__bindingPointIndex),d.set(be,me))}function Ot(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),c.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),g={},ue=null,se={},_={},y=new WeakMap,S=[],E=null,A=!1,x=null,v=null,N=null,L=null,b=null,j=null,U=null,F=new yt(0,0,0),H=0,P=!1,R=null,B=null,le=null,Q=null,he=null,Re.set(0,0,t.canvas.width,t.canvas.height),Z.set(0,0,t.canvas.width,t.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:fe,disable:Se,bindFramebuffer:Ae,drawBuffers:We,useProgram:Tt,setBlending:G,setMaterial:cn,setFlipSided:mt,setCullFace:_t,setLineWidth:tt,setPolygonOffset:Lt,setScissorTest:qe,activeTexture:w,bindTexture:T,unbindTexture:q,compressedTexImage2D:de,compressedTexImage3D:ge,texImage2D:Fe,texImage3D:nt,updateUBOMapping:xt,uniformBlockBinding:ft,texStorage2D:ct,texStorage3D:ye,texSubImage2D:ae,texSubImage3D:Be,compressedTexSubImage2D:Ce,compressedTexSubImage3D:De,scissor:ot,viewport:ke,reset:Ot}}function u1(t,e,n,r){const o=UA(r);switch(n){case R2:return t*e;case P2:return t*e;case L2:return t*e*2;case D2:return t*e/o.components*o.byteLength;case Um:return t*e/o.components*o.byteLength;case N2:return t*e*2/o.components*o.byteLength;case Fm:return t*e*2/o.components*o.byteLength;case b2:return t*e*3/o.components*o.byteLength;case cr:return t*e*4/o.components*o.byteLength;case Om:return t*e*4/o.components*o.byteLength;case sf:case of:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case af:case lf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case kp:case zp:return Math.max(t,16)*Math.max(e,8)/4;case Op:case Bp:return Math.max(t,8)*Math.max(e,8)/2;case Vp:case Hp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Gp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Wp:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Xp:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case jp:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Yp:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case qp:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case $p:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Kp:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case Zp:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Qp:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Jp:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case em:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case tm:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case nm:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case im:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case uf:case rm:case sm:return Math.ceil(t/4)*Math.ceil(e/4)*16;case I2:case om:return Math.ceil(t/4)*Math.ceil(e/4)*8;case am:case lm:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function UA(t){switch(t){case rs:case w2:return{byteLength:1,components:1};case iu:case A2:case lu:return{byteLength:2,components:1};case Nm:case Im:return{byteLength:2,components:4};case Lo:case Dm:case ts:return{byteLength:4,components:1};case C2:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function FA(t,e,n,r,o,l,c){const f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Bt,g=new WeakMap;let _;const y=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(w,T){return S?new OffscreenCanvas(w,T):pf("canvas")}function A(w,T,q){let de=1;const ge=qe(w);if((ge.width>q||ge.height>q)&&(de=q/Math.max(ge.width,ge.height)),de<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const ae=Math.floor(de*ge.width),Be=Math.floor(de*ge.height);_===void 0&&(_=E(ae,Be));const Ce=T?E(ae,Be):_;return Ce.width=ae,Ce.height=Be,Ce.getContext("2d").drawImage(w,0,0,ae,Be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ge.width+"x"+ge.height+") to ("+ae+"x"+Be+")."),Ce}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ge.width+"x"+ge.height+")."),w;return w}function x(w){return w.generateMipmaps}function v(w){t.generateMipmap(w)}function N(w){return w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?t.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function L(w,T,q,de,ge=!1){if(w!==null){if(t[w]!==void 0)return t[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ae=T;if(T===t.RED&&(q===t.FLOAT&&(ae=t.R32F),q===t.HALF_FLOAT&&(ae=t.R16F),q===t.UNSIGNED_BYTE&&(ae=t.R8)),T===t.RED_INTEGER&&(q===t.UNSIGNED_BYTE&&(ae=t.R8UI),q===t.UNSIGNED_SHORT&&(ae=t.R16UI),q===t.UNSIGNED_INT&&(ae=t.R32UI),q===t.BYTE&&(ae=t.R8I),q===t.SHORT&&(ae=t.R16I),q===t.INT&&(ae=t.R32I)),T===t.RG&&(q===t.FLOAT&&(ae=t.RG32F),q===t.HALF_FLOAT&&(ae=t.RG16F),q===t.UNSIGNED_BYTE&&(ae=t.RG8)),T===t.RG_INTEGER&&(q===t.UNSIGNED_BYTE&&(ae=t.RG8UI),q===t.UNSIGNED_SHORT&&(ae=t.RG16UI),q===t.UNSIGNED_INT&&(ae=t.RG32UI),q===t.BYTE&&(ae=t.RG8I),q===t.SHORT&&(ae=t.RG16I),q===t.INT&&(ae=t.RG32I)),T===t.RGB_INTEGER&&(q===t.UNSIGNED_BYTE&&(ae=t.RGB8UI),q===t.UNSIGNED_SHORT&&(ae=t.RGB16UI),q===t.UNSIGNED_INT&&(ae=t.RGB32UI),q===t.BYTE&&(ae=t.RGB8I),q===t.SHORT&&(ae=t.RGB16I),q===t.INT&&(ae=t.RGB32I)),T===t.RGBA_INTEGER&&(q===t.UNSIGNED_BYTE&&(ae=t.RGBA8UI),q===t.UNSIGNED_SHORT&&(ae=t.RGBA16UI),q===t.UNSIGNED_INT&&(ae=t.RGBA32UI),q===t.BYTE&&(ae=t.RGBA8I),q===t.SHORT&&(ae=t.RGBA16I),q===t.INT&&(ae=t.RGBA32I)),T===t.RGB&&q===t.UNSIGNED_INT_5_9_9_9_REV&&(ae=t.RGB9_E5),T===t.RGBA){const Be=ge?Af:bt.getTransfer(de);q===t.FLOAT&&(ae=t.RGBA32F),q===t.HALF_FLOAT&&(ae=t.RGBA16F),q===t.UNSIGNED_BYTE&&(ae=Be===zt?t.SRGB8_ALPHA8:t.RGBA8),q===t.UNSIGNED_SHORT_4_4_4_4&&(ae=t.RGBA4),q===t.UNSIGNED_SHORT_5_5_5_1&&(ae=t.RGB5_A1)}return(ae===t.R16F||ae===t.R32F||ae===t.RG16F||ae===t.RG32F||ae===t.RGBA16F||ae===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ae}function b(w,T){let q;return w?T===null||T===Lo||T===Fa?q=t.DEPTH24_STENCIL8:T===ts?q=t.DEPTH32F_STENCIL8:T===iu&&(q=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Lo||T===Fa?q=t.DEPTH_COMPONENT24:T===ts?q=t.DEPTH_COMPONENT32F:T===iu&&(q=t.DEPTH_COMPONENT16),q}function j(w,T){return x(w)===!0||w.isFramebufferTexture&&w.minFilter!==dr&&w.minFilter!==Ar?Math.log2(Math.max(T.width,T.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?T.mipmaps.length:1}function U(w){const T=w.target;T.removeEventListener("dispose",U),H(T),T.isVideoTexture&&g.delete(T)}function F(w){const T=w.target;T.removeEventListener("dispose",F),R(T)}function H(w){const T=r.get(w);if(T.__webglInit===void 0)return;const q=w.source,de=y.get(q);if(de){const ge=de[T.__cacheKey];ge.usedTimes--,ge.usedTimes===0&&P(w),Object.keys(de).length===0&&y.delete(q)}r.remove(w)}function P(w){const T=r.get(w);t.deleteTexture(T.__webglTexture);const q=w.source,de=y.get(q);delete de[T.__cacheKey],c.memory.textures--}function R(w){const T=r.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),r.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let de=0;de<6;de++){if(Array.isArray(T.__webglFramebuffer[de]))for(let ge=0;ge<T.__webglFramebuffer[de].length;ge++)t.deleteFramebuffer(T.__webglFramebuffer[de][ge]);else t.deleteFramebuffer(T.__webglFramebuffer[de]);T.__webglDepthbuffer&&t.deleteRenderbuffer(T.__webglDepthbuffer[de])}else{if(Array.isArray(T.__webglFramebuffer))for(let de=0;de<T.__webglFramebuffer.length;de++)t.deleteFramebuffer(T.__webglFramebuffer[de]);else t.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&t.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&t.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let de=0;de<T.__webglColorRenderbuffer.length;de++)T.__webglColorRenderbuffer[de]&&t.deleteRenderbuffer(T.__webglColorRenderbuffer[de]);T.__webglDepthRenderbuffer&&t.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const q=w.textures;for(let de=0,ge=q.length;de<ge;de++){const ae=r.get(q[de]);ae.__webglTexture&&(t.deleteTexture(ae.__webglTexture),c.memory.textures--),r.remove(q[de])}r.remove(w)}let B=0;function le(){B=0}function Q(){const w=B;return w>=o.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+o.maxTextures),B+=1,w}function he(w){const T=[];return T.push(w.wrapS),T.push(w.wrapT),T.push(w.wrapR||0),T.push(w.magFilter),T.push(w.minFilter),T.push(w.anisotropy),T.push(w.internalFormat),T.push(w.format),T.push(w.type),T.push(w.generateMipmaps),T.push(w.premultiplyAlpha),T.push(w.flipY),T.push(w.unpackAlignment),T.push(w.colorSpace),T.join()}function pe(w,T){const q=r.get(w);if(w.isVideoTexture&&tt(w),w.isRenderTargetTexture===!1&&w.version>0&&q.__version!==w.version){const de=w.image;if(de===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(de.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(q,w,T);return}}n.bindTexture(t.TEXTURE_2D,q.__webglTexture,t.TEXTURE0+T)}function te(w,T){const q=r.get(w);if(w.version>0&&q.__version!==w.version){Z(q,w,T);return}n.bindTexture(t.TEXTURE_2D_ARRAY,q.__webglTexture,t.TEXTURE0+T)}function re(w,T){const q=r.get(w);if(w.version>0&&q.__version!==w.version){Z(q,w,T);return}n.bindTexture(t.TEXTURE_3D,q.__webglTexture,t.TEXTURE0+T)}function O(w,T){const q=r.get(w);if(w.version>0&&q.__version!==w.version){ce(q,w,T);return}n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture,t.TEXTURE0+T)}const ue={[Up]:t.REPEAT,[So]:t.CLAMP_TO_EDGE,[Fp]:t.MIRRORED_REPEAT},se={[dr]:t.NEAREST,[MM]:t.NEAREST_MIPMAP_NEAREST,[Rc]:t.NEAREST_MIPMAP_LINEAR,[Ar]:t.LINEAR,[Fh]:t.LINEAR_MIPMAP_NEAREST,[Mo]:t.LINEAR_MIPMAP_LINEAR},D={[CM]:t.NEVER,[NM]:t.ALWAYS,[RM]:t.LESS,[U2]:t.LEQUAL,[bM]:t.EQUAL,[DM]:t.GEQUAL,[PM]:t.GREATER,[LM]:t.NOTEQUAL};function Y(w,T){if(T.type===ts&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===Ar||T.magFilter===Fh||T.magFilter===Rc||T.magFilter===Mo||T.minFilter===Ar||T.minFilter===Fh||T.minFilter===Rc||T.minFilter===Mo)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(w,t.TEXTURE_WRAP_S,ue[T.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,ue[T.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,ue[T.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,se[T.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,se[T.minFilter]),T.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,D[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===dr||T.minFilter!==Rc&&T.minFilter!==Mo||T.type===ts&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||r.get(T).__currentAnisotropy){const q=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,o.getMaxAnisotropy())),r.get(T).__currentAnisotropy=T.anisotropy}}}function Re(w,T){let q=!1;w.__webglInit===void 0&&(w.__webglInit=!0,T.addEventListener("dispose",U));const de=T.source;let ge=y.get(de);ge===void 0&&(ge={},y.set(de,ge));const ae=he(T);if(ae!==w.__cacheKey){ge[ae]===void 0&&(ge[ae]={texture:t.createTexture(),usedTimes:0},c.memory.textures++,q=!0),ge[ae].usedTimes++;const Be=ge[w.__cacheKey];Be!==void 0&&(ge[w.__cacheKey].usedTimes--,Be.usedTimes===0&&P(T)),w.__cacheKey=ae,w.__webglTexture=ge[ae].texture}return q}function Z(w,T,q){let de=t.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(de=t.TEXTURE_2D_ARRAY),T.isData3DTexture&&(de=t.TEXTURE_3D);const ge=Re(w,T),ae=T.source;n.bindTexture(de,w.__webglTexture,t.TEXTURE0+q);const Be=r.get(ae);if(ae.version!==Be.__version||ge===!0){n.activeTexture(t.TEXTURE0+q);const Ce=bt.getPrimaries(bt.workingColorSpace),De=T.colorSpace===zs?null:bt.getPrimaries(T.colorSpace),ct=T.colorSpace===zs||Ce===De?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,T.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ct);let ye=A(T.image,!1,o.maxTextureSize);ye=Lt(T,ye);const Fe=l.convert(T.format,T.colorSpace),nt=l.convert(T.type);let ot=L(T.internalFormat,Fe,nt,T.colorSpace,T.isVideoTexture);Y(de,T);let ke;const xt=T.mipmaps,ft=T.isVideoTexture!==!0,Ot=Be.__version===void 0||ge===!0,V=ae.dataReady,be=j(T,ye);if(T.isDepthTexture)ot=b(T.format===Oa,T.type),Ot&&(ft?n.texStorage2D(t.TEXTURE_2D,1,ot,ye.width,ye.height):n.texImage2D(t.TEXTURE_2D,0,ot,ye.width,ye.height,0,Fe,nt,null));else if(T.isDataTexture)if(xt.length>0){ft&&Ot&&n.texStorage2D(t.TEXTURE_2D,be,ot,xt[0].width,xt[0].height);for(let oe=0,me=xt.length;oe<me;oe++)ke=xt[oe],ft?V&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,ke.width,ke.height,Fe,nt,ke.data):n.texImage2D(t.TEXTURE_2D,oe,ot,ke.width,ke.height,0,Fe,nt,ke.data);T.generateMipmaps=!1}else ft?(Ot&&n.texStorage2D(t.TEXTURE_2D,be,ot,ye.width,ye.height),V&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ye.width,ye.height,Fe,nt,ye.data)):n.texImage2D(t.TEXTURE_2D,0,ot,ye.width,ye.height,0,Fe,nt,ye.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){ft&&Ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,be,ot,xt[0].width,xt[0].height,ye.depth);for(let oe=0,me=xt.length;oe<me;oe++)if(ke=xt[oe],T.format!==cr)if(Fe!==null)if(ft){if(V)if(T.layerUpdates.size>0){const Ie=u1(ke.width,ke.height,T.format,T.type);for(const Ne of T.layerUpdates){const dt=ke.data.subarray(Ne*Ie/ke.data.BYTES_PER_ELEMENT,(Ne+1)*Ie/ke.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,Ne,ke.width,ke.height,1,Fe,dt)}T.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,0,ke.width,ke.height,ye.depth,Fe,ke.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,oe,ot,ke.width,ke.height,ye.depth,0,ke.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ft?V&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,oe,0,0,0,ke.width,ke.height,ye.depth,Fe,nt,ke.data):n.texImage3D(t.TEXTURE_2D_ARRAY,oe,ot,ke.width,ke.height,ye.depth,0,Fe,nt,ke.data)}else{ft&&Ot&&n.texStorage2D(t.TEXTURE_2D,be,ot,xt[0].width,xt[0].height);for(let oe=0,me=xt.length;oe<me;oe++)ke=xt[oe],T.format!==cr?Fe!==null?ft?V&&n.compressedTexSubImage2D(t.TEXTURE_2D,oe,0,0,ke.width,ke.height,Fe,ke.data):n.compressedTexImage2D(t.TEXTURE_2D,oe,ot,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ft?V&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,ke.width,ke.height,Fe,nt,ke.data):n.texImage2D(t.TEXTURE_2D,oe,ot,ke.width,ke.height,0,Fe,nt,ke.data)}else if(T.isDataArrayTexture)if(ft){if(Ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,be,ot,ye.width,ye.height,ye.depth),V)if(T.layerUpdates.size>0){const oe=u1(ye.width,ye.height,T.format,T.type);for(const me of T.layerUpdates){const Ie=ye.data.subarray(me*oe/ye.data.BYTES_PER_ELEMENT,(me+1)*oe/ye.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,me,ye.width,ye.height,1,Fe,nt,Ie)}T.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ye.width,ye.height,ye.depth,Fe,nt,ye.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ot,ye.width,ye.height,ye.depth,0,Fe,nt,ye.data);else if(T.isData3DTexture)ft?(Ot&&n.texStorage3D(t.TEXTURE_3D,be,ot,ye.width,ye.height,ye.depth),V&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ye.width,ye.height,ye.depth,Fe,nt,ye.data)):n.texImage3D(t.TEXTURE_3D,0,ot,ye.width,ye.height,ye.depth,0,Fe,nt,ye.data);else if(T.isFramebufferTexture){if(Ot)if(ft)n.texStorage2D(t.TEXTURE_2D,be,ot,ye.width,ye.height);else{let oe=ye.width,me=ye.height;for(let Ie=0;Ie<be;Ie++)n.texImage2D(t.TEXTURE_2D,Ie,ot,oe,me,0,Fe,nt,null),oe>>=1,me>>=1}}else if(xt.length>0){if(ft&&Ot){const oe=qe(xt[0]);n.texStorage2D(t.TEXTURE_2D,be,ot,oe.width,oe.height)}for(let oe=0,me=xt.length;oe<me;oe++)ke=xt[oe],ft?V&&n.texSubImage2D(t.TEXTURE_2D,oe,0,0,Fe,nt,ke):n.texImage2D(t.TEXTURE_2D,oe,ot,Fe,nt,ke);T.generateMipmaps=!1}else if(ft){if(Ot){const oe=qe(ye);n.texStorage2D(t.TEXTURE_2D,be,ot,oe.width,oe.height)}V&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Fe,nt,ye)}else n.texImage2D(t.TEXTURE_2D,0,ot,Fe,nt,ye);x(T)&&v(de),Be.__version=ae.version,T.onUpdate&&T.onUpdate(T)}w.__version=T.version}function ce(w,T,q){if(T.image.length!==6)return;const de=Re(w,T),ge=T.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+q);const ae=r.get(ge);if(ge.version!==ae.__version||de===!0){n.activeTexture(t.TEXTURE0+q);const Be=bt.getPrimaries(bt.workingColorSpace),Ce=T.colorSpace===zs?null:bt.getPrimaries(T.colorSpace),De=T.colorSpace===zs||Be===Ce?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,T.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,De);const ct=T.isCompressedTexture||T.image[0].isCompressedTexture,ye=T.image[0]&&T.image[0].isDataTexture,Fe=[];for(let me=0;me<6;me++)!ct&&!ye?Fe[me]=A(T.image[me],!0,o.maxCubemapSize):Fe[me]=ye?T.image[me].image:T.image[me],Fe[me]=Lt(T,Fe[me]);const nt=Fe[0],ot=l.convert(T.format,T.colorSpace),ke=l.convert(T.type),xt=L(T.internalFormat,ot,ke,T.colorSpace),ft=T.isVideoTexture!==!0,Ot=ae.__version===void 0||de===!0,V=ge.dataReady;let be=j(T,nt);Y(t.TEXTURE_CUBE_MAP,T);let oe;if(ct){ft&&Ot&&n.texStorage2D(t.TEXTURE_CUBE_MAP,be,xt,nt.width,nt.height);for(let me=0;me<6;me++){oe=Fe[me].mipmaps;for(let Ie=0;Ie<oe.length;Ie++){const Ne=oe[Ie];T.format!==cr?ot!==null?ft?V&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie,0,0,Ne.width,Ne.height,ot,Ne.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie,xt,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ft?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie,0,0,Ne.width,Ne.height,ot,ke,Ne.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie,xt,Ne.width,Ne.height,0,ot,ke,Ne.data)}}}else{if(oe=T.mipmaps,ft&&Ot){oe.length>0&&be++;const me=qe(Fe[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,be,xt,me.width,me.height)}for(let me=0;me<6;me++)if(ye){ft?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,Fe[me].width,Fe[me].height,ot,ke,Fe[me].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,xt,Fe[me].width,Fe[me].height,0,ot,ke,Fe[me].data);for(let Ie=0;Ie<oe.length;Ie++){const dt=oe[Ie].image[me].image;ft?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie+1,0,0,dt.width,dt.height,ot,ke,dt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie+1,xt,dt.width,dt.height,0,ot,ke,dt.data)}}else{ft?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,ot,ke,Fe[me]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,xt,ot,ke,Fe[me]);for(let Ie=0;Ie<oe.length;Ie++){const Ne=oe[Ie];ft?V&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie+1,0,0,ot,ke,Ne.image[me]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,Ie+1,xt,ot,ke,Ne.image[me])}}}x(T)&&v(t.TEXTURE_CUBE_MAP),ae.__version=ge.version,T.onUpdate&&T.onUpdate(T)}w.__version=T.version}function _e(w,T,q,de,ge,ae){const Be=l.convert(q.format,q.colorSpace),Ce=l.convert(q.type),De=L(q.internalFormat,Be,Ce,q.colorSpace),ct=r.get(T),ye=r.get(q);if(ye.__renderTarget=T,!ct.__hasExternalTextures){const Fe=Math.max(1,T.width>>ae),nt=Math.max(1,T.height>>ae);ge===t.TEXTURE_3D||ge===t.TEXTURE_2D_ARRAY?n.texImage3D(ge,ae,De,Fe,nt,T.depth,0,Be,Ce,null):n.texImage2D(ge,ae,De,Fe,nt,0,Be,Ce,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),_t(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,de,ge,ye.__webglTexture,0,mt(T)):(ge===t.TEXTURE_2D||ge>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ge<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,de,ge,ye.__webglTexture,ae),n.bindFramebuffer(t.FRAMEBUFFER,null)}function fe(w,T,q){if(t.bindRenderbuffer(t.RENDERBUFFER,w),T.depthBuffer){const de=T.depthTexture,ge=de&&de.isDepthTexture?de.type:null,ae=b(T.stencilBuffer,ge),Be=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ce=mt(T);_t(T)?f.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ce,ae,T.width,T.height):q?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ce,ae,T.width,T.height):t.renderbufferStorage(t.RENDERBUFFER,ae,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Be,t.RENDERBUFFER,w)}else{const de=T.textures;for(let ge=0;ge<de.length;ge++){const ae=de[ge],Be=l.convert(ae.format,ae.colorSpace),Ce=l.convert(ae.type),De=L(ae.internalFormat,Be,Ce,ae.colorSpace),ct=mt(T);q&&_t(T)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ct,De,T.width,T.height):_t(T)?f.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ct,De,T.width,T.height):t.renderbufferStorage(t.RENDERBUFFER,De,T.width,T.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Se(w,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const de=r.get(T.depthTexture);de.__renderTarget=T,(!de.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),pe(T.depthTexture,0);const ge=de.__webglTexture,ae=mt(T);if(T.depthTexture.format===ba)_t(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ge,0,ae):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ge,0);else if(T.depthTexture.format===Oa)_t(T)?f.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ge,0,ae):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ge,0);else throw new Error("Unknown depthTexture format")}function Ae(w){const T=r.get(w),q=w.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==w.depthTexture){const de=w.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),de){const ge=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,de.removeEventListener("dispose",ge)};de.addEventListener("dispose",ge),T.__depthDisposeCallback=ge}T.__boundDepthTexture=de}if(w.depthTexture&&!T.__autoAllocateDepthBuffer){if(q)throw new Error("target.depthTexture not supported in Cube render targets");Se(T.__webglFramebuffer,w)}else if(q){T.__webglDepthbuffer=[];for(let de=0;de<6;de++)if(n.bindFramebuffer(t.FRAMEBUFFER,T.__webglFramebuffer[de]),T.__webglDepthbuffer[de]===void 0)T.__webglDepthbuffer[de]=t.createRenderbuffer(),fe(T.__webglDepthbuffer[de],w,!1);else{const ge=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ae=T.__webglDepthbuffer[de];t.bindRenderbuffer(t.RENDERBUFFER,ae),t.framebufferRenderbuffer(t.FRAMEBUFFER,ge,t.RENDERBUFFER,ae)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=t.createRenderbuffer(),fe(T.__webglDepthbuffer,w,!1);else{const de=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ge=T.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ge),t.framebufferRenderbuffer(t.FRAMEBUFFER,de,t.RENDERBUFFER,ge)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function We(w,T,q){const de=r.get(w);T!==void 0&&_e(de.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),q!==void 0&&Ae(w)}function Tt(w){const T=w.texture,q=r.get(w),de=r.get(T);w.addEventListener("dispose",F);const ge=w.textures,ae=w.isWebGLCubeRenderTarget===!0,Be=ge.length>1;if(Be||(de.__webglTexture===void 0&&(de.__webglTexture=t.createTexture()),de.__version=T.version,c.memory.textures++),ae){q.__webglFramebuffer=[];for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0){q.__webglFramebuffer[Ce]=[];for(let De=0;De<T.mipmaps.length;De++)q.__webglFramebuffer[Ce][De]=t.createFramebuffer()}else q.__webglFramebuffer[Ce]=t.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){q.__webglFramebuffer=[];for(let Ce=0;Ce<T.mipmaps.length;Ce++)q.__webglFramebuffer[Ce]=t.createFramebuffer()}else q.__webglFramebuffer=t.createFramebuffer();if(Be)for(let Ce=0,De=ge.length;Ce<De;Ce++){const ct=r.get(ge[Ce]);ct.__webglTexture===void 0&&(ct.__webglTexture=t.createTexture(),c.memory.textures++)}if(w.samples>0&&_t(w)===!1){q.__webglMultisampledFramebuffer=t.createFramebuffer(),q.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let Ce=0;Ce<ge.length;Ce++){const De=ge[Ce];q.__webglColorRenderbuffer[Ce]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,q.__webglColorRenderbuffer[Ce]);const ct=l.convert(De.format,De.colorSpace),ye=l.convert(De.type),Fe=L(De.internalFormat,ct,ye,De.colorSpace,w.isXRRenderTarget===!0),nt=mt(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,nt,Fe,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ce,t.RENDERBUFFER,q.__webglColorRenderbuffer[Ce])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(q.__webglDepthRenderbuffer=t.createRenderbuffer(),fe(q.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ae){n.bindTexture(t.TEXTURE_CUBE_MAP,de.__webglTexture),Y(t.TEXTURE_CUBE_MAP,T);for(let Ce=0;Ce<6;Ce++)if(T.mipmaps&&T.mipmaps.length>0)for(let De=0;De<T.mipmaps.length;De++)_e(q.__webglFramebuffer[Ce][De],w,T,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,De);else _e(q.__webglFramebuffer[Ce],w,T,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0);x(T)&&v(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Be){for(let Ce=0,De=ge.length;Ce<De;Ce++){const ct=ge[Ce],ye=r.get(ct);n.bindTexture(t.TEXTURE_2D,ye.__webglTexture),Y(t.TEXTURE_2D,ct),_e(q.__webglFramebuffer,w,ct,t.COLOR_ATTACHMENT0+Ce,t.TEXTURE_2D,0),x(ct)&&v(t.TEXTURE_2D)}n.unbindTexture()}else{let Ce=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Ce=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Ce,de.__webglTexture),Y(Ce,T),T.mipmaps&&T.mipmaps.length>0)for(let De=0;De<T.mipmaps.length;De++)_e(q.__webglFramebuffer[De],w,T,t.COLOR_ATTACHMENT0,Ce,De);else _e(q.__webglFramebuffer,w,T,t.COLOR_ATTACHMENT0,Ce,0);x(T)&&v(Ce),n.unbindTexture()}w.depthBuffer&&Ae(w)}function ht(w){const T=w.textures;for(let q=0,de=T.length;q<de;q++){const ge=T[q];if(x(ge)){const ae=N(w),Be=r.get(ge).__webglTexture;n.bindTexture(ae,Be),v(ae),n.unbindTexture()}}}const At=[],G=[];function cn(w){if(w.samples>0){if(_t(w)===!1){const T=w.textures,q=w.width,de=w.height;let ge=t.COLOR_BUFFER_BIT;const ae=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Be=r.get(w),Ce=T.length>1;if(Ce)for(let De=0;De<T.length;De++)n.bindFramebuffer(t.FRAMEBUFFER,Be.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+De,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Be.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+De,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Be.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Be.__webglFramebuffer);for(let De=0;De<T.length;De++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(ge|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(ge|=t.STENCIL_BUFFER_BIT)),Ce){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Be.__webglColorRenderbuffer[De]);const ct=r.get(T[De]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ct,0)}t.blitFramebuffer(0,0,q,de,0,0,q,de,ge,t.NEAREST),d===!0&&(At.length=0,G.length=0,At.push(t.COLOR_ATTACHMENT0+De),w.depthBuffer&&w.resolveDepthBuffer===!1&&(At.push(ae),G.push(ae),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,G)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,At))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Ce)for(let De=0;De<T.length;De++){n.bindFramebuffer(t.FRAMEBUFFER,Be.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+De,t.RENDERBUFFER,Be.__webglColorRenderbuffer[De]);const ct=r.get(T[De]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Be.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+De,t.TEXTURE_2D,ct,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Be.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&d){const T=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[T])}}}function mt(w){return Math.min(o.maxSamples,w.samples)}function _t(w){const T=r.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function tt(w){const T=c.render.frame;g.get(w)!==T&&(g.set(w,T),w.update())}function Lt(w,T){const q=w.colorSpace,de=w.format,ge=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||q!==Ka&&q!==zs&&(bt.getTransfer(q)===zt?(de!==cr||ge!==rs)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",q)),T}function qe(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(p.width=w.naturalWidth||w.width,p.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(p.width=w.displayWidth,p.height=w.displayHeight):(p.width=w.width,p.height=w.height),p}this.allocateTextureUnit=Q,this.resetTextureUnits=le,this.setTexture2D=pe,this.setTexture2DArray=te,this.setTexture3D=re,this.setTextureCube=O,this.rebindTextures=We,this.setupRenderTarget=Tt,this.updateRenderTargetMipmap=ht,this.updateMultisampleRenderTarget=cn,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=_t}function OA(t,e){function n(r,o=zs){let l;const c=bt.getTransfer(o);if(r===rs)return t.UNSIGNED_BYTE;if(r===Nm)return t.UNSIGNED_SHORT_4_4_4_4;if(r===Im)return t.UNSIGNED_SHORT_5_5_5_1;if(r===C2)return t.UNSIGNED_INT_5_9_9_9_REV;if(r===w2)return t.BYTE;if(r===A2)return t.SHORT;if(r===iu)return t.UNSIGNED_SHORT;if(r===Dm)return t.INT;if(r===Lo)return t.UNSIGNED_INT;if(r===ts)return t.FLOAT;if(r===lu)return t.HALF_FLOAT;if(r===R2)return t.ALPHA;if(r===b2)return t.RGB;if(r===cr)return t.RGBA;if(r===P2)return t.LUMINANCE;if(r===L2)return t.LUMINANCE_ALPHA;if(r===ba)return t.DEPTH_COMPONENT;if(r===Oa)return t.DEPTH_STENCIL;if(r===D2)return t.RED;if(r===Um)return t.RED_INTEGER;if(r===N2)return t.RG;if(r===Fm)return t.RG_INTEGER;if(r===Om)return t.RGBA_INTEGER;if(r===sf||r===of||r===af||r===lf)if(c===zt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(r===sf)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===of)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===af)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===lf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(r===sf)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===of)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===af)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===lf)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Op||r===kp||r===Bp||r===zp)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(r===Op)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===kp)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Bp)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===zp)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Vp||r===Hp||r===Gp)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(r===Vp||r===Hp)return c===zt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(r===Gp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Wp||r===Xp||r===jp||r===Yp||r===qp||r===$p||r===Kp||r===Zp||r===Qp||r===Jp||r===em||r===tm||r===nm||r===im)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(r===Wp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Xp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===jp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Yp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===qp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===$p)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Kp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Zp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Qp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Jp)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===em)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===tm)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===nm)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===im)return c===zt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===uf||r===rm||r===sm)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(r===uf)return c===zt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===rm)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===sm)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===I2||r===om||r===am||r===lm)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(r===uf)return l.COMPRESSED_RED_RGTC1_EXT;if(r===om)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===am)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===lm)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Fa?t.UNSIGNED_INT_24_8:t[r]!==void 0?t[r]:null}return{convert:n}}class kA extends Yi{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Zl extends On{constructor(){super(),this.isGroup=!0,this.type="Group"}}const BA={type:"move"};class fp{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Zl,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Zl,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new ie,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new ie),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Zl,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new ie,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new ie),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const r of e.hand.values())this._getHandJoint(n,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,r){let o=null,l=null,c=null;const f=this._targetRay,d=this._grip,p=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(p&&e.hand){c=!0;for(const A of e.hand.values()){const x=n.getJointPose(A,r),v=this._getHandJoint(p,A);x!==null&&(v.matrix.fromArray(x.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=x.radius),v.visible=x!==null}const g=p.joints["index-finger-tip"],_=p.joints["thumb-tip"],y=g.position.distanceTo(_.position),S=.02,E=.005;p.inputState.pinching&&y>S+E?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&y<=S-E&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else d!==null&&e.gripSpace&&(l=n.getPose(e.gripSpace,r),l!==null&&(d.matrix.fromArray(l.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,l.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(l.linearVelocity)):d.hasLinearVelocity=!1,l.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(l.angularVelocity)):d.hasAngularVelocity=!1));f!==null&&(o=n.getPose(e.targetRaySpace,r),o===null&&l!==null&&(o=l),o!==null&&(f.matrix.fromArray(o.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,o.linearVelocity?(f.hasLinearVelocity=!0,f.linearVelocity.copy(o.linearVelocity)):f.hasLinearVelocity=!1,o.angularVelocity?(f.hasAngularVelocity=!0,f.angularVelocity.copy(o.angularVelocity)):f.hasAngularVelocity=!1,this.dispatchEvent(BA)))}return f!==null&&(f.visible=o!==null),d!==null&&(d.visible=l!==null),p!==null&&(p.visible=c!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const r=new Zl;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[n.jointName]=r,e.add(r)}return e.joints[n.jointName]}}const zA=`
void main() {
...
void main() {
...
}`;class HA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,r){if(this.texture===null){const o=new mi,l=e.properties.get(o);l.__webglTexture=n.texture,(n.depthNear!=r.depthNear||n.depthFar!=r.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=o}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,r=new $i({vertexShader:zA,fragmentShader:VA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new fr(new Rf(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class GA extends Za{constructor(e,n){super();const r=this;let o=null,l=1,c=null,f="local-floor",d=1,p=null,g=null,_=null,y=null,S=null,E=null;const A=new HA,x=n.getContextAttributes();let v=null,N=null;const L=[],b=[],j=new Bt;let U=null;const F=new Yi;F.viewport=new ln;const H=new Yi;H.viewport=new ln;const P=[F,H],R=new kA;let B=null,le=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let ce=L[Z];return ce===void 0&&(ce=new fp,L[Z]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(Z){let ce=L[Z];return ce===void 0&&(ce=new fp,L[Z]=ce),ce.getGripSpace()},this.getHand=function(Z){let ce=L[Z];return ce===void 0&&(ce=new fp,L[Z]=ce),ce.getHandSpace()};function Q(Z){const ce=b.indexOf(Z.inputSource);if(ce===-1)return;const _e=L[ce];_e!==void 0&&(_e.update(Z.inputSource,Z.frame,p||c),_e.dispatchEvent({type:Z.type,data:Z.inputSource}))}function he(){o.removeEventListener("select",Q),o.removeEventListener("selectstart",Q),o.removeEventListener("selectend",Q),o.removeEventListener("squeeze",Q),o.removeEventListener("squeezestart",Q),o.removeEventListener("squeezeend",Q),o.removeEventListener("end",he),o.removeEventListener("inputsourceschange",pe);for(let Z=0;Z<L.length;Z++){const ce=b[Z];ce!==null&&(b[Z]=null,L[Z].disconnect(ce))}B=null,le=null,A.reset(),e.setRenderTarget(v),S=null,y=null,_=null,o=null,N=null,Re.stop(),r.isPresenting=!1,e.setPixelRatio(U),e.setSize(j.width,j.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){l=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){f=Z,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||c},this.setReferenceSpace=function(Z){p=Z},this.getBaseLayer=function(){return y!==null?y:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return o},this.setSession=async function(Z){if(o=Z,o!==null){if(v=e.getRenderTarget(),o.addEventListener("select",Q),o.addEventListener("selectstart",Q),o.addEventListener("selectend",Q),o.addEventListener("squeeze",Q),o.addEventListener("squeezestart",Q),o.addEventListener("squeezeend",Q),o.addEventListener("end",he),o.addEventListener("inputsourceschange",pe),x.xrCompatible!==!0&&await n.makeXRCompatible(),U=e.getPixelRatio(),e.getSize(j),o.renderState.layers===void 0){const ce={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:l};S=new XRWebGLLayer(o,n,ce),o.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),N=new Do(S.framebufferWidth,S.framebufferHeight,{format:cr,type:rs,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let ce=null,_e=null,fe=null;x.depth&&(fe=x.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ce=x.stencil?Oa:ba,_e=x.stencil?Fa:Lo);const Se={colorFormat:n.RGBA8,depthFormat:fe,scaleFactor:l};_=new XRWebGLBinding(o,n),y=_.createProjectionLayer(Se),o.updateRenderState({layers:[y]}),e.setPixelRatio(1),e.setSize(y.textureWidth,y.textureHeight,!1),N=new Do(y.textureWidth,y.textureHeight,{format:cr,type:rs,depthTexture:new $2(y.textureWidth,y.textureHeight,_e,void 0,void 0,void 0,void 0,void 0,void 0,ce),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1})}N.isXRRenderTarget=!0,this.setFoveation(d),p=null,c=await o.requestReferenceSpace(f),Re.setContext(o),Re.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(o!==null)return o.environmentBlendMode},this.getDepthTexture=function(){return A.getDepthTexture()};function pe(Z){for(let ce=0;ce<Z.removed.length;ce++){const _e=Z.removed[ce],fe=b.indexOf(_e);fe>=0&&(b[fe]=null,L[fe].disconnect(_e))}for(let ce=0;ce<Z.added.length;ce++){const _e=Z.added[ce];let fe=b.indexOf(_e);if(fe===-1){for(let Ae=0;Ae<L.length;Ae++)if(Ae>=b.length){b.push(_e),fe=Ae;break}else if(b[Ae]===null){b[Ae]=_e,fe=Ae;break}if(fe===-1)break}const Se=L[fe];Se&&Se.connect(_e)}}const te=new ie,re=new ie;function O(Z,ce,_e){te.setFromMatrixPosition(ce.matrixWorld),re.setFromMatrixPosition(_e.matrixWorld);const fe=te.distanceTo(re),Se=ce.projectionMatrix.elements,Ae=_e.projectionMatrix.elements,We=Se[14]/(Se[10]-1),Tt=Se[14]/(Se[10]+1),ht=(Se[9]+1)/Se[5],At=(Se[9]-1)/Se[5],G=(Se[8]-1)/Se[0],cn=(Ae[8]+1)/Ae[0],mt=We*G,_t=We*cn,tt=fe/(-G+cn),Lt=tt*-G;if(ce.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Lt),Z.translateZ(tt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Se[10]===-1)Z.projectionMatrix.copy(ce.projectionMatrix),Z.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{const qe=We+tt,w=Tt+tt,T=mt-Lt,q=_t+(fe-Lt),de=ht*Tt/w*qe,ge=At*Tt/w*qe;Z.projectionMatrix.makePerspective(T,q,de,ge,qe,w),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function ue(Z,ce){ce===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(ce.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(o===null)return;let ce=Z.near,_e=Z.far;A.texture!==null&&(A.depthNear>0&&(ce=A.depthNear),A.depthFar>0&&(_e=A.depthFar)),R.near=H.near=F.near=ce,R.far=H.far=F.far=_e,(B!==R.near||le!==R.far)&&(o.updateRenderState({depthNear:R.near,depthFar:R.far}),B=R.near,le=R.far),F.layers.mask=Z.layers.mask|2,H.layers.mask=Z.layers.mask|4,R.layers.mask=F.layers.mask|H.layers.mask;const fe=Z.parent,Se=R.cameras;ue(R,fe);for(let Ae=0;Ae<Se.length;Ae++)ue(Se[Ae],fe);Se.length===2?O(R,F,H):R.projectionMatrix.copy(F.projectionMatrix),se(Z,R,fe)};function se(Z,ce,_e){_e===null?Z.matrix.copy(ce.matrixWorld):(Z.matrix.copy(_e.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(ce.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(ce.projectionMatrix),Z.projectionMatrixInverse.copy(ce.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=um*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(y===null&&S===null))return d},this.setFoveation=function(Z){d=Z,y!==null&&(y.fixedFoveation=Z),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=Z)},this.hasDepthSensing=function(){return A.texture!==null},this.getDepthSensingMesh=function(){return A.getMesh(R)};let D=null;function Y(Z,ce){if(g=ce.getViewerPose(p||c),E=ce,g!==null){const _e=g.views;S!==null&&(e.setRenderTargetFramebuffer(N,S.framebuffer),e.setRenderTarget(N));let fe=!1;_e.length!==R.cameras.length&&(R.cameras.length=0,fe=!0);for(let Ae=0;Ae<_e.length;Ae++){const We=_e[Ae];let Tt=null;if(S!==null)Tt=S.getViewport(We);else{const At=_.getViewSubImage(y,We);Tt=At.viewport,Ae===0&&(e.setRenderTargetTextures(N,At.colorTexture,y.ignoreDepthValues?void 0:At.depthStencilTexture),e.setRenderTarget(N))}let ht=P[Ae];ht===void 0&&(ht=new Yi,ht.layers.enable(Ae),ht.viewport=new ln,P[Ae]=ht),ht.matrix.fromArray(We.transform.matrix),ht.matrix.decompose(ht.position,ht.quaternion,ht.scale),ht.projectionMatrix.fromArray(We.projectionMatrix),ht.projectionMatrixInverse.copy(ht.projectionMatrix).invert(),ht.viewport.set(Tt.x,Tt.y,Tt.width,Tt.height),Ae===0&&(R.matrix.copy(ht.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),fe===!0&&R.cameras.push(ht)}const Se=o.enabledFeatures;if(Se&&Se.includes("depth-sensing")){const Ae=_.getDepthInformation(_e[0]);Ae&&Ae.isValid&&Ae.texture&&A.init(e,Ae,o.renderState)}}for(let _e=0;_e<L.length;_e++){const fe=b[_e],Se=L[_e];fe!==null&&Se!==void 0&&Se.update(fe,ce,p||c)}D&&D(Z,ce),ce.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ce}),E=null}const Re=new Y2;Re.setAnimationLoop(Y),this.setAnimationLoop=function(Z){D=Z},this.dispose=function(){}}}const mo=new ss,WA=new rn;function XA(t,e){function n(x,v){x.matrixAutoUpdate===!0&&x.updateMatrix(),v.value.copy(x.matrix)}function r(x,v){v.color.getRGB(x.fogColor.value,W2(t)),v.isFog?(x.fogNear.value=v.near,x.fogFar.value=v.far):v.isFogExp2&&(x.fogDensity.value=v.density)}function o(x,v,N,L,b){v.isMeshBasicMaterial||v.isMeshLambertMaterial?l(x,v):v.isMeshToonMaterial?(l(x,v),_(x,v)):v.isMeshPhongMaterial?(l(x,v),g(x,v)):v.isMeshStandardMaterial?(l(x,v),y(x,v),v.isMeshPhysicalMaterial&&S(x,v,b)):v.isMeshMatcapMaterial?(l(x,v),E(x,v)):v.isMeshDepthMaterial?l(x,v):v.isMeshDistanceMaterial?(l(x,v),A(x,v)):v.isMeshNormalMaterial?l(x,v):v.isLineBasicMaterial?(c(x,v),v.isLineDashedMaterial&&f(x,v)):v.isPointsMaterial?d(x,v,N,L):v.isSpriteMaterial?p(x,v):v.isShadowMaterial?(x.color.value.copy(v.color),x.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function l(x,v){x.opacity.value=v.opacity,v.color&&x.diffuse.value.copy(v.color),v.emissive&&x.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(x.map.value=v.map,n(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.bumpMap&&(x.bumpMap.value=v.bumpMap,n(v.bumpMap,x.bumpMapTransform),x.bumpScale.value=v.bumpScale,v.side===pi&&(x.bumpScale.value*=-1)),v.normalMap&&(x.normalMap.value=v.normalMap,n(v.normalMap,x.normalMapTransform),x.normalScale.value.copy(v.normalScale),v.side===pi&&x.normalScale.value.negate()),v.displacementMap&&(x.displacementMap.value=v.displacementMap,n(v.displacementMap,x.displacementMapTransform),x.displacementScale.value=v.displacementScale,x.displacementBias.value=v.displacementBias),v.emissiveMap&&(x.emissiveMap.value=v.emissiveMap,n(v.emissiveMap,x.emissiveMapTransform)),v.specularMap&&(x.specularMap.value=v.specularMap,n(v.specularMap,x.specularMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest);const N=e.get(v),L=N.envMap,b=N.envMapRotation;L&&(x.envMap.value=L,mo.copy(b),mo.x*=-1,mo.y*=-1,mo.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(mo.y*=-1,mo.z*=-1),x.envMapRotation.value.setFromMatrix4(WA.makeRotationFromEuler(mo)),x.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=v.reflectivity,x.ior.value=v.ior,x.refractionRatio.value=v.refractionRatio),v.lightMap&&(x.lightMap.value=v.lightMap,x.lightMapIntensity.value=v.lightMapIntensity,n(v.lightMap,x.lightMapTransform)),v.aoMap&&(x.aoMap.value=v.aoMap,x.aoMapIntensity.value=v.aoMapIntensity,n(v.aoMap,x.aoMapTransform))}function c(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,v.map&&(x.map.value=v.map,n(v.map,x.mapTransform))}function f(x,v){x.dashSize.value=v.dashSize,x.totalSize.value=v.dashSize+v.gapSize,x.scale.value=v.scale}function d(x,v,N,L){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.size.value=v.size*N,x.scale.value=L*.5,v.map&&(x.map.value=v.map,n(v.map,x.uvTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function p(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.rotation.value=v.rotation,v.map&&(x.map.value=v.map,n(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,n(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function g(x,v){x.specular.value.copy(v.specular),x.shininess.value=Math.max(v.shininess,1e-4)}function _(x,v){v.gradientMap&&(x.gradientMap.value=v.gradientMap)}function y(x,v){x.metalness.value=v.metalness,v.metalnessMap&&(x.metalnessMap.value=v.metalnessMap,n(v.metalnessMap,x.metalnessMapTransform)),x.roughness.value=v.roughness,v.roughnessMap&&(x.roughnessMap.value=v.roughnessMap,n(v.roughnessMap,x.roughnessMapTransform)),v.envMap&&(x.envMapIntensity.value=v.envMapIntensity)}function S(x,v,N){x.ior.value=v.ior,v.sheen>0&&(x.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),x.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(x.sheenColorMap.value=v.sheenColorMap,n(v.sheenColorMap,x.sheenColorMapTransform)),v.sheenRoughnessMap&&(x.sheenRoughnessMap.value=v.sheenRoughnessMap,n(v.sheenRoughnessMap,x.sheenRoughnessMapTransform))),v.clearcoat>0&&(x.clearcoat.value=v.clearcoat,x.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(x.clearcoatMap.value=v.clearcoatMap,n(v.clearcoatMap,x.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,n(v.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(x.clearcoatNormalMap.value=v.clearcoatNormalMap,n(v.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===pi&&x.clearcoatNormalScale.value.negate())),v.dispersion>0&&(x.dispersion.value=v.dispersion),v.iridescence>0&&(x.iridescence.value=v.iridescence,x.iridescenceIOR.value=v.iridescenceIOR,x.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(x.iridescenceMap.value=v.iridescenceMap,n(v.iridescenceMap,x.iridescenceMapTransform)),v.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=v.iridescenceThicknessMap,n(v.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),v.transmission>0&&(x.transmission.value=v.transmission,x.transmissionSamplerMap.value=N.texture,x.transmissionSamplerSize.value.set(N.width,N.height),v.transmissionMap&&(x.transmissionMap.value=v.transmissionMap,n(v.transmissionMap,x.transmissionMapTransform)),x.thickness.value=v.thickness,v.thicknessMap&&(x.thicknessMap.value=v.thicknessMap,n(v.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=v.attenuationDistance,x.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(x.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(x.anisotropyMap.value=v.anisotropyMap,n(v.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=v.specularIntensity,x.specularColor.value.copy(v.specularColor),v.specularColorMap&&(x.specularColorMap.value=v.specularColorMap,n(v.specularColorMap,x.specularColorMapTransform)),v.specularIntensityMap&&(x.specularIntensityMap.value=v.specularIntensityMap,n(v.specularIntensityMap,x.specularIntensityMapTransform))}function E(x,v){v.matcap&&(x.matcap.value=v.matcap)}function A(x,v){const N=e.get(v).light;x.referencePosition.value.setFromMatrixPosition(N.matrixWorld),x.nearDistance.value=N.shadow.camera.near,x.farDistance.value=N.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:o}}function jA(t,e,n,r){let o={},l={},c=[];const f=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function d(N,L){const b=L.program;r.uniformBlockBinding(N,b)}function p(N,L){let b=o[N.id];b===void 0&&(E(N),b=g(N),o[N.id]=b,N.addEventListener("dispose",x));const j=L.program;r.updateUBOMapping(N,j);const U=e.render.frame;l[N.id]!==U&&(y(N),l[N.id]=U)}function g(N){const L=_();N.__bindingPointIndex=L;const b=t.createBuffer(),j=N.__size,U=N.usage;return t.bindBuffer(t.UNIFORM_BUFFER,b),t.bufferData(t.UNIFORM_BUFFER,j,U),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,L,b),b}function _(){for(let N=0;N<f;N++)if(c.indexOf(N)===-1)return c.push(N),N;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(N){const L=o[N.id],b=N.uniforms,j=N.__cache;t.bindBuffer(t.UNIFORM_BUFFER,L);for(let U=0,F=b.length;U<F;U++){const H=Array.isArray(b[U])?b[U]:[b[U]];for(let P=0,R=H.length;P<R;P++){const B=H[P];if(S(B,U,P,j)===!0){const le=B.__offset,Q=Array.isArray(B.value)?B.value:[B.value];let he=0;for(let pe=0;pe<Q.length;pe++){const te=Q[pe],re=A(te);typeof te=="number"||typeof te=="boolean"?(B.__data[0]=te,t.bufferSubData(t.UNIFORM_BUFFER,le+he,B.__data)):te.isMatrix3?(B.__data[0]=te.elements[0],B.__data[1]=te.elements[1],B.__data[2]=te.elements[2],B.__data[3]=0,B.__data[4]=te.elements[3],B.__data[5]=te.elements[4],B.__data[6]=te.elements[5],B.__data[7]=0,B.__data[8]=te.elements[6],B.__data[9]=te.elements[7],B.__data[10]=te.elements[8],B.__data[11]=0):(te.toArray(B.__data,he),he+=re.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,le,B.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function S(N,L,b,j){const U=N.value,F=L+"_"+b;if(j[F]===void 0)return typeof U=="number"||typeof U=="boolean"?j[F]=U:j[F]=U.clone(),!0;{const H=j[F];if(typeof U=="number"||typeof U=="boolean"){if(H!==U)return j[F]=U,!0}else if(H.equals(U)===!1)return H.copy(U),!0}return!1}function E(N){const L=N.uniforms;let b=0;const j=16;for(let F=0,H=L.length;F<H;F++){const P=Array.isArray(L[F])?L[F]:[L[F]];for(let R=0,B=P.length;R<B;R++){const le=P[R],Q=Array.isArray(le.value)?le.value:[le.value];for(let he=0,pe=Q.length;he<pe;he++){const te=Q[he],re=A(te),O=b%j,ue=O%re.boundary,se=O+ue;b+=ue,se!==0&&j-se<re.storage&&(b+=j-se),le.__data=new Float32Array(re.storage/Float32Array.BYTES_PER_ELEMENT),le.__offset=b,b+=re.storage}}}const U=b%j;return U>0&&(b+=j-U),N.__size=b,N.__cache={},this}function A(N){const L={boundary:0,storage:0};return typeof N=="number"||typeof N=="boolean"?(L.boundary=4,L.storage=4):N.isVector2?(L.boundary=8,L.storage=8):N.isVector3||N.isColor?(L.boundary=16,L.storage=12):N.isVector4?(L.boundary=16,L.storage=16):N.isMatrix3?(L.boundary=48,L.storage=48):N.isMatrix4?(L.boundary=64,L.storage=64):N.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",N),L}function x(N){const L=N.target;L.removeEventListener("dispose",x);const b=c.indexOf(L.__bindingPointIndex);c.splice(b,1),t.deleteBuffer(o[L.id]),delete o[L.id],delete l[L.id]}function v(){for(const N in o)t.deleteBuffer(o[N]);c=[],o={},l={}}return{bind:d,update:p,dispose:v}}class YA{constructor(e={}){const{canvas:n=UM(),context:r=null,depth:o=!0,stencil:l=!1,alpha:c=!1,antialias:f=!1,premultipliedAlpha:d=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:y=!1}=e;this.isWebGLRenderer=!0;let S;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=r.getContextAttributes().alpha}else S=c;const E=new Uint32Array(4),A=new Int32Array(4);let x=null,v=null;const N=[],L=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ji,this.toneMapping=Gs,this.toneMappingExposure=1;const b=this;let j=!1,U=0,F=0,H=null,P=-1,R=null;const B=new ln,le=new ln;let Q=null;const he=new yt(0);let pe=0,te=n.width,re=n.height,O=1,ue=null,se=null;const D=new ln(0,0,te,re),Y=new ln(0,0,te,re);let Re=!1;const Z=new Bm;let ce=!1,_e=!1;const fe=new rn,Se=new rn,Ae=new ie,We=new ln,Tt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ht=!1;function At(){return H===null?O:1}let G=r;function cn(C,W){return n.getContext(C,W)}try{const C={alpha:!0,depth:o,stencil:l,antialias:f,premultipliedAlpha:d,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Lm}`),n.addEventListener("webglcontextlost",me,!1),n.addEventListener("webglcontextrestored",Ie,!1),n.addEventListener("webglcontextcreationerror",Ne,!1),G===null){const W="webgl2";if(G=cn(W,C),G===null)throw cn(W)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let mt,_t,tt,Lt,qe,w,T,q,de,ge,ae,Be,Ce,De,ct,ye,Fe,nt,ot,ke,xt,ft,Ot,V;function be(){mt=new Q4(G),mt.init(),ft=new OA(G,mt),_t=new j4(G,mt,e,ft),tt=new IA(G,mt),_t.reverseDepthBuffer&&y&&tt.buffers.depth.setReversed(!0),Lt=new tw(G),qe=new yA,w=new FA(G,mt,tt,qe,_t,ft,Lt),T=new q4(b),q=new Z4(b),de=new lE(G),Ot=new W4(G,de),ge=new J4(G,de,Lt,Ot),ae=new iw(G,ge,de,Lt),ot=new nw(G,_t,w),ye=new Y4(qe),Be=new vA(b,T,q,mt,_t,Ot,ye),Ce=new XA(b,qe),De=new SA,ct=new CA(mt),nt=new G4(b,T,q,tt,ae,S,d),Fe=new DA(b,ae,_t),V=new jA(G,Lt,_t,tt),ke=new X4(G,mt,Lt),xt=new ew(G,mt,Lt),Lt.programs=Be.programs,b.capabilities=_t,b.extensions=mt,b.properties=qe,b.renderLists=De,b.shadowMap=Fe,b.state=tt,b.info=Lt}be();const oe=new GA(b,G);this.xr=oe,this.getContext=function(){return G},this.getContextAttributes=function(){return G.getContextAttributes()},this.forceContextLoss=function(){const C=mt.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=mt.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return O},this.setPixelRatio=function(C){C!==void 0&&(O=C,this.setSize(te,re,!1))},this.getSize=function(C){return C.set(te,re)},this.setSize=function(C,W,ee=!0){if(oe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}te=C,re=W,n.width=Math.floor(C*O),n.height=Math.floor(W*O),ee===!0&&(n.style.width=C+"px",n.style.height=W+"px"),this.setViewport(0,0,C,W)},this.getDrawingBufferSize=function(C){return C.set(te*O,re*O).floor()},this.setDrawingBufferSize=function(C,W,ee){te=C,re=W,O=ee,n.width=Math.floor(C*ee),n.height=Math.floor(W*ee),this.setViewport(0,0,C,W)},this.getCurrentViewport=function(C){return C.copy(B)},this.getViewport=function(C){return C.copy(D)},this.setViewport=function(C,W,ee,ne){C.isVector4?D.set(C.x,C.y,C.z,C.w):D.set(C,W,ee,ne),tt.viewport(B.copy(D).multiplyScalar(O).round())},this.getScissor=function(C){return C.copy(Y)},this.setScissor=function(C,W,ee,ne){C.isVector4?Y.set(C.x,C.y,C.z,C.w):Y.set(C,W,ee,ne),tt.scissor(le.copy(Y).multiplyScalar(O).round())},this.getScissorTest=function(){return Re},this.setScissorTest=function(C){tt.setScissorTest(Re=C)},this.setOpaqueSort=function(C){ue=C},this.setTransparentSort=function(C){se=C},this.getClearColor=function(C){return C.copy(nt.getClearColor())},this.setClearColor=function(){nt.setClearColor.apply(nt,arguments)},this.getClearAlpha=function(){return nt.getClearAlpha()},this.setClearAlpha=function(){nt.setClearAlpha.apply(nt,arguments)},this.clear=function(C=!0,W=!0,ee=!0){let ne=0;if(C){let X=!1;if(H!==null){const we=H.texture.format;X=we===Om||we===Fm||we===Um}if(X){const we=H.texture.type,Ee=we===rs||we===Lo||we===iu||we===Fa||we===Nm||we===Im,Xe=nt.getClearColor(),He=nt.getClearAlpha(),at=Xe.r,ut=Xe.g,je=Xe.b;Ee?(E[0]=at,E[1]=ut,E[2]=je,E[3]=He,G.clearBufferuiv(G.COLOR,0,E)):(A[0]=at,A[1]=ut,A[2]=je,A[3]=He,G.clearBufferiv(G.COLOR,0,A))}else ne|=G.COLOR_BUFFER_BIT}W&&(ne|=G.DEPTH_BUFFER_BIT),ee&&(ne|=G.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G.clear(ne)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",me,!1),n.removeEventListener("webglcontextrestored",Ie,!1),n.removeEventListener("webglcontextcreationerror",Ne,!1),De.dispose(),ct.dispose(),qe.dispose(),T.dispose(),q.dispose(),ae.dispose(),Ot.dispose(),V.dispose(),Be.dispose(),oe.dispose(),oe.removeEventListener("sessionstart",Bo),oe.removeEventListener("sessionend",cs),Fr.stop()};function me(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),j=!0}function Ie(){console.log("THREE.WebGLRenderer: Context Restored."),j=!1;const C=Lt.autoReset,W=Fe.enabled,ee=Fe.autoUpdate,ne=Fe.needsUpdate,X=Fe.type;be(),Lt.autoReset=C,Fe.enabled=W,Fe.autoUpdate=ee,Fe.needsUpdate=ne,Fe.type=X}function Ne(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function dt(C){const W=C.target;W.removeEventListener("dispose",dt),Xt(W)}function Xt(C){yn(C),qe.remove(C)}function yn(C){const W=qe.get(C).programs;W!==void 0&&(W.forEach(function(ee){Be.releaseProgram(ee)}),C.isShaderMaterial&&Be.releaseShaderCache(C))}this.renderBufferDirect=function(C,W,ee,ne,X,we){W===null&&(W=Tt);const Ee=X.isMesh&&X.matrixWorld.determinant()<0,Xe=Tu(C,W,ee,ne,X);tt.setMaterial(ne,Ee);let He=ee.index,at=1;if(ne.wireframe===!0){if(He=ge.getWireframeAttribute(ee),He===void 0)return;at=2}const ut=ee.drawRange,je=ee.attributes.position;let Et=ut.start*at,Ut=(ut.start+ut.count)*at;we!==null&&(Et=Math.max(Et,we.start*at),Ut=Math.min(Ut,(we.start+we.count)*at)),He!==null?(Et=Math.max(Et,0),Ut=Math.min(Ut,He.count)):je!=null&&(Et=Math.max(Et,0),Ut=Math.min(Ut,je.count));const Mt=Ut-Et;if(Mt<0||Mt===1/0)return;Ot.setup(X,ne,Xe,ee,He);let Bn,pt=ke;if(He!==null&&(Bn=de.get(He),pt=xt,pt.setIndex(Bn)),X.isMesh)ne.wireframe===!0?(tt.setLineWidth(ne.wireframeLinewidth*At()),pt.setMode(G.LINES)):pt.setMode(G.TRIANGLES);else if(X.isLine){let $e=ne.linewidth;$e===void 0&&($e=1),tt.setLineWidth($e*At()),X.isLineSegments?pt.setMode(G.LINES):X.isLineLoop?pt.setMode(G.LINE_LOOP):pt.setMode(G.LINE_STRIP)}else X.isPoints?pt.setMode(G.POINTS):X.isSprite&&pt.setMode(G.TRIANGLES);if(X.isBatchedMesh)if(X._multiDrawInstances!==null)pt.renderMultiDrawInstances(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount,X._multiDrawInstances);else if(mt.get("WEBGL_multi_draw"))pt.renderMultiDraw(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount);else{const $e=X._multiDrawStarts,Qi=X._multiDrawCounts,Dt=X._multiDrawCount,zn=He?de.get(He).bytesPerElement:1,Ji=qe.get(ne).currentProgram.getUniforms();for(let xn=0;xn<Dt;xn++)Ji.setValue(G,"_gl_DrawID",xn),pt.render($e[xn]/zn,Qi[xn])}else if(X.isInstancedMesh)pt.renderInstances(Et,Mt,X.count);else if(ee.isInstancedBufferGeometry){const $e=ee._maxInstanceCount!==void 0?ee._maxInstanceCount:1/0,Qi=Math.min(ee.instanceCount,$e);pt.renderInstances(Et,Mt,Qi)}else pt.render(Et,Mt)};function Ct(C,W,ee){C.transparent===!0&&C.side===Jr&&C.forceSinglePass===!1?(C.side=pi,C.needsUpdate=!0,zo(C,W,ee),C.side=Xs,C.needsUpdate=!0,zo(C,W,ee),C.side=Jr):zo(C,W,ee)}this.compile=function(C,W,ee=null){ee===null&&(ee=C),v=ct.get(ee),v.init(W),L.push(v),ee.traverseVisible(function(X){X.isLight&&X.layers.test(W.layers)&&(v.pushLight(X),X.castShadow&&v.pushShadow(X))}),C!==ee&&C.traverseVisible(function(X){X.isLight&&X.layers.test(W.layers)&&(v.pushLight(X),X.castShadow&&v.pushShadow(X))}),v.setupLights();const ne=new Set;return C.traverse(function(X){if(!(X.isMesh||X.isPoints||X.isLine||X.isSprite))return;const we=X.material;if(we)if(Array.isArray(we))for(let Ee=0;Ee<we.length;Ee++){const Xe=we[Ee];Ct(Xe,ee,X),ne.add(Xe)}else Ct(we,ee,X),ne.add(we)}),L.pop(),v=null,ne},this.compileAsync=function(C,W,ee=null){const ne=this.compile(C,W,ee);return new Promise(X=>{function we(){if(ne.forEach(function(Ee){qe.get(Ee).currentProgram.isReady()&&ne.delete(Ee)}),ne.size===0){X(C);return}setTimeout(we,10)}mt.get("KHR_parallel_shader_compile")!==null?we():setTimeout(we,10)})};let ni=null;function Zn(C){ni&&ni(C)}function Bo(){Fr.stop()}function cs(){Fr.start()}const Fr=new Y2;Fr.setAnimationLoop(Zn),typeof self<"u"&&Fr.setContext(self),this.setAnimationLoop=function(C){ni=C,oe.setAnimationLoop(C),C===null?Fr.stop():Fr.start()},oe.addEventListener("sessionstart",Bo),oe.addEventListener("sessionend",cs),this.render=function(C,W){if(W!==void 0&&W.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(j===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),W.parent===null&&W.matrixWorldAutoUpdate===!0&&W.updateMatrixWorld(),oe.enabled===!0&&oe.isPresenting===!0&&(oe.cameraAutoUpdate===!0&&oe.updateCamera(W),W=oe.getCamera()),C.isScene===!0&&C.onBeforeRender(b,C,W,H),v=ct.get(C,L.length),v.init(W),L.push(v),Se.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),Z.setFromProjectionMatrix(Se),_e=this.localClippingEnabled,ce=ye.init(this.clippingPlanes,_e),x=De.get(C,N.length),x.init(),N.push(x),oe.enabled===!0&&oe.isPresenting===!0){const we=b.xr.getDepthSensingMesh();we!==null&&Or(we,W,-1/0,b.sortObjects)}Or(C,W,0,b.sortObjects),x.finish(),b.sortObjects===!0&&x.sort(ue,se),ht=oe.enabled===!1||oe.isPresenting===!1||oe.hasDepthSensing()===!1,ht&&nt.addToRenderList(x,C),this.info.render.frame++,ce===!0&&ye.beginShadows();const ee=v.state.shadowsArray;Fe.render(ee,C,W),ce===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset();const ne=x.opaque,X=x.transmissive;if(v.setupLights(),W.isArrayCamera){const we=W.cameras;if(X.length>0)for(let Ee=0,Xe=we.length;Ee<Xe;Ee++){const He=we[Ee];Ks(ne,X,C,He)}ht&&nt.render(C);for(let Ee=0,Xe=we.length;Ee<Xe;Ee++){const He=we[Ee];$s(x,C,He,He.viewport)}}else X.length>0&&Ks(ne,X,C,W),ht&&nt.render(C),$s(x,C,W);H!==null&&(w.updateMultisampleRenderTarget(H),w.updateRenderTargetMipmap(H)),C.isScene===!0&&C.onAfterRender(b,C,W),Ot.resetDefaultState(),P=-1,R=null,L.pop(),L.length>0?(v=L[L.length-1],ce===!0&&ye.setGlobalState(b.clippingPlanes,v.state.camera)):v=null,N.pop(),N.length>0?x=N[N.length-1]:x=null};function Or(C,W,ee,ne){if(C.visible===!1)return;if(C.layers.test(W.layers)){if(C.isGroup)ee=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(W);else if(C.isLight)v.pushLight(C),C.castShadow&&v.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||Z.intersectsSprite(C)){ne&&We.setFromMatrixPosition(C.matrixWorld).applyMatrix4(Se);const Ee=ae.update(C),Xe=C.material;Xe.visible&&x.push(C,Ee,Xe,ee,We.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||Z.intersectsObject(C))){const Ee=ae.update(C),Xe=C.material;if(ne&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),We.copy(C.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),We.copy(Ee.boundingSphere.center)),We.applyMatrix4(C.matrixWorld).applyMatrix4(Se)),Array.isArray(Xe)){const He=Ee.groups;for(let at=0,ut=He.length;at<ut;at++){const je=He[at],Et=Xe[je.materialIndex];Et&&Et.visible&&x.push(C,Ee,Et,ee,We.z,je)}}else Xe.visible&&x.push(C,Ee,Xe,ee,We.z,null)}}const we=C.children;for(let Ee=0,Xe=we.length;Ee<Xe;Ee++)Or(we[Ee],W,ee,ne)}function $s(C,W,ee,ne){const X=C.opaque,we=C.transmissive,Ee=C.transparent;v.setupLightsView(ee),ce===!0&&ye.setGlobalState(b.clippingPlanes,ee),ne&&tt.viewport(B.copy(ne)),X.length>0&&fs(X,W,ee),we.length>0&&fs(we,W,ee),Ee.length>0&&fs(Ee,W,ee),tt.buffers.depth.setTest(!0),tt.buffers.depth.setMask(!0),tt.buffers.color.setMask(!0),tt.setPolygonOffset(!1)}function Ks(C,W,ee,ne){if((ee.isScene===!0?ee.overrideMaterial:null)!==null)return;v.state.transmissionRenderTarget[ne.id]===void 0&&(v.state.transmissionRenderTarget[ne.id]=new Do(1,1,{generateMipmaps:!0,type:mt.has("EXT_color_buffer_half_float")||mt.has("EXT_color_buffer_float")?lu:rs,minFilter:Mo,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:bt.workingColorSpace}));const we=v.state.transmissionRenderTarget[ne.id],Ee=ne.viewport||B;we.setSize(Ee.z,Ee.w);const Xe=b.getRenderTarget();b.setRenderTarget(we),b.getClearColor(he),pe=b.getClearAlpha(),pe<1&&b.setClearColor(16777215,.5),b.clear(),ht&&nt.render(ee);const He=b.toneMapping;b.toneMapping=Gs;const at=ne.viewport;if(ne.viewport!==void 0&&(ne.viewport=void 0),v.setupLightsView(ne),ce===!0&&ye.setGlobalState(b.clippingPlanes,ne),fs(C,ee,ne),w.updateMultisampleRenderTarget(we),w.updateRenderTargetMipmap(we),mt.has("WEBGL_multisampled_render_to_texture")===!1){let ut=!1;for(let je=0,Et=W.length;je<Et;je++){const Ut=W[je],Mt=Ut.object,Bn=Ut.geometry,pt=Ut.material,$e=Ut.group;if(pt.side===Jr&&Mt.layers.test(ne.layers)){const Qi=pt.side;pt.side=pi,pt.needsUpdate=!0,Mu(Mt,ee,ne,Bn,pt,$e),pt.side=Qi,pt.needsUpdate=!0,ut=!0}}ut===!0&&(w.updateMultisampleRenderTarget(we),w.updateRenderTargetMipmap(we))}b.setRenderTarget(Xe),b.setClearColor(he,pe),at!==void 0&&(ne.viewport=at),b.toneMapping=He}function fs(C,W,ee){const ne=W.isScene===!0?W.overrideMaterial:null;for(let X=0,we=C.length;X<we;X++){const Ee=C[X],Xe=Ee.object,He=Ee.geometry,at=ne===null?Ee.material:ne,ut=Ee.group;Xe.layers.test(ee.layers)&&Mu(Xe,W,ee,He,at,ut)}}function Mu(C,W,ee,ne,X,we){C.onBeforeRender(b,W,ee,ne,X,we),C.modelViewMatrix.multiplyMatrices(ee.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),X.onBeforeRender(b,W,ee,ne,C,we),X.transparent===!0&&X.side===Jr&&X.forceSinglePass===!1?(X.side=pi,X.needsUpdate=!0,b.renderBufferDirect(ee,W,ne,X,C,we),X.side=Xs,X.needsUpdate=!0,b.renderBufferDirect(ee,W,ne,X,C,we),X.side=Jr):b.renderBufferDirect(ee,W,ne,X,C,we),C.onAfterRender(b,W,ee,ne,X,we)}function zo(C,W,ee){W.isScene!==!0&&(W=Tt);const ne=qe.get(C),X=v.state.lights,we=v.state.shadowsArray,Ee=X.state.version,Xe=Be.getParameters(C,X.state,we,W,ee),He=Be.getProgramCacheKey(Xe);let at=ne.programs;ne.environment=C.isMeshStandardMaterial?W.environment:null,ne.fog=W.fog,ne.envMap=(C.isMeshStandardMaterial?q:T).get(C.envMap||ne.environment),ne.envMapRotation=ne.environment!==null&&C.envMap===null?W.environmentRotation:C.envMapRotation,at===void 0&&(C.addEventListener("dispose",dt),at=new Map,ne.programs=at);let ut=at.get(He);if(ut!==void 0){if(ne.currentProgram===ut&&ne.lightsStateVersion===Ee)return _r(C,Xe),ut}else Xe.uniforms=Be.getUniforms(C),C.onBeforeCompile(Xe,b),ut=Be.acquireProgram(Xe,He),at.set(He,ut),ne.uniforms=Xe.uniforms;const je=ne.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(je.clippingPlanes=ye.uniform),_r(C,Xe),ne.needsLights=Jf(C),ne.lightsStateVersion=Ee,ne.needsLights&&(je.ambientLightColor.value=X.state.ambient,je.lightProbe.value=X.state.probe,je.directionalLights.value=X.state.directional,je.directionalLightShadows.value=X.state.directionalShadow,je.spotLights.value=X.state.spot,je.spotLightShadows.value=X.state.spotShadow,je.rectAreaLights.value=X.state.rectArea,je.ltc_1.value=X.state.rectAreaLTC1,je.ltc_2.value=X.state.rectAreaLTC2,je.pointLights.value=X.state.point,je.pointLightShadows.value=X.state.pointShadow,je.hemisphereLights.value=X.state.hemi,je.directionalShadowMap.value=X.state.directionalShadowMap,je.directionalShadowMatrix.value=X.state.directionalShadowMatrix,je.spotShadowMap.value=X.state.spotShadowMap,je.spotLightMatrix.value=X.state.spotLightMatrix,je.spotLightMap.value=X.state.spotLightMap,je.pointShadowMap.value=X.state.pointShadowMap,je.pointShadowMatrix.value=X.state.pointShadowMatrix),ne.currentProgram=ut,ne.uniformsList=null,ut}function Eu(C){if(C.uniformsList===null){const W=C.currentProgram.getUniforms();C.uniformsList=cf.seqWithValue(W.seq,C.uniforms)}return C.uniformsList}function _r(C,W){const ee=qe.get(C);ee.outputColorSpace=W.outputColorSpace,ee.batching=W.batching,ee.batchingColor=W.batchingColor,ee.instancing=W.instancing,ee.instancingColor=W.instancingColor,ee.instancingMorph=W.instancingMorph,ee.skinning=W.skinning,ee.morphTargets=W.morphTargets,ee.morphNormals=W.morphNormals,ee.morphColors=W.morphColors,ee.morphTargetsCount=W.morphTargetsCount,ee.numClippingPlanes=W.numClippingPlanes,ee.numIntersection=W.numClipIntersection,ee.vertexAlphas=W.vertexAlphas,ee.vertexTangents=W.vertexTangents,ee.toneMapping=W.toneMapping}function Tu(C,W,ee,ne,X){W.isScene!==!0&&(W=Tt),w.resetTextureUnits();const we=W.fog,Ee=ne.isMeshStandardMaterial?W.environment:null,Xe=H===null?b.outputColorSpace:H.isXRRenderTarget===!0?H.texture.colorSpace:Ka,He=(ne.isMeshStandardMaterial?q:T).get(ne.envMap||Ee),at=ne.vertexColors===!0&&!!ee.attributes.color&&ee.attributes.color.itemSize===4,ut=!!ee.attributes.tangent&&(!!ne.normalMap||ne.anisotropy>0),je=!!ee.morphAttributes.position,Et=!!ee.morphAttributes.normal,Ut=!!ee.morphAttributes.color;let Mt=Gs;ne.toneMapped&&(H===null||H.isXRRenderTarget===!0)&&(Mt=b.toneMapping);const Bn=ee.morphAttributes.position||ee.morphAttributes.normal||ee.morphAttributes.color,pt=Bn!==void 0?Bn.length:0,$e=qe.get(ne),Qi=v.state.lights;if(ce===!0&&(_e===!0||C!==R)){const Qn=C===R&&ne.id===P;ye.setState(ne,C,Qn)}let Dt=!1;ne.version===$e.__version?($e.needsLights&&$e.lightsStateVersion!==Qi.state.version||$e.outputColorSpace!==Xe||X.isBatchedMesh&&$e.batching===!1||!X.isBatchedMesh&&$e.batching===!0||X.isBatchedMesh&&$e.batchingColor===!0&&X.colorTexture===null||X.isBatchedMesh&&$e.batchingColor===!1&&X.colorTexture!==null||X.isInstancedMesh&&$e.instancing===!1||!X.isInstancedMesh&&$e.instancing===!0||X.isSkinnedMesh&&$e.skinning===!1||!X.isSkinnedMesh&&$e.skinning===!0||X.isInstancedMesh&&$e.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&$e.instancingColor===!1&&X.instanceColor!==null||X.isInstancedMesh&&$e.instancingMorph===!0&&X.morphTexture===null||X.isInstancedMesh&&$e.instancingMorph===!1&&X.morphTexture!==null||$e.envMap!==He||ne.fog===!0&&$e.fog!==we||$e.numClippingPlanes!==void 0&&($e.numClippingPlanes!==ye.numPlanes||$e.numIntersection!==ye.numIntersection)||$e.vertexAlphas!==at||$e.vertexTangents!==ut||$e.morphTargets!==je||$e.morphNormals!==Et||$e.morphColors!==Ut||$e.toneMapping!==Mt||$e.morphTargetsCount!==pt)&&(Dt=!0):(Dt=!0,$e.__version=ne.version);let zn=$e.currentProgram;Dt===!0&&(zn=zo(ne,W,X));let Ji=!1,xn=!1,vr=!1;const Ht=zn.getUniforms(),Ii=$e.uniforms;if(tt.useProgram(zn.program)&&(Ji=!0,xn=!0,vr=!0),ne.id!==P&&(P=ne.id,xn=!0),Ji||R!==C){tt.buffers.depth.getReversed()?(fe.copy(C.projectionMatrix),OM(fe),kM(fe),Ht.setValue(G,"projectionMatrix",fe)):Ht.setValue(G,"projectionMatrix",C.projectionMatrix),Ht.setValue(G,"viewMatrix",C.matrixWorldInverse);const Ui=Ht.map.cameraPosition;Ui!==void 0&&Ui.setValue(G,Ae.setFromMatrixPosition(C.matrixWorld)),_t.logarithmicDepthBuffer&&Ht.setValue(G,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(ne.isMeshPhongMaterial||ne.isMeshToonMaterial||ne.isMeshLambertMaterial||ne.isMeshBasicMaterial||ne.isMeshStandardMaterial||ne.isShaderMaterial)&&Ht.setValue(G,"isOrthographic",C.isOrthographicCamera===!0),R!==C&&(R=C,xn=!0,vr=!0)}if(X.isSkinnedMesh){Ht.setOptional(G,X,"bindMatrix"),Ht.setOptional(G,X,"bindMatrixInverse");const Qn=X.skeleton;Qn&&(Qn.boneTexture===null&&Qn.computeBoneTexture(),Ht.setValue(G,"boneTexture",Qn.boneTexture,w))}X.isBatchedMesh&&(Ht.setOptional(G,X,"batchingTexture"),Ht.setValue(G,"batchingTexture",X._matricesTexture,w),Ht.setOptional(G,X,"batchingIdTexture"),Ht.setValue(G,"batchingIdTexture",X._indirectTexture,w),Ht.setOptional(G,X,"batchingColorTexture"),X._colorsTexture!==null&&Ht.setValue(G,"batchingColorTexture",X._colorsTexture,w));const kr=ee.morphAttributes;if((kr.position!==void 0||kr.normal!==void 0||kr.color!==void 0)&&ot.update(X,ee,zn),(xn||$e.receiveShadow!==X.receiveShadow)&&($e.receiveShadow=X.receiveShadow,Ht.setValue(G,"receiveShadow",X.receiveShadow)),ne.isMeshGouraudMaterial&&ne.envMap!==null&&(Ii.envMap.value=He,Ii.flipEnvMap.value=He.isCubeTexture&&He.isRenderTargetTexture===!1?-1:1),ne.isMeshStandardMaterial&&ne.envMap===null&&W.environment!==null&&(Ii.envMapIntensity.value=W.environmentIntensity),xn&&(Ht.setValue(G,"toneMappingExposure",b.toneMappingExposure),$e.needsLights&&wu(Ii,vr),we&&ne.fog===!0&&Ce.refreshFogUniforms(Ii,we),Ce.refreshMaterialUniforms(Ii,ne,O,re,v.state.transmissionRenderTarget[C.id]),cf.upload(G,Eu($e),Ii,w)),ne.isShaderMaterial&&ne.uniformsNeedUpdate===!0&&(cf.upload(G,Eu($e),Ii,w),ne.uniformsNeedUpdate=!1),ne.isSpriteMaterial&&Ht.setValue(G,"center",X.center),Ht.setValue(G,"modelViewMatrix",X.modelViewMatrix),Ht.setValue(G,"normalMatrix",X.normalMatrix),Ht.setValue(G,"modelMatrix",X.matrixWorld),ne.isShaderMaterial||ne.isRawShaderMaterial){const Qn=ne.uniformsGroups;for(let Ui=0,ii=Qn.length;Ui<ii;Ui++){const Au=Qn[Ui];V.update(Au,zn),V.bind(Au,zn)}}return zn}function wu(C,W){C.ambientLightColor.needsUpdate=W,C.lightProbe.needsUpdate=W,C.directionalLights.needsUpdate=W,C.directionalLightShadows.needsUpdate=W,C.pointLights.needsUpdate=W,C.pointLightShadows.needsUpdate=W,C.spotLights.needsUpdate=W,C.spotLightShadows.needsUpdate=W,C.rectAreaLights.needsUpdate=W,C.hemisphereLights.needsUpdate=W}function Jf(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return U},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return H},this.setRenderTargetTextures=function(C,W,ee){qe.get(C.texture).__webglTexture=W,qe.get(C.depthTexture).__webglTexture=ee;const ne=qe.get(C);ne.__hasExternalTextures=!0,ne.__autoAllocateDepthBuffer=ee===void 0,ne.__autoAllocateDepthBuffer||mt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ne.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(C,W){const ee=qe.get(C);ee.__webglFramebuffer=W,ee.__useDefaultFramebuffer=W===void 0},this.setRenderTarget=function(C,W=0,ee=0){H=C,U=W,F=ee;let ne=!0,X=null,we=!1,Ee=!1;if(C){const He=qe.get(C);if(He.__useDefaultFramebuffer!==void 0)tt.bindFramebuffer(G.FRAMEBUFFER,null),ne=!1;else if(He.__webglFramebuffer===void 0)w.setupRenderTarget(C);else if(He.__hasExternalTextures)w.rebindTextures(C,qe.get(C.texture).__webglTexture,qe.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const je=C.depthTexture;if(He.__boundDepthTexture!==je){if(je!==null&&qe.has(je)&&(C.width!==je.image.width||C.height!==je.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(C)}}const at=C.texture;(at.isData3DTexture||at.isDataArrayTexture||at.isCompressedArrayTexture)&&(Ee=!0);const ut=qe.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(ut[W])?X=ut[W][ee]:X=ut[W],we=!0):C.samples>0&&w.useMultisampledRTT(C)===!1?X=qe.get(C).__webglMultisampledFramebuffer:Array.isArray(ut)?X=ut[ee]:X=ut,B.copy(C.viewport),le.copy(C.scissor),Q=C.scissorTest}else B.copy(D).multiplyScalar(O).floor(),le.copy(Y).multiplyScalar(O).floor(),Q=Re;if(tt.bindFramebuffer(G.FRAMEBUFFER,X)&&ne&&tt.drawBuffers(C,X),tt.viewport(B),tt.scissor(le),tt.setScissorTest(Q),we){const He=qe.get(C.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_CUBE_MAP_POSITIVE_X+W,He.__webglTexture,ee)}else if(Ee){const He=qe.get(C.texture),at=W||0;G.framebufferTextureLayer(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,He.__webglTexture,ee||0,at)}P=-1},this.readRenderTargetPixels=function(C,W,ee,ne,X,we,Ee){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Xe=qe.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ee!==void 0&&(Xe=Xe[Ee]),Xe){tt.bindFramebuffer(G.FRAMEBUFFER,Xe);try{const He=C.texture,at=He.format,ut=He.type;if(!_t.textureFormatReadable(at)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!_t.textureTypeReadable(ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}W>=0&&W<=C.width-ne&&ee>=0&&ee<=C.height-X&&G.readPixels(W,ee,ne,X,ft.convert(at),ft.convert(ut),we)}finally{const He=H!==null?qe.get(H).__webglFramebuffer:null;tt.bindFramebuffer(G.FRAMEBUFFER,He)}}},this.readRenderTargetPixelsAsync=async function(C,W,ee,ne,X,we,Ee){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Xe=qe.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ee!==void 0&&(Xe=Xe[Ee]),Xe){const He=C.texture,at=He.format,ut=He.type;if(!_t.textureFormatReadable(at))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!_t.textureTypeReadable(ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(W>=0&&W<=C.width-ne&&ee>=0&&ee<=C.height-X){tt.bindFramebuffer(G.FRAMEBUFFER,Xe);const je=G.createBuffer();G.bindBuffer(G.PIXEL_PACK_BUFFER,je),G.bufferData(G.PIXEL_PACK_BUFFER,we.byteLength,G.STREAM_READ),G.readPixels(W,ee,ne,X,ft.convert(at),ft.convert(ut),0);const Et=H!==null?qe.get(H).__webglFramebuffer:null;tt.bindFramebuffer(G.FRAMEBUFFER,Et);const Ut=G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE,0);return G.flush(),await FM(G,Ut,4),G.bindBuffer(G.PIXEL_PACK_BUFFER,je),G.getBufferSubData(G.PIXEL_PACK_BUFFER,0,we),G.deleteBuffer(je),G.deleteSync(Ut),we}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(C,W=null,ee=0){C.isTexture!==!0&&($l("WebGLRenderer: copyFramebufferToTexture function signature has changed."),W=arguments[0]||null,C=arguments[1]);const ne=Math.pow(2,-ee),X=Math.floor(C.image.width*ne),we=Math.floor(C.image.height*ne),Ee=W!==null?W.x:0,Xe=W!==null?W.y:0;w.setTexture2D(C,0),G.copyTexSubImage2D(G.TEXTURE_2D,ee,0,0,Ee,Xe,X,we),tt.unbindTexture()},this.copyTextureToTexture=function(C,W,ee=null,ne=null,X=0){C.isTexture!==!0&&($l("WebGLRenderer: copyTextureToTexture function signature has changed."),ne=arguments[0]||null,C=arguments[1],W=arguments[2],X=arguments[3]||0,ee=null);let we,Ee,Xe,He,at,ut,je,Et,Ut;const Mt=C.isCompressedTexture?C.mipmaps[X]:C.image;ee!==null?(we=ee.max.x-ee.min.x,Ee=ee.max.y-ee.min.y,Xe=ee.isBox3?ee.max.z-ee.min.z:1,He=ee.min.x,at=ee.min.y,ut=ee.isBox3?ee.min.z:0):(we=Mt.width,Ee=Mt.height,Xe=Mt.depth||1,He=0,at=0,ut=0),ne!==null?(je=ne.x,Et=ne.y,Ut=ne.z):(je=0,Et=0,Ut=0);const Bn=ft.convert(W.format),pt=ft.convert(W.type);let $e;W.isData3DTexture?(w.setTexture3D(W,0),$e=G.TEXTURE_3D):W.isDataArrayTexture||W.isCompressedArrayTexture?(w.setTexture2DArray(W,0),$e=G.TEXTURE_2D_ARRAY):(w.setTexture2D(W,0),$e=G.TEXTURE_2D),G.pixelStorei(G.UNPACK_FLIP_Y_WEBGL,W.flipY),G.pixelStorei(G.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),G.pixelStorei(G.UNPACK_ALIGNMENT,W.unpackAlignment);const Qi=G.getParameter(G.UNPACK_ROW_LENGTH),Dt=G.getParameter(G.UNPACK_IMAGE_HEIGHT),zn=G.getParameter(G.UNPACK_SKIP_PIXELS),Ji=G.getParameter(G.UNPACK_SKIP_ROWS),xn=G.getParameter(G.UNPACK_SKIP_IMAGES);G.pixelStorei(G.UNPACK_ROW_LENGTH,Mt.width),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Mt.height),G.pixelStorei(G.UNPACK_SKIP_PIXELS,He),G.pixelStorei(G.UNPACK_SKIP_ROWS,at),G.pixelStorei(G.UNPACK_SKIP_IMAGES,ut);const vr=C.isDataArrayTexture||C.isData3DTexture,Ht=W.isDataArrayTexture||W.isData3DTexture;if(C.isRenderTargetTexture||C.isDepthTexture){const Ii=qe.get(C),kr=qe.get(W),Qn=qe.get(Ii.__renderTarget),Ui=qe.get(kr.__renderTarget);tt.bindFramebuffer(G.READ_FRAMEBUFFER,Qn.__webglFramebuffer),tt.bindFramebuffer(G.DRAW_FRAMEBUFFER,Ui.__webglFramebuffer);for(let ii=0;ii<Xe;ii++)vr&&G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,qe.get(C).__webglTexture,X,ut+ii),C.isDepthTexture?(Ht&&G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,qe.get(W).__webglTexture,X,Ut+ii),G.blitFramebuffer(He,at,we,Ee,je,Et,we,Ee,G.DEPTH_BUFFER_BIT,G.NEAREST)):Ht?G.copyTexSubImage3D($e,X,je,Et,Ut+ii,He,at,we,Ee):G.copyTexSubImage2D($e,X,je,Et,Ut+ii,He,at,we,Ee);tt.bindFramebuffer(G.READ_FRAMEBUFFER,null),tt.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else Ht?C.isDataTexture||C.isData3DTexture?G.texSubImage3D($e,X,je,Et,Ut,we,Ee,Xe,Bn,pt,Mt.data):W.isCompressedArrayTexture?G.compressedTexSubImage3D($e,X,je,Et,Ut,we,Ee,Xe,Bn,Mt.data):G.texSubImage3D($e,X,je,Et,Ut,we,Ee,Xe,Bn,pt,Mt):C.isDataTexture?G.texSubImage2D(G.TEXTURE_2D,X,je,Et,we,Ee,Bn,pt,Mt.data):C.isCompressedTexture?G.compressedTexSubImage2D(G.TEXTURE_2D,X,je,Et,Mt.width,Mt.height,Bn,Mt.data):G.texSubImage2D(G.TEXTURE_2D,X,je,Et,we,Ee,Bn,pt,Mt);G.pixelStorei(G.UNPACK_ROW_LENGTH,Qi),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Dt),G.pixelStorei(G.UNPACK_SKIP_PIXELS,zn),G.pixelStorei(G.UNPACK_SKIP_ROWS,Ji),G.pixelStorei(G.UNPACK_SKIP_IMAGES,xn),X===0&&W.generateMipmaps&&G.generateMipmap($e),tt.unbindTexture()},this.copyTextureToTexture3D=function(C,W,ee=null,ne=null,X=0){return C.isTexture!==!0&&($l("WebGLRenderer: copyTextureToTexture3D function signature has changed."),ee=arguments[0]||null,ne=arguments[1]||null,C=arguments[2],W=arguments[3],X=arguments[4]||0),$l('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(C,W,ee,ne,X)},this.initRenderTarget=function(C){qe.get(C).__webglFramebuffer===void 0&&w.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?w.setTextureCube(C,0):C.isData3DTexture?w.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?w.setTexture2DArray(C,0):w.setTexture2D(C,0),tt.unbindTexture()},this.resetState=function(){U=0,F=0,H=null,tt.reset(),Ot.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ns}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorspace=bt._getDrawingBufferColorSpace(e),n.unpackColorSpace=bt._getUnpackColorSpace()}}class mf{constructor(e,n=25e-5){this.isFogExp2=!0,this.name="",this.color=new yt(e),this.density=n}clone(){return new mf(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class qA extends On{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ss,this.environmentIntensity=1,this.environmentRotation=new ss,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class ey extends du{static get type(){return"PointsMaterial"}constructor(e){super(),this.isPointsMaterial=!0,this.color=new yt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const c1=new rn,fm=new B2,$c=new Cf,Kc=new ie;class gf extends On{constructor(e=new Ri,n=new ey){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const r=this.geometry,o=this.matrixWorld,l=e.params.Points.threshold,c=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),$c.copy(r.boundingSphere),$c.applyMatrix4(o),$c.radius+=l,e.ray.intersectsSphere($c)===!1)return;c1.copy(o).invert(),fm.copy(e.ray).applyMatrix4(c1);const f=l/((this.scale.x+this.scale.y+this.scale.z)/3),d=f*f,p=r.index,_=r.attributes.position;if(p!==null){const y=Math.max(0,c.start),S=Math.min(p.count,c.start+c.count);for(let E=y,A=S;E<A;E++){const x=p.getX(E);Kc.fromBufferAttribute(_,x),f1(Kc,x,d,o,e,n,this)}}else{const y=Math.max(0,c.start),S=Math.min(_.count,c.start+c.count);for(let E=y,A=S;E<A;E++)Kc.fromBufferAttribute(_,E),f1(Kc,E,d,o,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,r=Object.keys(n);if(r.length>0){const o=n[r[0]];if(o!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let l=0,c=o.length;l<c;l++){const f=o[l].name||String(l);this.morphTargetInfluences.push(0),this.morphTargetDictionary[f]=l}}}}}function f1(t,e,n,r,o,l,c){const f=fm.distanceSqToPoint(t);if(f<n){const d=new ie;fm.closestPointToPoint(t,d),d.applyMatrix4(r);const p=o.ray.origin.distanceTo(d);if(p<o.near||p>o.far)return;l.push({distance:p,distanceToRay:Math.sqrt(f),point:d,index:e,face:null,faceIndex:null,barycoord:null,object:c})}}class _f extends Ri{constructor(e=1,n=32,r=16,o=0,l=Math.PI*2,c=0,f=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:r,phiStart:o,phiLength:l,thetaStart:c,thetaLength:f},n=Math.max(3,Math.floor(n)),r=Math.max(2,Math.floor(r));const d=Math.min(c+f,Math.PI);let p=0;const g=[],_=new ie,y=new ie,S=[],E=[],A=[],x=[];for(let v=0;v<=r;v++){const N=[],L=v/r;let b=0;v===0&&c===0?b=.5/n:v===r&&d===Math.PI&&(b=-.5/n);for(let j=0;j<=n;j++){const U=j/n;_.x=-e*Math.cos(o+U*l)*Math.sin(c+L*f),_.y=e*Math.cos(c+L*f),_.z=e*Math.sin(o+U*l)*Math.sin(c+L*f),E.push(_.x,_.y,_.z),y.copy(_).normalize(),A.push(y.x,y.y,y.z),x.push(U+b,1-L),N.push(p++)}g.push(N)}for(let v=0;v<r;v++)for(let N=0;N<n;N++){const L=g[v][N+1],b=g[v][N],j=g[v+1][N],U=g[v+1][N+1];(v!==0||c>0)&&S.push(L,b,U),(v!==r-1||d<Math.PI)&&S.push(b,j,U)}this.setIndex(S),this.setAttribute("position",new Rr(E,3)),this.setAttribute("normal",new Rr(A,3)),this.setAttribute("uv",new Rr(x,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new _f(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class ty extends On{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new yt(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const dp=new rn,d1=new ie,h1=new ie;class $A{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Bt(512,512),this.map=null,this.mapPass=null,this.matrix=new rn,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Bm,this._frameExtents=new Bt(1,1),this._viewportCount=1,this._viewports=[new ln(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,r=this.matrix;d1.setFromMatrixPosition(e.matrixWorld),n.position.copy(d1),h1.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(h1),n.updateMatrixWorld(),dp.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(dp),r.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),r.multiply(dp)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class KA extends $A{constructor(){super(new q2(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class p1 extends ty{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(On.DEFAULT_UP),this.updateMatrix(),this.target=new On,this.shadow=new KA}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class ZA extends ty{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Lm}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Lm);const Zc=1.5;function hp({count:t,innerR:e,outerR:n,colorInner:r,colorOuter:o,tilt:l,opacity:c,sizeMin:f,sizeMax:d,renderOrder:p}){const g=new Ri,_=new Float32Array(t*3),y=new Float32Array(t*3),S=new Float32Array(t),E=new yt(r),A=new yt(o);for(let L=0;L<t;L++){const b=Math.random()*Math.PI*2,j=Math.random(),U=e+Math.sqrt(j)*(n-e),F=.15+j*.6,H=(Math.random()-.5)*F*2;_[L*3]=Math.cos(b)*U,_[L*3+1]=H,_[L*3+2]=Math.sin(b)*U;const P=E.clone().lerp(A,j);y[L*3]=P.r,y[L*3+1]=P.g,y[L*3+2]=P.b,S[L]=Math.random()*(d-f)+f+(1-j)*f}g.setAttribute("position",new hn(_,3)),g.setAttribute("color",new hn(y,3)),g.setAttribute("size",new hn(S,1));const x=new $i({uniforms:{uScale:{value:1},uTint:{value:new yt("#ffffff")}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,blending:wo,vertexColors:!0}),S=new gf(d,y);return S.renderOrder=l,{points:S,mat:y}}const m1={default:{tint:"#ffffff",bg:"#06060f",fog:"#06060f",glow:"#4488cc",ambient:"#1a2a44"},fire:{tint:"#ffccaa",bg:"#0f0806",fog:"#0f0806",glow:"#ff6644",ambient:"#2a1a0a"},aurora:{tint:"#ccffdd",bg:"#060f0a",fog:"#060f0a",glow:"#44ffcc",ambient:"#0a1a14"},void:{tint:"#bbaadd",bg:"#0a0814",fog:"#0a0814",glow:"#5533aa",ambient:"#0a0a14"}};function QA({ringScale:t,planetScale:e,brightness:n,speed:r,sparkle:o,mode:l,quality:c,focus:f}){const d=Je.useRef(null),p=Je.useRef(null),g=Je.useRef(t),_=Je.useRef(e),y=Je.useRef(n??1),S=Je.useRef(r??1),E=Je.useRef(o??0),A=Je.useRef(l??"default"),x=Je.useRef(c??"high"),v=Je.useRef(f??0);return Je.useEffect(()=>{g.current=t},[t]),Je.useEffect(()=>{_.current=e},[e]),Je.useEffect(()=>{y.current=n??1},[n]),Je.useEffect(()=>{S.current=r??1},[r]),Je.useEffect(()=>{E.current=o??0},[o]),Je.useEffect(()=>{A.current=l??"default"},[l]),Je.useEffect(()=>{x.current=c??"high"},[c]),Je.useEffect(()=>{v.current=f??0},[f]),Je.useEffect(()=>{const N=d.current;let L=!1;const b=c==="eco"?.55:1,j=w=>Math.round(w*b),U=new qA;U.background=new yt(394767),U.fog=new mf(394767,15e-5);const F=new Yi(55,N.clientWidth/N.clientHeight,.1,50);F.position.set(0,1,7.5),F.lookAt(0,0,0);const H=new YA({antialias:!0,alpha:!1});H.setPixelRatio(Math.min(window.devicePixelRatio,2)),H.setSize(N.clientWidth,N.clientHeight),H.toneMapping=E2,H.toneMappingExposure=1.2,N.appendChild(H.domElement);const P=new ZA(1714756,1.8);U.add(P);const R=new p1(16772829,3.5);R.position.set(6,4,6),U.add(R);const B=new p1(3364215,1.2);B.position.set(-4,-1,-4),U.add(B);const le=j(1800),Q=new Ri,he=new Float32Array(le*3);for(let w=0;w<le;w++){const T=Math.random()*Math.PI*2,q=Math.acos(2*Math.random()-1),de=12+Math.random()*8;he[w*3]=Math.sin(q)*Math.cos(T)*de,he[w*3+1]=Math.sin(q)*Math.sin(T)*de,he[w*3+2]=Math.cos(q)*de}Q.setAttribute("position",new hn(he,3));const pe=new ey({color:16777215,size:.04,transparent:!0,opacity:.7,depthWrite:!1,blending:wo}),te=new gf(Q,pe);te.renderOrder=0,U.add(te);const re=hp({count:j(2500),innerR:1.8,outerR:2.8,colorInner:"#ffcc77",colorOuter:"#cc7733",tilt:.25,opacity:.8,sizeMin:.014,sizeMax:.07,renderOrder:3}),O=hp({count:j(2e3),innerR:3.1,outerR:3.7,colorInner:"#66eecc",colorOuter:"#2288bb",tilt:.55,opacity:.65,sizeMin:.012,sizeMax:.055,renderOrder:2}),ue=hp({count:j(1800),innerR:3.6,outerR:4.8,colorInner:"#cc99ff",colorOuter:"#5533aa",tilt:.78,opacity:.6,sizeMin:.01,sizeMax:.05,renderOrder:1});U.add(re.group),U.add(O.group),U.add(ue.group);const se=new _f(1.58,64,48),D=new $i({uniforms:{uColor:{value:new yt("#4488cc")}},vertexShader:`
      ...
      `,transparent:!0,blending:wo,depthWrite:!1}),Y=new fr(se,D);Y.renderOrder=4,U.add(Y);const Re=new _f(Zc-.02,64,48),Z=new km({color:394767}),ce=new fr(Re,Z);ce.renderOrder=5,U.add(ce);const _e=pp({count:j(1500),radius:Zc,jitterRate:1,jitterAmount:.55,colorFn:()=>{const w=Math.random();return[.12+w*.15,.3+w*.1,.7+w*.25,Math.random()*.08+.02+w*.03]},renderOrder:6,uniforms:{uWave:{value:0},uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
    ...
    `,U.add(_e.points);const fe=pp({count:j(1200),radius:Zc,jitterRate:1,jitterAmount:.2,colorFn:()=>[.15+Math.random()*.35,.35+Math.random()*.45,.6+Math.random()*.4,Math.random()*.035+.008],renderOrder:7,uniforms:{uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
      ...
      `});U.add(fe.points);const Se=pp({count:j(2800),radius:Zc,jitterRate:.3,jitterAmount:.15,colorFn:(w,T,q)=>{const de=Math.abs(Math.cos(q));return[.2+de*.4,.4+de*.35,.55+de*.4,Math.random()*.04+.01+(Math.random()<.08?.06:0)]},renderOrder:8,uniforms:{uPulse:{value:1}},fragShader:`
        varying vec3 vColor;
      ...
      `});U.add(Se.points);const Ae=j(500),We=new Ri,Tt=new Float32Array(Ae*3),ht=new Float32Array(Ae*3),At=new Float32Array(Ae*3),G=new Float32Array(Ae);for(let w=0;w<Ae;w++){const T=Math.random()*Math.PI*2,q=Math.acos(2*Math.random()-1),de=Math.random(),ge=.15+Math.sqrt(de)*.5;Tt[w*3]=Math.sin(q)*Math.cos(T)*ge,Tt[w*3+1]=Math.sin(q)*Math.sin(T)*ge,Tt[w*3+2]=Math.cos(q)*ge;const ae=w/Ae*Math.PI*2,Be=Math.pow(Math.sin(ae),3),Ce=(13*Math.cos(ae)-5*Math.cos(2*ae)-2*Math.cos(3*ae)-Math.cos(4*ae))/16,ct=.6+w%2*.12+(Math.random()-.5)*.02;ht[w*3]=Be*ct,ht[w*3+1]=Ce*ct,ht[w*3+2]=(Math.random()-.5)*.06;const ye=1-de;At[w*3]=.8+ye*.2,At[w*3+1]=.7+ye*.3,At[w*3+2]=.5+ye*.5,G[w]=Math.random()*.06+.02+ye*.08}We.setAttribute("position",new hn(Tt,3)),We.setAttribute("heartTarget",new hn(ht,3)),We.setAttribute("color",new hn(At,3)),We.setAttribute("size",new hn(G,1));const cn=new $i({uniforms:{uSparkle:{value:0},uPhase:{value:0},uTint:{value:new yt("#ffffff")}},vertexShader:`
